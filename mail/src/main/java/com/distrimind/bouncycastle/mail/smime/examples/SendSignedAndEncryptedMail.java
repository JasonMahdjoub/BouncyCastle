...
import com.distrimind.bouncycastle.mail.smime.SMIMEEnvelopedGenerator;
import com.distrimind.bouncycastle.mail.smime.SMIMEException;
import com.distrimind.bouncycastle.mail.smime.SMIMESignedGenerator;
...
public class SendSignedAndEncryptedMail
{
    public static void main(String args[])
    {
        ...
        try
        {
            ...
            mailcap
                    .addMailcap("application/pkcs7-signature;; x-java-content-handler=com.distrimind.bouncycastle.mail.smime.handlers.pkcs7_signature");
            mailcap
                    .addMailcap("application/pkcs7-mime;; x-java-content-handler=com.distrimind.bouncycastle.mail.smime.handlers.pkcs7_mime");
            mailcap
                    .addMailcap("application/x-pkcs7-signature;; x-java-content-handler=com.distrimind.bouncycastle.mail.smime.handlers.x_pkcs7_signature");
            mailcap
                    .addMailcap("application/x-pkcs7-mime;; x-java-content-handler=com.distrimind.bouncycastle.mail.smime.handlers.x_pkcs7_mime");
            mailcap
                    .addMailcap("multipart/signed;; x-java-content-handler=com.distrimind.bouncycastle.mail.smime.handlers.multipart_signed");
