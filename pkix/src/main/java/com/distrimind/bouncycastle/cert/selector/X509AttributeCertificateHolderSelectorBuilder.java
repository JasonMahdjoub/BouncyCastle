package com.distrimind.bouncycastle.cert.selector;
...
public class X509AttributeCertificateHolderSelectorBuilder
{
     ...
     * @see #addTargetName(com.distrimind.bouncycastle.asn1.x509.GeneralName)
     */
     ...
     * @throws java.io.IOException if a parsing error occurs.
     * @see #addTargetGroup(com.distrimind.bouncycastle.asn1.x509.GeneralName)
     */
