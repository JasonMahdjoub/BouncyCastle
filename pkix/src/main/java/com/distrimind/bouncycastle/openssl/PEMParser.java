...
import com.distrimind.bouncycastle.util.io.pem.PemObjectParser;
        ...
        implements PEMKeyPairParser
    {
            ...
            throws IOException
        {
            try
            {
                ...
                com.distrimind.bouncycastle.asn1.sec.ECPrivateKey pKey = com.distrimind.bouncycastle.asn1.sec.ECPrivateKey.getInstance(seq);
        ...
        implements PEMKeyPairParser
    {
            ...
            throws IOException
        {
            try
            {
                ...
                com.distrimind.bouncycastle.asn1.pkcs.RSAPrivateKey keyStruct = com.distrimind.bouncycastle.asn1.pkcs.RSAPrivateKey.getInstance(seq);
