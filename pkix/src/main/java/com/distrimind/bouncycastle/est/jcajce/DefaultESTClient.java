...
import com.distrimind.bouncycastle.est.ESTClientSourceProvider;
import com.distrimind.bouncycastle.est.ESTException;
import com.distrimind.bouncycastle.est.ESTRequest;
import com.distrimind.bouncycastle.est.ESTRequestBuilder;
    ...
    implements ESTClient
{
        ...
        throws IOException
    {
        ...
        try
        {
            ...
            Set<String> opts = Properties.asKeySet("com.distrimind.bouncycastle.debug.est");
