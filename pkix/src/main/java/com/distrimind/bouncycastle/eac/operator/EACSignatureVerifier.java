package com.distrimind.bouncycastle.eac.operator;
...
public interface EACSignatureVerifier
{
     ...
     * a signature for later verification. Use com.distrimind.bouncycastle.util.io.TeeOutputStream if you want to accumulate
