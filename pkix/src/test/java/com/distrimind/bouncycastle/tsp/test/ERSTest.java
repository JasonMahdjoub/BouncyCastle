...
import com.distrimind.bouncycastle.tsp.ers.ArchiveTimeStampValidationException;
import com.distrimind.bouncycastle.tsp.ers.ERSArchiveTimeStamp;
import com.distrimind.bouncycastle.tsp.ers.ERSArchiveTimeStampGenerator;
import com.distrimind.bouncycastle.tsp.ers.ERSByteData;
import com.distrimind.bouncycastle.tsp.ers.ERSData;
import com.distrimind.bouncycastle.tsp.ers.ERSDataGroup;
import com.distrimind.bouncycastle.tsp.ers.ERSDirectoryDataGroup;
import com.distrimind.bouncycastle.tsp.ers.ERSEvidenceRecord;
import com.distrimind.bouncycastle.tsp.ers.ERSEvidenceRecordGenerator;
import com.distrimind.bouncycastle.tsp.ers.ERSEvidenceRecordSelector;
import com.distrimind.bouncycastle.tsp.ers.ERSEvidenceRecordStore;
import com.distrimind.bouncycastle.tsp.ers.ERSException;
import com.distrimind.bouncycastle.tsp.ers.ERSFileData;
...
//        ev.validatePresent(h2Doc, new Date());
        ...
        throws Exception
    {
        ...
        for (int i = 0; i < dataObjects.length; i++) {
            ...
            final com.distrimind.bouncycastle.asn1.tsp.PartialHashtree[] ht = ersEvidenceRecord.toASN1Structure().getArchiveTimeStampSequence().getArchiveTimeStampChains()[0].getArchiveTimestamps()[0].getReducedHashTree();
