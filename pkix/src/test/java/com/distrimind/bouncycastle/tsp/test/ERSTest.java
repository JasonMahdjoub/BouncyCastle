...
//        ev.validatePresent(h2Doc, new Date());
        ...
        throws Exception
    {
        ...
        for (int i = 0; i < dataObjects.length; i++)
        {
            ...
            final PartialHashtree[] ht = ersEvidenceRecord.toASN1Structure().getArchiveTimeStampSequence().getArchiveTimeStampChains()[0].getArchiveTimestamps()[0].getReducedHashTree();
