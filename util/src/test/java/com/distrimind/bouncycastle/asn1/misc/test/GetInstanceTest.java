...
import com.distrimind.bouncycastle.asn1.cmp.*;
    ...
    extends TestCase
{
        ...
        throws Exception
    {
        ...
        doFullGetInstanceTest(CertStatus.class, new CertStatus(new byte[10], BigInteger.valueOf(1), new PKIStatusInfo(PKIStatus.granted), new AlgorithmIdentifier(new ASN1ObjectIdentifier("0.0"))));
