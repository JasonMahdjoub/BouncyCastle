...
ed com/distrimind/bouncycastle/asn1/x500/style/X500NameTokenizer.java <<%
g/private final .*/s/final//
w
w
q
...
ed com/distrimind/bouncycastle/pkcs/DeltaCertificateRequestAttributeValue.java <<%
g/private final /s/final//
w
q
%

ed com/distrimind/bouncycastle/pkcs/PKCS10CertificationRequest.java <<%
g/private final /s/final//
w
q
%
...
ed com/distrimind/bouncycastle/bcpg/Packet.java <<%
g/private.*final.*;/s/final//
w
q
%
...
ed com/distrimind/bouncycastle/bcpg/sig/PreferredAEADCiphersuites.java <<%
g/private.*final.*;/s/final//
w
q
%
