    ...
    extends AsymmetricKeyParameter
{
    ...
    private static BigInteger validate(BigInteger modulus, boolean isInternal)
    {
        ...
        int maxBitLength = Properties.asInteger("com.distrimind.bouncycastle.rsa.max_size", 16384);
        ...
        int iterations = Properties.asInteger("com.distrimind.bouncycastle.rsa.max_mr_tests", getMRIterations(bits));
