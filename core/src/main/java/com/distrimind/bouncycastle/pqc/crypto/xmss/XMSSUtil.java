...
public class XMSSUtil
{
       ...
       extends ObjectInputStream
    {
        ...
        static
        {
            ...
            components.add("com.distrimind.bouncycastle.pqc.crypto.xmss.BDS");
            components.add("java.util.ArrayList");
            components.add("com.distrimind.bouncycastle.pqc.crypto.xmss.XMSSNode");
            components.add("[B");
            ...
            components.add("com.distrimind.bouncycastle.pqc.crypto.xmss.BDSTreeHash");
        }
