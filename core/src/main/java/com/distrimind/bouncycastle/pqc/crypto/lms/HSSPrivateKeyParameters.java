...
import static com.distrimind.bouncycastle.pqc.crypto.lms.HSS.rangeTestKeys;
    ...
    implements LMSContextBasedSigner
{
    ...
    void resetKeyToIndex()
    {
        ...
        for (int i = 1; i < qTreePath.length; i++)
        {
            ...
            //
            boolean seedEquals = com.distrimind.bouncycastle.util.Arrays.areEqual(childI, keys[i].getI())
                && com.distrimind.bouncycastle.util.Arrays.areEqual(childSeed, keys[i].getMasterSecret());
