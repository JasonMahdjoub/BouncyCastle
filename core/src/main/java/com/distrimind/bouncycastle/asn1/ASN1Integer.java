    ...
    extends ASN1Primitive
{
     ...
     * </p>
     * <p>
     * Users can set the 'com.distrimind.bouncycastle.asn1.allow_unsafe_integer' to 'true'
    ...
    static boolean isMalformed(byte[] bytes)
    {
        ...
        default:
            return bytes[0] == (bytes[1] >> 7)
                ...
                && !Properties.isOverrideSet("com.distrimind.bouncycastle.asn1.allow_unsafe_integer");
        }
    }
