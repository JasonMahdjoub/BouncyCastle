...
import com.distrimind.bouncycastle.pqc.crypto.bike.BIKEKeyGenerationParameters;
import com.distrimind.bouncycastle.pqc.crypto.bike.BIKEKeyPairGenerator;
...
//        boolean full = System.getProperty("test.full", "false").equals("true");
        ...
        for (int fileIndex = 0; fileIndex < files.length; fileIndex++)
        {
            ...
            InputStream src = BIKETest.class.getResourceAsStream("/com/distrimind/bouncycastle/pqc/crypto/test/bike/" + name);
