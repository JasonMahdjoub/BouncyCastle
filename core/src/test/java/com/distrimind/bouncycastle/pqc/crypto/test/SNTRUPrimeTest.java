...
import com.distrimind.bouncycastle.pqc.crypto.ntruprime.SNTRUPrimeKeyGenerationParameters;
import com.distrimind.bouncycastle.pqc.crypto.ntruprime.SNTRUPrimeKeyPairGenerator;
...
public class SNTRUPrimeTest
    extends TestCase
{
    private static final String resourcePath = "/com/distrimind/bouncycastle/pqc/crypto/test/ntruprime/sntrup/";
