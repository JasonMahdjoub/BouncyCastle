...
import com.distrimind.bouncycastle.pqc.crypto.falcon.FalconKeyGenerationParameters;
import com.distrimind.bouncycastle.pqc.crypto.falcon.FalconKeyPairGenerator;
    ...
    extends TestCase
{
        ...
        throws Exception
    {
        ...
        for (int fileindex = 0; fileindex < files.length; fileindex++)
        {
            ...
            InputStream src = FalconTest.class.getResourceAsStream("/com/distrimind/bouncycastle/pqc/crypto/test/falcon/" + name);
