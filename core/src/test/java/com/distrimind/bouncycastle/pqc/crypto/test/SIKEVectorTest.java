...
import com.distrimind.bouncycastle.pqc.crypto.sike.SIKEKEMExtractor;
import com.distrimind.bouncycastle.pqc.crypto.sike.SIKEKEMGenerator;
import com.distrimind.bouncycastle.pqc.crypto.sike.SIKEKeyGenerationParameters;
import com.distrimind.bouncycastle.pqc.crypto.sike.SIKEKeyPairGenerator;
...
import com.distrimind.bouncycastle.pqc.crypto.sike.SIKEPublicKeyParameters;
        ...
        extends TestCase
{
            ...
            throws Exception
    {
        ...
        for (int fileIndex = 0; fileIndex != files.length; fileIndex++)
        {
            ...
            InputStream src = SIKEVectorTest.class.getResourceAsStream("/com/distrimind/bouncycastle/pqc/crypto/test/sike/" + name);
