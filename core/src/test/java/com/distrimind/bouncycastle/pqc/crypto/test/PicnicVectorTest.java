...
import com.distrimind.bouncycastle.pqc.crypto.picnic.PicnicKeyGenerationParameters;
import com.distrimind.bouncycastle.pqc.crypto.picnic.PicnicKeyPairGenerator;
...
import com.distrimind.bouncycastle.pqc.crypto.picnic.PicnicSigner;
...

{
        ...
        throws Exception
    {
        ...
        for (int fileIndex = 0; fileIndex != files.length; fileIndex++)
        {
            ...
            InputStream src = PicnicVectorTest.class.getResourceAsStream("/com/distrimind/bouncycastle/pqc/crypto/test/picnic/" + name);
