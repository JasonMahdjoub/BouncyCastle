...
import com.distrimind.bouncycastle.pqc.crypto.hqc.HQCKeyGenerationParameters;
import com.distrimind.bouncycastle.pqc.crypto.hqc.HQCKeyPairGenerator;
...
//        boolean full = System.getProperty("test.full", "false").equals("true");
        ...
        for (int fileIndex = 0; fileIndex < files.length; fileIndex++)
        {
            ...
            InputStream src = HQCTest.class.getResourceAsStream("/com/distrimind/bouncycastle/pqc/crypto/test/hqc/" + name);
