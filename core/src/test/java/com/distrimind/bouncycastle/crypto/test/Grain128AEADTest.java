...
import com.distrimind.bouncycastle.crypto.engines.Grain128AEADEngine;
    ...
    extends SimpleTest
{
        ...
        throws Exception
    {
        ...
        InputStream src = Grain128AEADTest.class.getResourceAsStream("/com/distrimind/bouncycastle/crypto/test/LWC_AEAD_KAT_128_96.txt");
