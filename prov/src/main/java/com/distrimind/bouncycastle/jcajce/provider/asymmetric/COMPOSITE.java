...
{
    private static final String PREFIX = "com.distrimind.bouncycastle.jcajce.provider.asymmetric.COMPOSITE";

    private static final Map<String, String> compositeAttributes = new HashMap<String, String>();

    static
    {
        compositeAttributes.put("SupportedKeyClasses", "com.distrimind.bouncycastle.jcajce.CompositePublicKey|com.distrimind.bouncycastle.jcajce.CompositePrivateKey");
