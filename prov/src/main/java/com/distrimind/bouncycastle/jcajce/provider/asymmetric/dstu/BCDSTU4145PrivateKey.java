package com.distrimind.bouncycastle.jcajce.provider.asymmetric.dstu;
...
import com.distrimind.bouncycastle.asn1.ua.DSTU4145BinaryField;
import com.distrimind.bouncycastle.asn1.ua.DSTU4145ECBinary;
import com.distrimind.bouncycastle.asn1.ua.DSTU4145NamedCurves;
import com.distrimind.bouncycastle.asn1.ua.DSTU4145Params;
import com.distrimind.bouncycastle.asn1.ua.DSTU4145PointEncoder;
...
public class BCDSTU4145PrivateKey
    implements ECPrivateKey, com.distrimind.bouncycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder
{
    ...
    public BCDSTU4145PrivateKey(
        com.distrimind.bouncycastle.jce.spec.ECPrivateKeySpec spec)
    {
        this.d = spec.getD();
        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    spec = new com.distrimind.bouncycastle.jce.spec.ECParameterSpec(curve, DSTU4145PointEncoder.decodePoint(curve, g_bytes), binary.getN());
                }
    ...
    public com.distrimind.bouncycastle.jce.spec.ECParameterSpec getParameters()
    {
        if (ecSpec == null)
        {
            return null;
    ...
    com.distrimind.bouncycastle.jce.spec.ECParameterSpec engineGetSpec()
    {
        if (ecSpec != null)
        {
            return EC5Util.convertSpec(ecSpec);
