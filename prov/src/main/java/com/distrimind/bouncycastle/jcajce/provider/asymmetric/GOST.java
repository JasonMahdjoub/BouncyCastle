...
import com.distrimind.bouncycastle.jcajce.provider.asymmetric.gost.KeyFactorySpi;
import com.distrimind.bouncycastle.jcajce.provider.config.ConfigurableProvider;
import com.distrimind.bouncycastle.jcajce.provider.util.AsymmetricAlgorithmProvider;

public class GOST
{
    private static final String PREFIX = "com.distrimind.bouncycastle.jcajce.provider.asymmetric" + ".gost.";
