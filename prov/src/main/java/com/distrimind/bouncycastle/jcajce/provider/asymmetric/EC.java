...
import com.distrimind.bouncycastle.jcajce.provider.asymmetric.ec.KeyFactorySpi;
...
public class EC
{
    private static final String PREFIX = "com.distrimind.bouncycastle.jcajce.provider.asymmetric" + ".ec.";
