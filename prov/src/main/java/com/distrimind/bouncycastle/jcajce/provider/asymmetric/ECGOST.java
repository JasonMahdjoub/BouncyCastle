...
import com.distrimind.bouncycastle.jcajce.provider.asymmetric.ecgost12.KeyFactorySpi;
import com.distrimind.bouncycastle.jcajce.provider.config.ConfigurableProvider;
import com.distrimind.bouncycastle.jcajce.provider.util.AsymmetricAlgorithmProvider;

public class ECGOST
{
    private static final String PREFIX_COMMON = "com.distrimind.bouncycastle.jcajce.provider.asymmetric" + ".ec.";
    private static final String PREFIX = "com.distrimind.bouncycastle.jcajce.provider.asymmetric" + ".ecgost.";
    private static final String PREFIX_GOST_2012 = "com.distrimind.bouncycastle.jcajce.provider.asymmetric" + ".ecgost12.";
        ...
        extends AsymmetricAlgorithmProvider
    {
        ...
        public void configure(ConfigurableProvider provider)
        {
            ...
            registerOid(provider, CryptoProObjectIdentifiers.gostR3410_2001,
                    "ECGOST3410", new com.distrimind.bouncycastle.jcajce.provider.asymmetric.ecgost.KeyFactorySpi());
