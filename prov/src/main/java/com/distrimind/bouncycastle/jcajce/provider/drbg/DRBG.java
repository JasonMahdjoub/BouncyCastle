package com.distrimind.bouncycastle.jcajce.provider.drbg;
 ...
 * <p>
 * com.distrimind.bouncycastle.drbg.gather_pause_secs - is to stop the entropy collection thread from grabbing all
 ...
 * </p>
 * <p>
 * com.distrimind.bouncycastle.drbg.entropysource - is the class name for an implementation of EntropySourceProvider.
 * For example, one could be provided which just reads directly from /dev/random and the extra infrastructure used here
 * could be avoided.
 * </p>
 * <p>
 * com.distrimind.bouncycastle.drbg.entropy_thread - if true the provider will start a single daemon thread for handling entropy requests,
...
public class DRBG
{
    ...
    {
        if (Properties.getPropertyValue("com.distrimind.bouncycastle.drbg.entropysource") != null)
        {
        ...
        else if (Properties.isOverrideSet("com.distrimind.bouncycastle.drbg.entropy_thread"))
        {
    ...
    {
        final String sourceClass = Properties.getPropertyValue("com.distrimind.bouncycastle.drbg.entropysource");
