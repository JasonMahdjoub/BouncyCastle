...
import com.distrimind.bouncycastle.jcajce.provider.asymmetric.compositesignatures.CompositeSignaturesConstants;
import com.distrimind.bouncycastle.jcajce.provider.asymmetric.compositesignatures.KeyFactorySpi;
...
{
    private static final String PREFIX = "com.distrimind.bouncycastle.jcajce.provider.asymmetric" + ".compositesignatures.";

    private static final Map<String, String> compositesAttributes = new HashMap<String, String>();

    static
    {
        compositesAttributes.put("SupportedKeyClasses", "com.distrimind.bouncycastle.jcajce.CompositePublicKey|com.distrimind.bouncycastle.jcajce.CompositePrivateKey");
