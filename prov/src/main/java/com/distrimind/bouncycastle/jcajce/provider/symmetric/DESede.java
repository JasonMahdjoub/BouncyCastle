...
import com.distrimind.bouncycastle.crypto.engines.DESedeWrapEngine;
import com.distrimind.bouncycastle.crypto.engines.RFC3211WrapEngine;
...
import com.distrimind.bouncycastle.jcajce.provider.symmetric.util.*;
...
public final class DESede
{
  ...
  /**
        ...
        extends DES.DESPBEKeyFactory
    {
        ...
        {
            super("PBEwithSHAandDES3Key-CBC", PKCSObjectIdentifiers.pbeWithSHAAnd3_KeyTripleDES_CBC, true, PBE.PKCS12, PBE.SHA1, 192, 64);
        }
    }
        ...
        extends DES.DESPBEKeyFactory
    {
        ...
        {
            super("PBEwithSHAandDES2Key-CBC", PKCSObjectIdentifiers.pbeWithSHAAnd2_KeyTripleDES_CBC, true, PBE.PKCS12, PBE.SHA1, 128, 64);
        }
    }
        ...
        extends AlgorithmProvider
    {
        ...
        private static final String PACKAGE = "com.distrimind.bouncycastle.jcajce.provider.symmetric"; // JDK 1.2
