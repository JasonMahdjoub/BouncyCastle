...
import com.distrimind.bouncycastle.jcajce.provider.asymmetric.dsa.DSAUtil;
import com.distrimind.bouncycastle.jcajce.provider.asymmetric.dsa.KeyFactorySpi;
...
public class DSA
{
    private static final String PREFIX = "com.distrimind.bouncycastle.jcajce.provider.asymmetric" + ".dsa.";
