...
{
    private static final String PREFIX = "com.distrimind.bouncycastle.jcajce.provider.asymmetric.EXTERNAL";

    private static final Map<String, String> externalAttributes = new HashMap<String, String>();

    static
    {
        externalAttributes.put("SupportedKeyClasses", "com.distrimind.bouncycastle.jcajce.ExternalPublicKey");
