    ...
    implements PKIXCertRevocationChecker
{
        ...
        throws CertPathValidatorException
    {
        ...
        if (ocspResponses.get(cert) == null && ocspUri != null)
        {
            ...
            com.distrimind.bouncycastle.asn1.x509.Certificate issuer = extractCert();
    ...
    {
        byte[] extValue = cert.getExtensionValue(com.distrimind.bouncycastle.asn1.x509.Extension.authorityInfoAccess.getId());
        if (extValue == null)
        {
            return null;
        }
        ...
        try
        {
            ...
            if (sig.verify(basicResp.getSignature().getBytes()))
            {
                if (nonce != null)
                {
                    ...
                    com.distrimind.bouncycastle.asn1.x509.Extension ext = exts.getExtension(OCSPObjectIdentifiers.id_pkix_ocsp_nonce);
    ...
    private com.distrimind.bouncycastle.asn1.x509.Certificate extractCert()
        throws CertPathValidatorException
    {
        try
        {
            return com.distrimind.bouncycastle.asn1.x509.Certificate.getInstance(parameters.getSigningCert().getEncoded());
        }
        catch (Exception e)
        {
    ...
    private CertID createCertID(CertID base, com.distrimind.bouncycastle.asn1.x509.Certificate issuer, ASN1Integer serialNumber)
        throws CertPathValidatorException
    {
        return createCertID(base.getHashAlgorithm(), issuer, serialNumber);
    }

    private CertID createCertID(AlgorithmIdentifier digestAlg, com.distrimind.bouncycastle.asn1.x509.Certificate issuer, ASN1Integer serialNumber)
        throws CertPathValidatorException
    {
        try
        {
