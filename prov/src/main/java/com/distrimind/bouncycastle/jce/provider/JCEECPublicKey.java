    ...
    implements ECPublicKey, com.distrimind.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder
{
    ...
    private com.distrimind.bouncycastle.math.ec.ECPoint q;
        ...
        com.distrimind.bouncycastle.jce.spec.ECPublicKeySpec spec)
    {
        ...
        else
        {
            if (q.getCurve() == null)
            {
                com.distrimind.bouncycastle.jce.spec.ECParameterSpec s = BouncyCastleProvider.CONFIGURATION.getEcImplicitlyCa();
    ...
    public com.distrimind.bouncycastle.math.ec.ECPoint engineGetQ()
    {
        return q;
    }
