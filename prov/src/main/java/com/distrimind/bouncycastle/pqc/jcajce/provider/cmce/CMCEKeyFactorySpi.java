    ...
    implements AsymmetricKeyInfoConverter
{
    ...
    public final KeySpec engineGetKeySpec(Key key, Class keySpec)
        throws InvalidKeySpecException
    {
        if (key instanceof com.distrimind.bouncycastle.pqc.jcajce.provider.cmce.BCCMCEPrivateKey)
        {
        ...
        else if (key instanceof com.distrimind.bouncycastle.pqc.jcajce.provider.cmce.BCCMCEPublicKey)
        {
    ...
    {
        if (key instanceof com.distrimind.bouncycastle.pqc.jcajce.provider.cmce.BCCMCEPrivateKey || key instanceof com.distrimind.bouncycastle.pqc.jcajce.provider.cmce.BCCMCEPublicKey)
        {
            return key;
        }
