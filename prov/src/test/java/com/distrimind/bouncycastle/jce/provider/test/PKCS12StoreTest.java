    ...
    extends SimpleTest
{
        ...
        throws Exception
    {
        ...
        System.setProperty("com.distrimind.bouncycastle.pkcs12.ignore_useless_passwd", "true");

        pkcs12.load(new ByteArrayInputStream(certsOnly), "1".toCharArray());

        System.setProperty("com.distrimind.bouncycastle.pkcs12.ignore_useless_passwd", "false");
    }
    ...
    private void testIterationCount()
        throws Exception
    {
        System.setProperty("com.distrimind.bouncycastle.pkcs12.max_it_count", "10");
        ...
        System.clearProperty("com.distrimind.bouncycastle.pkcs12.max_it_count");
    }
        ...
        throws Exception
    {
        ...
        {
            isTrue("illegal object in getInstance: com.distrimind.bouncycastle.asn1.DLSequence".equals(e.getMessage()));
        }
    }
