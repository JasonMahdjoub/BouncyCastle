    ...
    extends SimpleTest
{
        ...
        throws Exception
    {
        ...
        com.distrimind.bouncycastle.jce.spec.ECPublicKeySpec pubSpec = new com.distrimind.bouncycastle.jce.spec.ECPublicKeySpec(namedCurve.getCurve().createPoint(PubX, PubY), namedCurve);
