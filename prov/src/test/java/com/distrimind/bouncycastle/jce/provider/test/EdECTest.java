...
import com.distrimind.bouncycastle.jcajce.spec.RawEncodedKeySpec;
    ...
    extends SimpleTest
{
    ...
    private void testPKCS8Override()
        throws Exception
    {
        System.setProperty("com.distrimind.bouncycastle.pkcs8.v1_info_only", "true");
        ...
        System.setProperty("com.distrimind.bouncycastle.pkcs8.v1_info_only", "false");
