...
import org.bouncycastle.bcasn1.DERGeneralString;
import org.bouncycastle.bcasn1.DERIA5String;
import org.bouncycastle.bcasn1.DERNull;
import org.bouncycastle.bcasn1.DERNumericString;
...
import org.bouncycastle.bcasn1.DERT61String;
import org.bouncycastle.bcasn1.DERTaggedObject;
import org.bouncycastle.bcasn1.DERUTF8String;
import org.bouncycastle.bcasn1.DERUniversalString;
import org.bouncycastle.bcasn1.DERVisibleString;
import org.bouncycastle.bcasn1.cmp.CAKeyUpdAnnContent;
import org.bouncycastle.bcasn1.cmp.CMPCertificate;
import org.bouncycastle.bcasn1.cmp.CRLAnnContent;
import org.bouncycastle.bcasn1.cmp.CertConfirmContent;
import org.bouncycastle.bcasn1.cmp.CertOrEncCert;
import org.bouncycastle.bcasn1.cmp.CertRepMessage;
import org.bouncycastle.bcasn1.cmp.CertResponse;
import org.bouncycastle.bcasn1.cmp.CertifiedKeyPair;
import org.bouncycastle.bcasn1.cmp.Challenge;
import org.bouncycastle.bcasn1.cmp.ErrorMsgContent;
import org.bouncycastle.bcasn1.cmp.GenMsgContent;
import org.bouncycastle.bcasn1.cmp.GenRepContent;
import org.bouncycastle.bcasn1.cmp.InfoTypeAndValue;
import org.bouncycastle.bcasn1.cmp.KeyRecRepContent;
import org.bouncycastle.bcasn1.cmp.OOBCertHash;
import org.bouncycastle.bcasn1.cmp.PBMParameter;
import org.bouncycastle.bcasn1.cmp.PKIBody;
import org.bouncycastle.bcasn1.cmp.PKIConfirmContent;
...
import org.bouncycastle.bcasn1.cmp.PKIMessages;
import org.bouncycastle.bcasn1.cmp.PKIStatus;
import org.bouncycastle.bcasn1.cmp.PKIStatusInfo;
import org.bouncycastle.bcasn1.cmp.POPODecKeyChallContent;
import org.bouncycastle.bcasn1.cmp.POPODecKeyRespContent;
import org.bouncycastle.bcasn1.cmp.PollRepContent;
import org.bouncycastle.bcasn1.cmp.PollReqContent;
import org.bouncycastle.bcasn1.cmp.ProtectedPart;
import org.bouncycastle.bcasn1.cmp.RevAnnContent;
import org.bouncycastle.bcasn1.cmp.RevDetails;
import org.bouncycastle.bcasn1.cmp.RevRepContent;
import org.bouncycastle.bcasn1.cmp.RevReqContent;
import org.bouncycastle.bcasn1.cms.Attribute;
import org.bouncycastle.bcasn1.cms.Attributes;
import org.bouncycastle.bcasn1.cms.AuthEnvelopedData;
import org.bouncycastle.bcasn1.cms.AuthenticatedData;
import org.bouncycastle.bcasn1.cms.CompressedData;
...
import org.bouncycastle.bcasn1.cms.Evidence;
...
import org.bouncycastle.bcasn1.cms.OtherKeyAttribute;
import org.bouncycastle.bcasn1.cms.OtherRecipientInfo;
...
import org.bouncycastle.bcasn1.cms.TimeStampAndCRL;
import org.bouncycastle.bcasn1.cms.TimeStampTokenEvidence;
import org.bouncycastle.bcasn1.cms.TimeStampedData;
import org.bouncycastle.bcasn1.cms.ecc.MQVuserKeyingMaterial;
import org.bouncycastle.bcasn1.crmf.AttributeTypeAndValue;
import org.bouncycastle.bcasn1.crmf.CertId;
import org.bouncycastle.bcasn1.crmf.CertReqMessages;
import org.bouncycastle.bcasn1.crmf.CertReqMsg;
import org.bouncycastle.bcasn1.crmf.CertRequest;
import org.bouncycastle.bcasn1.crmf.CertTemplate;
import org.bouncycastle.bcasn1.crmf.Controls;
...
import org.bouncycastle.bcasn1.crmf.OptionalValidity;
import org.bouncycastle.bcasn1.crmf.PKIArchiveOptions;
import org.bouncycastle.bcasn1.crmf.PKIPublicationInfo;
import org.bouncycastle.bcasn1.crmf.PKMACValue;
import org.bouncycastle.bcasn1.crmf.POPOPrivKey;
import org.bouncycastle.bcasn1.crmf.POPOSigningKey;
import org.bouncycastle.bcasn1.crmf.POPOSigningKeyInput;
import org.bouncycastle.bcasn1.crmf.ProofOfPossession;
import org.bouncycastle.bcasn1.crmf.SinglePubInfo;
import org.bouncycastle.bcasn1.cryptopro.ECGOST3410ParamSetParameters;
import org.bouncycastle.bcasn1.cryptopro.GOST28147Parameters;
import org.bouncycastle.bcasn1.cryptopro.GOST3410ParamSetParameters;
...
import org.bouncycastle.bcasn1.eac.UnsignedInteger;
import org.bouncycastle.bcasn1.esf.CommitmentTypeIndication;
import org.bouncycastle.bcasn1.esf.CommitmentTypeQualifier;
import org.bouncycastle.bcasn1.esf.CompleteRevocationRefs;
import org.bouncycastle.bcasn1.esf.CrlIdentifier;
import org.bouncycastle.bcasn1.esf.CrlListID;
import org.bouncycastle.bcasn1.esf.CrlOcspRef;
import org.bouncycastle.bcasn1.esf.CrlValidatedID;
import org.bouncycastle.bcasn1.esf.OcspIdentifier;
import org.bouncycastle.bcasn1.esf.OcspListID;
import org.bouncycastle.bcasn1.esf.OcspResponsesID;
import org.bouncycastle.bcasn1.esf.OtherHash;
import org.bouncycastle.bcasn1.esf.OtherHashAlgAndValue;
import org.bouncycastle.bcasn1.esf.OtherRevRefs;
import org.bouncycastle.bcasn1.esf.OtherRevVals;
import org.bouncycastle.bcasn1.esf.RevocationValues;
import org.bouncycastle.bcasn1.esf.SPUserNotice;
import org.bouncycastle.bcasn1.esf.SPuri;
import org.bouncycastle.bcasn1.esf.SigPolicyQualifierInfo;
import org.bouncycastle.bcasn1.esf.SigPolicyQualifiers;
import org.bouncycastle.bcasn1.esf.SignaturePolicyId;
import org.bouncycastle.bcasn1.esf.SignaturePolicyIdentifier;
import org.bouncycastle.bcasn1.esf.SignerAttribute;
import org.bouncycastle.bcasn1.esf.SignerLocation;
import org.bouncycastle.bcasn1.ess.ContentHints;
import org.bouncycastle.bcasn1.ess.ContentIdentifier;
import org.bouncycastle.bcasn1.ess.ESSCertID;
import org.bouncycastle.bcasn1.ess.ESSCertIDv2;
import org.bouncycastle.bcasn1.ess.OtherCertID;
import org.bouncycastle.bcasn1.ess.OtherSigningCertificate;
import org.bouncycastle.bcasn1.ess.SigningCertificate;
import org.bouncycastle.bcasn1.ess.SigningCertificateV2;
import org.bouncycastle.bcasn1.icao.CscaMasterList;
import org.bouncycastle.bcasn1.icao.DataGroupHash;
import org.bouncycastle.bcasn1.icao.LDSSecurityObject;
import org.bouncycastle.bcasn1.icao.LDSVersionInfo;
import org.bouncycastle.bcasn1.isismtt.ocsp.CertHash;
import org.bouncycastle.bcasn1.isismtt.ocsp.RequestedCertificate;
import org.bouncycastle.bcasn1.isismtt.x509.AdditionalInformationSyntax;
import org.bouncycastle.bcasn1.isismtt.x509.AdmissionSyntax;
import org.bouncycastle.bcasn1.isismtt.x509.Admissions;
import org.bouncycastle.bcasn1.isismtt.x509.DeclarationOfMajority;
import org.bouncycastle.bcasn1.isismtt.x509.MonetaryLimit;
import org.bouncycastle.bcasn1.isismtt.x509.NamingAuthority;
import org.bouncycastle.bcasn1.isismtt.x509.ProcurationSyntax;
import org.bouncycastle.bcasn1.isismtt.x509.ProfessionInfo;
import org.bouncycastle.bcasn1.isismtt.x509.Restriction;
...
import org.bouncycastle.bcasn1.ocsp.CertID;
import org.bouncycastle.bcasn1.ocsp.CertStatus;
import org.bouncycastle.bcasn1.ocsp.CrlID;
...
import org.bouncycastle.bcasn1.pkcs.CertificationRequestInfo;
...
import org.bouncycastle.bcasn1.smime.SMIMECapabilities;
...
import org.bouncycastle.bcasn1.x500.DirectoryString;
...
import org.bouncycastle.bcasn1.x509.CRLNumber;
...
import org.bouncycastle.bcasn1.x509.CertificatePolicies;
import org.bouncycastle.bcasn1.x509.DSAParameter;
import org.bouncycastle.bcasn1.x509.DigestInfo;
import org.bouncycastle.bcasn1.x509.DisplayText;
...
import org.bouncycastle.bcasn1.x509.NoticeReference;
import org.bouncycastle.bcasn1.x509.ObjectDigestInfo;
import org.bouncycastle.bcasn1.x509.PolicyInformation;
import org.bouncycastle.bcasn1.x509.PolicyMappings;
import org.bouncycastle.bcasn1.x509.PolicyQualifierInfo;
import org.bouncycastle.bcasn1.x509.PrivateKeyUsagePeriod;
import org.bouncycastle.bcasn1.x509.RoleSyntax;
import org.bouncycastle.bcasn1.x509.SubjectDirectoryAttributes;
...
import org.bouncycastle.bcasn1.x509.UserNotice;
...
import org.bouncycastle.bcasn1.x509.qualified.BiometricData;
...
import org.bouncycastle.bcasn1.x509.qualified.SemanticsInformation;
import org.bouncycastle.bcasn1.x509.qualified.TypeOfBiometricData;
import org.bouncycastle.bcasn1.x509.sigi.NameOrPseudonym;
import org.bouncycastle.bcasn1.x509.sigi.PersonalData;
import org.bouncycastle.bcasn1.x9.DHDomainParameters;
import org.bouncycastle.bcasn1.x9.DHPublicKey;
import org.bouncycastle.bcasn1.x9.DHValidationParms;
    ...
    extends TestCase
{
        ...
        throws Exception
    {
        ...
        doFullGetInstanceTest(org.bouncycastle.bcasn1.cmp.CertStatus.class, new org.bouncycastle.bcasn1.cmp.CertStatus(new byte[10], BigInteger.valueOf(1), new PKIStatusInfo(PKIStatus.granted)));
        ...
        doFullGetInstanceTest(SignerAttribute.class, new SignerAttribute(new org.bouncycastle.bcasn1.x509.Attribute[]{new org.bouncycastle.bcasn1.x509.Attribute(new ASN1ObjectIdentifier("1.2.1"), new DERSet())}));
        ...
        org.bouncycastle.bcasn1.pkcs.RSAPublicKey.getInstance(null);
        RSAPublicKey.getInstance(null);
