...
import org.bouncycastle.bccrypto.tls.CertificateRequest;
import org.bouncycastle.bccrypto.tls.ClientCertificateType;
import org.bouncycastle.bccrypto.tls.ConnectionEnd;
import org.bouncycastle.bccrypto.tls.DefaultTlsClient;
import org.bouncycastle.bccrypto.tls.ProtocolVersion;
import org.bouncycastle.bccrypto.tls.SignatureAlgorithm;
import org.bouncycastle.bccrypto.tls.SignatureAndHashAlgorithm;
import org.bouncycastle.bccrypto.tls.TlsAuthentication;
import org.bouncycastle.bccrypto.tls.TlsCredentials;
import org.bouncycastle.bccrypto.tls.TlsFatalAlert;
import org.bouncycastle.bccrypto.tls.TlsSignerCredentials;
import org.bouncycastle.bccrypto.tls.TlsUtils;
    ...
    extends DefaultTlsClient
{
        ...
        return new TlsAuthentication()
        {
                ...
                throws IOException
            {
                ...
                return new TlsSignerCredentials()
                {
                    ...
                    public org.bouncycastle.bccrypto.tls.Certificate getCertificate()
                    {
                        org.bouncycastle.bccrypto.tls.Certificate cert = signerCredentials.getCertificate();
    ...
    protected org.bouncycastle.bccrypto.tls.Certificate corruptCertificate(org.bouncycastle.bccrypto.tls.Certificate cert)
    {
        Certificate[] certList = cert.getCertificateList();
        certList[0] = corruptCertificateSignature(certList[0]);
        return new org.bouncycastle.bccrypto.tls.Certificate(certList);
    }
