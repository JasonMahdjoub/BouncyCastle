    ...
    extends BufferedBlockCipher
{
     ...
     * @exception org.bouncycastle.bccrypto.DataLengthException if there isn't enough space in out.
     ...
     * @return the number of output bytes copied to out.
     * @exception org.bouncycastle.bccrypto.DataLengthException if there is insufficient space in out for
     * the output.
     * @exception IllegalStateException if the underlying cipher is not
     * initialised.
     * @exception org.bouncycastle.bccrypto.InvalidCipherTextException if cipher text decrypts wrongly (in
