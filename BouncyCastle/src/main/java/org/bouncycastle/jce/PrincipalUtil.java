...
/**
 * a utility class that will extract X509Principal objects from X.509
 * certificates.
 * <p>
 * Use this in preference to trying to recreate a principal from a String, not
 * all DNs are what they should be, so it's best to leave them encoded where
 * they can be.
 */
public class PrincipalUtil {
	...
	public static X509Principal getIssuerX509Principal(X509Certificate cert) throws CertificateEncodingException {
		try {
			TBSCertificateStructure tbsCert = TBSCertificateStructure
