...
public class X509Principal extends X509Name implements Principal {
	...
	/**
	 * constructor from a table of attributes and a vector giving the specific
	 * ordering required for encoding or conversion to a string.
	 * <p>
	 * it's is assumed the table contains OID/String pairs.
	 */
	 ...
	 * false the dir name will be encoded in the order of the (name, value) pairs
