...
public class X509LDAPCertStoreParameters implements X509StoreParameters, CertStoreParameters {
	...
	public static class Builder {
		...
		/**
		 * @param userCertificateAttribute
		 *            Attribute name(s) in the LDAP directory where end certificates are
		 *            stored. Separated by space. Defaults to "userCertificate" if
		 *            <code>null</code>.
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 */
		...
		/**
		 * @param cACertificateAttribute
		 *            Attribute name(s) in the LDAP directory where CA certificates are
		 *            stored. Separated by space. Defaults to "cACertificate" if
		 *            <code>null</code>.
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		...
		/**
		 * @param crossCertificateAttribute
		...
		/**
		 * @param deltaRevocationListAttribute
		 *            Attribute name(s) in the LDAP directory where delta RLs are
		 *            stored. Separated by space. Defaults to "deltaRevocationList" if
		 *            <code>null</code>.
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 ...
		 *            Attribute name(s) in the LDAP directory where CRLs for authorities
		 *            are stored. Separated by space. Defaults to
		...
		/**
		 * @param aACertificateAttribute
		 *            Attribute name(s) in the LDAP directory where attribute
		 *            certificates for attribute authorities are stored. Separated by
		 *            space. Defaults to "aACertificate" if <code>null</code>.
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 */
		 ...
		 *            Separated by space. Defaults to "attributeDescriptorCertificate"
		 *            if <code>null</code>.
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 ...
		 *            Attribute name(s) in the LDAP directory where CRLs for attribute
		 *            certificates are stored. Separated by space. Defaults to
		 *            "attributeCertificateRevocationList" if <code>null</code>.
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 */
		public Builder setAttributeCertificateRevocationListAttribute(
				String attributeCertificateRevocationListAttribute) {
		 ...
		 *            Attribute name(s) in the LDAP directory where RLs for attribute
		 *            authority attribute certificates are stored. Separated by space.
		 *            Defaults to "attributeAuthorityRevocationList" if
		 *            <code>null</code>.
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 ...
		 *            <code>userCertificateSubjectAttributeName</code>. E.g. if "cn" is
		 *            used to put information about the subject for end certificates,
		 *            then specify "cn".
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 ...
		 *            The attribute name(s) in the LDAP directory where to search for
		 *            the attribute value of the specified
		 *            <code>cACertificateSubjectAttributeName</code>. E.g. if "ou" is
		 *            used to put information about the subject for CA certificates,
		 *            then specify "ou".
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 ...
		 *            The attribute name(s) in the LDAP directory where to search for
		 *            the attribute value of the specified
		 *            <code>crossCertificateSubjectAttributeName</code>. E.g. if "o" is
		 *            used to put information about the subject for cross certificates,
		 *            then specify "o".
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 ...
		 *            The attribute name(s) in the LDAP directory where to search for
		 *            the attribute value of the specified
		 *            <code>certificateRevocationListIssuerAttributeName</code>. E.g. if
		 *            "ou" is used to put information about the issuer of CRLs, specify
		 *            "ou".
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 */
		public Builder setLdapCertificateRevocationListAttributeName(
				String ldapCertificateRevocationListAttributeName) {
		 ...
		 *            The attribute name(s) in the LDAP directory where to search for
		 *            the attribute value of the specified
		 *            <code>deltaRevocationListIssuerAttributeName</code>. E.g. if "ou"
		 *            is used to put information about the issuer of CRLs, specify "ou".
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 */
		 ...
		 *            The attribute name(s) in the LDAP directory where to search for
		 *            the attribute value of the specified
		 *            <code>authorityRevocationListIssuerAttributeName</code>. E.g. if
		 *            "ou" is used to put information about the issuer of CRLs, specify
		 *            "ou".
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 ...
		 *            E.g. if "cn" is used to put information about the subject of end
		 *            attribute certificates, specify "cn".
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 */
		public Builder setLdapAttributeCertificateAttributeAttributeName(
				String ldapAttributeCertificateAttributeAttributeName) {
		...
		/**
		 * @param ldapAACertificateAttributeName
		 *            The attribute name(s) in the LDAP directory where to search for
		 *            the attribute value of the specified
		 *            <code>aACertificateSubjectAttributeName</code>. E.g. if "ou" is
		 *            used to put information about the subject of attribute authority
		 *            attribute certificates, specify "ou".
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 */
		 ...
		 *            E.g. if "o" is used to put information about the subject of self
		 *            signed attribute authority attribute certificates, specify "o".
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 */
		public Builder setLdapAttributeDescriptorCertificateAttributeName(
		 ...
		 *            E.g. if "ou" is used to put information about the issuer of CRLs,
		 *            specify "ou".
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 */
		public Builder setLdapAttributeCertificateRevocationListAttributeName(
		 ...
		 * @return the builder
		 */
		public Builder setLdapAttributeAuthorityRevocationListAttributeName(
				String ldapAttributeAuthorityRevocationListAttributeName) {
		 ...
		 *            Attribute(s) in the subject of the certificate which is used to be
		 *            searched in the <code>ldapUserCertificateAttributeName</code>.
		 ...
		 *            Attribute(s) in the subject of the certificate which is used to be
		 *            searched in the <code>ldapCACertificateAttributeName</code>. E.g.
		 *            the "ou" attribute of the DN could be used.
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 */
		 ...
		 *            Attribute(s) in the subject of the cross certificate which is used
		 *            to be searched in the
		 *            <code>ldapCrossCertificateAttributeName</code>. E.g. the "o"
		 ...
		 *            Attribute(s) in the issuer of the CRL which is used to be searched
		 *            in the <code>ldapCertificateRevocationListAttributeName</code>.
		 *            E.g. the "o" or "ou" attribute may be used.
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 */
		public Builder setCertificateRevocationListIssuerAttributeName(
		 ...
		 *            Attribute(s) in the issuer of the CRL which is used to be searched
		 *            in the <code>ldapDeltaRevocationListAttributeName</code>. E.g. the
		 ...
		 *            Attribute(s) in the issuer of the CRL which is used to be searched
		 *            in the <code>ldapAuthorityRevocationListAttributeName</code>. E.g.
		 *            the "o" or "ou" attribute may be used.
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 */
		public Builder setAuthorityRevocationListIssuerAttributeName(
				String authorityRevocationListIssuerAttributeName) {
		 ...
		 *            Attribute(s) in the subject of the attribute certificate which is
		 *            used to be searched in the
		 *            <code>ldapAttributeCertificateAttributeAttributeName</code>. E.g.
		 *            the "cn" attribute of the DN could be used.
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 */
		public Builder setAttributeCertificateAttributeSubjectAttributeName(
				String attributeCertificateAttributeSubjectAttributeName) {
		 ...
		 *            Attribute(s) in the subject of the attribute certificate which is
		 *            used to be searched in the
		 *            <code>ldapAttributeDescriptorCertificateAttributeName</code>. E.g.
		 *            the "o" attribute of the DN could be used.
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 */
		public Builder setAttributeDescriptorCertificateSubjectAttributeName(
				String attributeDescriptorCertificateSubjectAttributeName) {
		 ...
		 *            E.g. the "o" or "ou" attribute may be used certificate is searched
		 *            in this LDAP attribute.
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 */
		public Builder setAttributeCertificateRevocationListIssuerAttributeName(
				String attributeCertificateRevocationListIssuerAttributeName) {
		 ...
		 * @return the builder
		 */
		public Builder setAttributeAuthorityRevocationListIssuerAttributeName(
				String attributeAuthorityRevocationListIssuerAttributeName) {
		 ...
		 *            If not <code>null</code> the serial number of the certificate is
		 *            searched in this LDAP attribute.
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 */
		...
		public X509LDAPCertStoreParameters build() {
			if (ldapUserCertificateAttributeName == null // migrate to setters
					|| ldapCACertificateAttributeName == null || ldapCrossCertificateAttributeName == null
					|| ldapCertificateRevocationListAttributeName == null
					|| ldapDeltaRevocationListAttributeName == null || ldapAuthorityRevocationListAttributeName == null
					|| ldapAttributeCertificateAttributeAttributeName == null || ldapAACertificateAttributeName == null
					...
					|| userCertificateSubjectAttributeName == null || cACertificateSubjectAttributeName == null
	...
	public boolean equal(Object o) {
		...
		return checkField(ldapURL, params.ldapURL) && checkField(baseDN, params.baseDN)
				...
				&& checkField(attributeCertificateRevocationListAttribute,
						params.attributeCertificateRevocationListAttribute)
				&& checkField(attributeAuthorityRevocationListAttribute,
						params.attributeAuthorityRevocationListAttribute)
				...
				&& checkField(ldapCertificateRevocationListAttributeName,
						params.ldapCertificateRevocationListAttributeName)
				...
				&& checkField(ldapAttributeDescriptorCertificateAttributeName,
						params.ldapAttributeDescriptorCertificateAttributeName)
				&& checkField(ldapAttributeCertificateRevocationListAttributeName,
				...
				&& checkField(certificateRevocationListIssuerAttributeName,
						params.certificateRevocationListIssuerAttributeName)
				&& checkField(deltaRevocationListIssuerAttributeName, params.deltaRevocationListIssuerAttributeName)
				&& checkField(authorityRevocationListIssuerAttributeName,
						params.authorityRevocationListIssuerAttributeName)
				&& checkField(attributeCertificateAttributeSubjectAttributeName,
						params.attributeCertificateAttributeSubjectAttributeName)
				&& checkField(aACertificateSubjectAttributeName, params.aACertificateSubjectAttributeName)
				&& checkField(attributeDescriptorCertificateSubjectAttributeName,
						params.attributeDescriptorCertificateSubjectAttributeName)
				&& checkField(attributeCertificateRevocationListIssuerAttributeName,
						params.attributeCertificateRevocationListIssuerAttributeName)
				&& checkField(attributeAuthorityRevocationListIssuerAttributeName,
						params.attributeAuthorityRevocationListIssuerAttributeName)
