...
public class PKIXAttrCertPathValidatorSpi extends CertPathValidatorSpi {
	 ...
	 * issuers with
	 * {@link org.bouncycastle.x509.ExtendedPKIXParameters#setTrustedACIssuers(java.util.Set)}.
	 * 
	 * @param certPath
	 ...
	 *             if <code>params</code> is inappropriate for this validator.
	...
	public CertPathValidatorResult engineValidate(CertPath certPath, CertPathParameters params)
		...
		if (!(certSelect instanceof X509AttributeCertStoreSelector)) {
			throw new InvalidAlgorithmParameterException("TargetConstraints must be an instance of "
