...
/**
 * @deprecated use CertificateFactory or the PEMParser in the openssl package
 *             (pkix jar).
 */
		...
		if (sData != null) {
			while (sDataObjectCount < sData.size()) {
				...
				if (obj instanceof ASN1Sequence) {
					return new X509CertificateObject(org.bouncycastle.asn1.x509.Certificate.getInstance(obj));
				}
			}
		}
