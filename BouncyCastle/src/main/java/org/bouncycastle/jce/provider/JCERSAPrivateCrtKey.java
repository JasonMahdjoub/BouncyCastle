...
public class JCERSAPrivateCrtKey extends JCERSAPrivateKey implements RSAPrivateCrtKey {
	 ...
	 *
	 * @param key
	 *            the parameters object representing the private key.
	 */
	 ...
	 *
	 * @param spec
	 *            the spec to be used in construction.
	 */
	...
	public byte[] getEncoded() {
		return KeyUtil.getEncodedPrivateKeyInfo(
				...
				new RSAPrivateKey(getModulus(), getPublicExponent(), getPrivateExponent(), getPrimeP(), getPrimeQ(),
	...
	public boolean equals(Object o) {
		...
		return this.getModulus().equals(key.getModulus()) && this.getPublicExponent().equals(key.getPublicExponent())
				...
				&& this.getPrimeP().equals(key.getPrimeP()) && this.getPrimeQ().equals(key.getPrimeQ())
