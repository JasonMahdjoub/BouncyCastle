...
class PKIXCRLUtil {
	...
	/**
	 * Return a Collection of all CRLs found in the X509Store's that are matching
	 * the crlSelect criteriums.
	 *
	 * @param crlSelect
	 *            a {@link org.bouncycastle.jcajce.PKIXCRLStoreSelector} object that
	 *            will be used to select the CRLs
	 * @param crlStores
	 *            a List containing only {@link Store} objects. These are used to
	 *            search for CRLs
	 *
	 * @return a Collection of all found {@link java.security.cert.X509CRL X509CRL}
