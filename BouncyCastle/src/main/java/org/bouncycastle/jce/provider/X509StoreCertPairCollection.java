...
public class X509StoreCertPairCollection extends X509StoreSpi {
	 ...
	 *
	 * @param params
	 *            The {@link X509CollectionStoreParameters}s for this store.
	 * @throws IllegalArgumentException
	 *             if <code>params</code> is no instance of
	 ...
	 * {@link org.bouncycastle.x509.X509CertificatePair}s. The selector must be a
	 * {@link org.bouncycastle.x509.X509CertPairStoreSelector} to select certificate
	 * pairs.
	 * </p>
	 * 
