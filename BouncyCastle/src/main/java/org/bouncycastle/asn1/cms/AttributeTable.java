...
public class AttributeTable {
	...
	/**
	 * Return all the attributes matching the OBJECT IDENTIFIER oid. The vector will
	 * be empty if there are no attributes of the required type present.
	 * 
	 * @param oid
	 *            type of attribute required.
	 ...
	 * @param attrValue
	 *            the value corresponding to the attribute (will be wrapped in a
	 *            SET).
