...
/**
 * Parser of <a href="http://tools.ietf.org/html/rfc5652#section-6.1">RFC
 * 5652</a> {@link EnvelopedData} object.
 * <p>
 * 
 * <pre>
...
public class EnvelopedDataParser {
	...
	public OriginatorInfo getOriginatorInfo() throws IOException {
		...
		if (_nextObject instanceof ASN1TaggedObjectParser && ((ASN1TaggedObjectParser) _nextObject).getTagNo() == 0) {
			ASN1SequenceParser originatorInfo = (ASN1SequenceParser) ((ASN1TaggedObjectParser) _nextObject)
