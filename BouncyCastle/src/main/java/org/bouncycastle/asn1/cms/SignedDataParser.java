...
/**
 * Parser for <a href="http://tools.ietf.org/html/rfc5652#section-5.1">RFC
 * 5652</a>: {@link SignedData} object.
 * <p>
 * 
 * <pre>
 * SignedData ::= SEQUENCE {
...
public class SignedDataParser {
	...
	public ASN1SetParser getCertificates() throws IOException {
		...
		if (_nextObject instanceof ASN1TaggedObjectParser && ((ASN1TaggedObjectParser) _nextObject).getTagNo() == 0) {
			ASN1SetParser certs = (ASN1SetParser) ((ASN1TaggedObjectParser) _nextObject).getObjectParser(BERTags.SET,
					false);
			_nextObject = null;
	...
	public ASN1SetParser getCrls() throws IOException {
		...
		if (_nextObject instanceof ASN1TaggedObjectParser && ((ASN1TaggedObjectParser) _nextObject).getTagNo() == 1) {
			ASN1SetParser crls = (ASN1SetParser) ((ASN1TaggedObjectParser) _nextObject).getObjectParser(BERTags.SET,
					false);
			_nextObject = null;
