...
public class CVCertificate extends ASN1Object {
	 ...
	 * @throws IOException
	 *             if tags or value are incorrect.
	 */
	 ...
	 *
	 * @param appSpe
	 *            the DERApplicationSpecific object.
	 * @return the Iso7816CertificateStructure represented by the
	...
	/**
	 * Gives the signature of the whole body. Type of signature is given in the
	 * Iso7816CertificateBody.Iso7816PublicKey.ASN1ObjectIdentifier
	 *
	...
	public ASN1Primitive toASN1Primitive() {
		...
		try {
			v.add(new DERApplicationSpecific(false, EACTags.STATIC_INTERNAL_AUTHENTIFICATION_ONE_STEP,
	...
	/**
	 * @return the type of certificate (request or profile) value is either
	 *         Iso7816CertificateBody.profileType or
	 *         Iso7816CertificateBody.requestType. Any other value is not valid.
	 */
	...
	/**
	 * return a bits field coded on one byte. For signification of the several bit
	 * see Iso7816CertificateHolderAuthorization
	 *
	...
	/**
	 * @return the bits corresponding to the role intented for the certificate See
	 *         Iso7816CertificateHolderAuthorization static int for values
	 * @throws IOException
	 */
	...
	/**
	 * @return the bits corresponding the authorizations contained in the
	 *         certificate See Iso7816CertificateHolderAuthorization static int for
	 *         values
	 * @throws IOException
	 */
