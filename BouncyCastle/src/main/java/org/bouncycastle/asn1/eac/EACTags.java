...
public class EACTags {
	...
	public static final int CERTIFICATE_HOLDER_AUTHORIZATION = 0x4C; // 0x5F4C Not yet defined in iso7816. The
	...
	public static int getTag(int encodedTag) {
		/*
		 * int i; for (i = 24; i>=0; i-=8) { if (((0xFF<<i) & tag) != 0) return
		 * (((0xFF<<i) & tag) >> i); } return 0;
		 */
