...
public class CertificateHolderAuthorization extends ASN1Object {
	...
	static {
		...
		/*
		 * for (int i : RightsDecodeMap.keySet()) ReverseMap.put(RightsDecodeMap.get(i),
		 * i);
		 * 
	 ...
	 * {@link DERApplicationSpecific}
	 *
	 * @param aSpe
	 *            the DERApplicationSpecific containing the data
	 * @throws IOException
	 */
	 ...
	 *
	 * @param oid
	 *            {@link ASN1ObjectIdentifier} containing the Object Identifier
	 */
	...
	/**
	 * return the Certificate Holder Authorization as a DERApplicationSpecific
	 * Object
	 */
