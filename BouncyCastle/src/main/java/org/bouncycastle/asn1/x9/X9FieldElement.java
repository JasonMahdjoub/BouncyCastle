...
public class X9FieldElement extends ASN1Object {
	 ...
	 * <li>if <i>q</i> is 2<sup>m</sup> then the bit string contained in the field
	 * element is converted into an octet string with the same ordering padded at
	 * the front if necessary.</li>
	 * </ol>
	 */
