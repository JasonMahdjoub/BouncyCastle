...
public class ASN1ObjectIdentifier extends ASN1Primitive {
	 ...
	 *
	 * @param obj
	 *            an ASN1ObjectIdentifier or an object that can be converted into
	 *            one.
	 ...
	 *
	 * @param identifier
	 *            a string representation of an OID.
	 */
	 ...
	 * <p>
	 * The pool is also used by the ASN.1 parsers to limit the number of duplicated
	 * OID objects in circulation.
	 * </p>
	 *
