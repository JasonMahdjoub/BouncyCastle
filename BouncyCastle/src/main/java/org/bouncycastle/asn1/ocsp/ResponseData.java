...
public class ResponseData extends ASN1Object {
	...
	public ResponseData(ASN1Integer version, ResponderID responderID, ASN1GeneralizedTime producedAt,
			ASN1Sequence responses, Extensions responseExtensions) {
	...
	public ResponseData(ResponderID responderID, ASN1GeneralizedTime producedAt, ASN1Sequence responses,
		...
		this(V1, responderID, ASN1GeneralizedTime.getInstance(producedAt), responses,
