...
public class SECNamedCurves {
	...
	static X9ECParametersHolder secp112r1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			X9ECPoint G = new X9ECPoint(curve,
					Hex.decode("04" + "09487239995A5EE76B55F9C2F098" + "A89CE5AF8724C0A23E0E0FF77500"));
	...
	static X9ECParametersHolder secp112r2 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			X9ECPoint G = new X9ECPoint(curve,
					Hex.decode("04" + "4BA30AB5E892B4E1649DD0928643" + "ADCD46F5882E3747DEF36E956E97"));
	...
	static X9ECParametersHolder secp128r2 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			X9ECPoint G = new X9ECPoint(curve,
					Hex.decode("04" + "7B6AA5D85E572983E6FB32A7CDEBC140" + "27B6916A894D3AEE7106FE805FC34B44"));
