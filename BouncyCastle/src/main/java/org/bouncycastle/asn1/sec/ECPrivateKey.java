...
public class ECPrivateKey extends ASN1Object {
	...
	/**
	 * @deprecated use constructor which takes orderBitLength to guarantee correct
	 *             encoding.
	 */
	 ...
	 *            the bitLength of the order of the curve.
	 * @param key
	 ...
	 * (ecPrivkeyVer1), privateKey OCTET STRING, parameters [0] Parameters OPTIONAL,
