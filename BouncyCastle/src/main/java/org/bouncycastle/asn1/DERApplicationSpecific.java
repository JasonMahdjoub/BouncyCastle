...
public class DERApplicationSpecific extends ASN1ApplicationSpecific {
	...
	/**
	 * Create an application specific object from the passed in data. This will
	 * assume the data does not represent a constructed object.
	 *
	 * @param tag
	...
	/**
	 * Create an application specific object with the tagging style given by the
	 * value of constructed.
	 *
	 * @param constructed
	 *            true if the object is constructed.
	 * @param tag
	 *            the tag number for this object.
	 * @param object
	 *            the object to be contained.
