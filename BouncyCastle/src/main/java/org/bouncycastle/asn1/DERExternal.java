...
public class DERExternal extends ASN1Primitive {
	...
	/**
	 * Creates a new instance of DERExternal See X.690 for more informations about
	 ...
	 *            The data value descriptor or <code>null</code> if not set.
	 * @param encoding
	 *            The encoding to be used for the external data
	 * @param externalData
	 *            The external data
	 */
	public DERExternal(ASN1ObjectIdentifier directReference, ASN1Integer indirectReference,
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.bouncycastle.asn1.ASN1Primitive#asn1Equals(org.bouncycastle.asn1.
	 * ASN1Primitive)
	 */
