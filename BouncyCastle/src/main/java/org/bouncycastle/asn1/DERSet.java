...
public class DERSet extends ASN1Set {
	 ...
	 * definite-length model to be used for structured types, this varies slightly
	 * from the ASN.1 descriptions given. Rather than just outputting SET, we also
	 * have to specify CONSTRUCTED, and the objects length.
	 */
