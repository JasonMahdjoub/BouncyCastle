...
public class ASN1Integer extends ASN1Primitive {
	 ...
	 *
	 * @param obj
	 *            an ASN1Integer or an object that can be converted into one.
	...
	/**
	 * in some cases positive values get crammed into a space, that's not quite big
	 * enough...
	 * 
	 * @return the BigInteger that results from treating this ASN.1 INTEGER as
	 *         unsigned.
	 */
