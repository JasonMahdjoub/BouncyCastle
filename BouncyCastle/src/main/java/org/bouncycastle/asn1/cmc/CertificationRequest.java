...
public class CertificationRequest extends ASN1Object {
	...
	public CertificationRequest(X500Name subject, AlgorithmIdentifier subjectPublicAlgorithm,
			DERBitString subjectPublicKey, ASN1Set attributes, AlgorithmIdentifier signatureAlgorithm,
			DERBitString signature) {
		this.certificationRequestInfo = new CertificationRequestInfo(subject, subjectPublicAlgorithm, subjectPublicKey,
				attributes);
	...
	/**
	 * If the public key is an encoded object this will return the ASN.1 primitives
	 * encoded - if the bitstring can't be decoded this routine throws an
	 * IOException.
	 *
	...
	private class CertificationRequestInfo extends ASN1Object {
		...
		private CertificationRequestInfo(X500Name subject, AlgorithmIdentifier algorithm, DERBitString subjectPublicKey,
				ASN1Set attributes) {
			this.version = ZERO;
