...
/**
 * DER T61String (also the teletex string) - a "modern" encapsulation that uses
 * UTF-8. If at all possible, avoid this one! It's only for emergencies. Use
 * UTF8String instead.
 * 
...
public class DERT61UTF8String extends ASN1Primitive implements ASN1String {
	...
	/**
	 * return a T61 string from the passed in object. UTF-8 Encoding is assumed in
	 * this case.
	 *
	 * @param obj
	 *            a DERT61UTF8String or an object that can be converted into one.
	...
	/**
	 * return an T61 String from a tagged object. UTF-8 encoding is assumed in this
	 * case.
	 *
	 * @param obj
