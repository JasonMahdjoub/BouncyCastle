...
public class BERSequenceGenerator extends BERGenerator {
	/**
	 * Use the passed in stream as the target for the generator, writing out the
	 * header tag for a constructed SEQUENCE.
	 *
	 * @param out
	 *            target stream
	 * @throws IOException
	...
	/**
	 * Use the passed in stream as the target for the generator, writing out the
	 * header tag for a tagged constructed SEQUENCE (possibly implicit).
	 *
	 * @param out
	 *            target stream
	 * @param tagNo
	 *            the tag number to introduce
	 * @param isExplicit
	 ...
	 * @throws IOException
	 *             if the target stream cannot be written to or the object cannot be
	 *             encoded.
	 */
