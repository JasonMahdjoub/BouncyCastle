...
public class ASN1GeneralizedTime extends ASN1Primitive {
	 ...
	 *
	 * @param obj
	 *            an ASN1GeneralizedTime or an object that can be converted into
	 *            one.
	...
	/**
	 * The correct format for this is YYYYMMDDHHMMSS[.f]Z, or without the Z for
	 * local time, or Z+-HHMM on the end, for difference between local time and UTC
	 * time. The fractional second amount f must consist of at least one number with
