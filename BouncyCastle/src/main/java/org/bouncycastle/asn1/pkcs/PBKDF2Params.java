...
public class PBKDF2Params extends ASN1Object {
	 ...
	 *
	 * @param obj
	 *            either PBKDF2Params or an ASN1Sequence.
	...
	/**
	 * Create a PBKDF2Params with the specified salt, iteration count, and
	 * algid-hmacWithSHA1 for the prf.
	 *
	 * @param salt
	 *            input salt.
	...
	/**
	 * Create a PBKDF2Params with the specified salt, iteration count, keyLength,
	 * and algid-hmacWithSHA1 for the prf.
	 *
	 * @param salt
	 *            input salt.
	 * @param iterationCount
	 *            input iteration count.
	 * @param keyLength
	 *            intended key length to be produced.
	 */
	...
	/**
	 * Create a PBKDF2Params with the specified salt, iteration count, and a defined
	 * prf.
	 *
	 * @param salt
	 *            input salt.
