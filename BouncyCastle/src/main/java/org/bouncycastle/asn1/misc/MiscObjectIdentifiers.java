...
public interface MiscObjectIdentifiers {
	//
	// Netscape
	// iso/itu(2) joint-assign(16) us(840) uscompany(1) netscape(113730)
	// cert-extensions(1) }
	//
	...
	//
	// Verisign
	// iso/itu(2) joint-assign(16) us(840) uscompany(1) verisign(113733)
	// cert-extensions(1) }
	//
	 ...
	 * nsn(7) algorithms(66) 10} SEE RFC 2984
	 */
