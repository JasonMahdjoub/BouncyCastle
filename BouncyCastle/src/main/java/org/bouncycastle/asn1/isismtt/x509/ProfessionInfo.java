...
public class ProfessionInfo extends ASN1Object {
	 ...
	 * <p>
	 * <code>professionItems</code> is mandatory, all other parameters are optional.
	 *
	 * @param namingAuthority
	 *            The naming authority.
	 * @param professionItems
	 *            Directory strings of the profession.
	 * @param professionOIDs
	 *            DERObjectIdentfier objects for the profession.
	 * @param registrationNumber
	 *            Registration number.
	 * @param addProfessionInfo
	 *            Additional infos in encoded form.
	 */
	public ProfessionInfo(NamingAuthority namingAuthority, DirectoryString[] professionItems,
			ASN1ObjectIdentifier[] professionOIDs, String registrationNumber, ASN1OctetString addProfessionInfo) {
