...
public interface ISISMTTObjectIdentifiers {
	 ...
	 * for Electronic Signatures, which additionally conforms the special
	 * requirements of the SigG and has been issued by an accredited CA.
	 * <p>
	 * 1.3.36.8.1.1
	 */
	 ...
	 * third person. May also be used as extension in a certificate.
	 * <p>
	 * OID: 1.3.36.8.3.2
	 */
	 ...
	 * certificates already in use, SigG conforming components MUST support
	...
	/**
	 * A declaration of majority. May be used as attribute in attribute certificate
	 * or as extension in a certificate
	 * <p>
	 * OID: 1.3.36.8.3.5
	 */
	...
	/**
	 * Some other restriction regarding the usage of this certificate. May be used
	 * as attribute in attribute certificate or as extension in a certificate.
	 * 
	 * <pre>
	...
	/**
	 * (Single)Request extension: Clients may include this extension in a (single)
	 * Request to request the responder to send the certificate in the response
	 * message along with the status information. Besides the LDAP service, this
	 * extension provides another mechanism for the distribution of certificates,
	 * which MAY optionally be provided by certificate repositories.
	 * 
	 * <pre>
	 ...
	 * inserting the RetrieveIfAllowed extension in the request, will be returned in
	 * this extension.
	 * <p>
	 * OID: 1.3.36.8.3.10
	 * 
	...
	/**
	 * SingleOCSPResponse extension: Date, when certificate has been published in
	 * the directory and status information has become available. Currently,
	 ...
	 * certificate. May be used as attribute in atribute certificate or as extension
	 * in a certificate.
	 * 
	 * <pre>
	...
	/**
	 * Indicates that an attribute certificate exists, which limits the usability of
	 * this public key certificate. Whenever verifying a signature with the help of
	 * this certificate, the content of the corresponding attribute certificate
	 * should be concerned. This extension MUST be included in a PKC, if a
	 * corresponding attribute certificate (having the PKC as base certificate)
	 * contains some attribute that restricts the usability of the PKC too.
	 * Attribute certificates with restricting content MUST always be included in
	 * the signed document.
	 * 
	 * <pre>
	 ...
	 */
	static final ASN1ObjectIdentifier id_isismtt_at_liabilityLimitationFlag = new ASN1ObjectIdentifier(
			"0.2.262.1.10.12.0");
}
