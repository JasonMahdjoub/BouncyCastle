...
public class DERIA5String extends ASN1Primitive implements ASN1String {
	 ...
	 *             if validate is true and the string contains characters that
	 *             should not be in an IA5String.
	 */
	...
	/**
	 * return true if the passed in String can be represented without loss as an
	 * IA5String, false otherwise.
	 *
	 * @param str
	 *            the string to check.
