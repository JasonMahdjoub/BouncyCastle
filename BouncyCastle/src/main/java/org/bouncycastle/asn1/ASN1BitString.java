...
public abstract class ASN1BitString extends ASN1Primitive implements ASN1String {
	 ...
	 * @return the correct number of pad bits for a bit string defined in a 32 bit
	 *         constant
	 */
	...
	/**
	 * Return the octets contained in this BIT STRING, checking that this BIT STRING
	 * really does represent an octet aligned string. Only use this method when the
	 * standard you are following dictates that the BIT STRING will be octet
	 * aligned.
	 *
