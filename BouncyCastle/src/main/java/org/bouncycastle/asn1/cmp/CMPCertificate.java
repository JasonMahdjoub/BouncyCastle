...
public class CMPCertificate extends ASN1Object implements ASN1Choice {
	...
	/**
	 * Note: the addition of attribute certificates is a BC extension. If you use
	 * this constructor they will be added with a tag value of 1.
	 * 
	...
	/**
	 * Note: the addition of other certificates is a BC extension. If you use this
	 * constructor they will be added with an explicit tag value of type.
	 *
	 * @param type
	 *            the type of the certificate (used as a tag value).
	 * @param otherCert
	 ...
	 * 
	 * @deprecated use getOtherCert and getOtherTag to make sure message is really
	 *             what it should be.
	 *
	 ...
	 * </pre>
	 * 
	 * Note: the addition of the explicit tagging is a BC extension. We apologise
	 * for the warped syntax, but hopefully you get the idea.
	 *
	 * @return a basic ASN.1 object representation.
	 */
	public ASN1Primitive toASN1Primitive() {
		if (otherCert != null) { // explicit following CMP conventions
