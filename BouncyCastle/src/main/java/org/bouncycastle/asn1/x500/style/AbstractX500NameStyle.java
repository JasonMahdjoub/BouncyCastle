...
public abstract class AbstractX500NameStyle implements X500NameStyle {
	...
	/**
	 * For all string values starting with '#' is assumed, that these are already
	 ...
	 * <p>
	 * Subclasses should overwrite this method to change the encoding of specific
	 * types.
	 * </p>
	 *
	 * @param oid
	 *            the DN oid of the value
	 * @param value
	 *            the String representation of the value
	 * @return a the value encoded into a ASN.1 object. Never returns
	 *         <code>null</code>.
	 */
