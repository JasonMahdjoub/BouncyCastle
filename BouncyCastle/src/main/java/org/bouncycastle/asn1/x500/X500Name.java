...
public class X500Name extends ASN1Object implements ASN1Choice {
	...
	/**
	 * return an array of OIDs contained in the attribute type of each RDN in
	 * structure order.
	 *
	...
	/**
	 * return an array of RDNs containing the attribute type given by OID in
	 * structure order.
	 *
	 * @param attributeType
	...
	public boolean equals(Object obj) {
		...
		try {
			return style.areEqual(this,
					new X500Name(ASN1Sequence.getInstance(((ASN1Encodable) obj).toASN1Primitive())));
		} catch (Exception e) {
			return false;
		}
	}
