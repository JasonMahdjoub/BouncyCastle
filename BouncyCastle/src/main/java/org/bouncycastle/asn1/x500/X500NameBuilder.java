...
public class X500NameBuilder {
	 ...
	 *
	 * @param oid
	 *            the OID for this RDN.
	 * @param value
	 *            the string representation of the value the OID refers to.
	 ...
	 *            the OID for this RDN.
	 * @param value
	 *            the ASN.1 value the OID refers to.
	 * @return the current builder instance.
	 */
	 ...
	 *
	 * @param attrTAndV
	 *            the AttributeTypeAndValue to build the RDN from.
	 * @return the current builder instance.
	 */
	...
	/**
	 * Add a multi-valued RDN made up of the passed in OIDs and associated string
	 * values.
	 *
	 * @param oids
	 *            the OIDs making up the RDN.
	 * @param values
	 *            the string representation of the values the OIDs refer to.
	 * @return the current builder instance.
	 */
	...
	/**
	 * Add a multi-valued RDN made up of the passed in OIDs and associated ASN.1
	 * values.
	 *
	 * @param oids
	 *            the OIDs making up the RDN.
	 * @param values
	 *            the ASN.1 values the OIDs refer to.
	 * @return the current builder instance.
	 */
	 ...
	 *
	 * @param attrTAndVs
	 *            the AttributeTypeAndValues to build the RDN from.
	 * @return the current builder instance.
	 */
