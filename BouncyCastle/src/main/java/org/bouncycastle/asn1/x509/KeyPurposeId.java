...
public class KeyPurposeId extends ASN1Object {
	 ...
	 */
	public static final KeyPurposeId id_kp_smartcardlogon = new KeyPurposeId(
	...
	/**
	 * Microsoft Server Gated Crypto (msSGC) see
	 * http://www.alvestrand.no/objectid/1.3.6.1.4.1.311.10.3.3.html
	 */
	public static final KeyPurposeId id_kp_msSGC = new KeyPurposeId(new ASN1ObjectIdentifier("1.3.6.1.4.1.311.10.3.3"));

	/**
	 * Netscape Server Gated Crypto (nsSGC) see
	 * http://www.alvestrand.no/objectid/2.16.840.1.113730.4.1.html
	 */
