...
public class GeneralSubtree extends ASN1Object {
	 ...
	 * 
	 * According RFC 3280, the minimum and maximum fields are not used with any name
	 * forms, thus minimum MUST be zero, and maximum MUST be absent.
	 * <p>
	 * If minimum is <code>null</code>, zero is assumed, if maximum is
	 * <code>null</code>, maximum is absent.
	 * 
	 * @param base
	 *            A restriction.
	 * @param minimum
