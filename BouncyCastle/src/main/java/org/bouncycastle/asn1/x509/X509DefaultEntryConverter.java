...
/**
 * The default converter for X509 DN entries when going from their string value
 * to ASN.1 strings.
 */
public class X509DefaultEntryConverter extends X509NameEntryConverter {
	/**
	 * Apply default coversion for the given value depending on the oid and the
	 * character range of the value.
	 * 
	 * @param oid
