...
public class TargetInformation extends ASN1Object {
	 ...
	 *            The ASN1Sequence.
	 * @throws IllegalArgumentException
	 *             if the sequence does not contain correctly encoded Targets
	 *             elements.
	 */
	...
	/**
	 * Constructs a target information from a single targets element. According to
	 * RFC 3281 only one targets element must be produced.
	 * 
	 * @param targets
	 *            A Targets instance.
	 */
	...
	/**
	 * According to RFC 3281 only one targets element must be produced. If multiple
	 * targets are given they must be merged in into one targets element.
	 *
	 * @param targets
	 ...
	 * <p>
	 * According to RFC 3281 only one targets element must be produced. If multiple
	 * targets are given in the constructor they are merged into one targets
	 * element. If this was produced from a
