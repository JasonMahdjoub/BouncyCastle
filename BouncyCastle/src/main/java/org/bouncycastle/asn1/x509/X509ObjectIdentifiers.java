...
public interface X509ObjectIdentifiers {
	...
	/**
	 * id-SHA1 OBJECT IDENTIFIER ::= {iso(1) identified-organization(3) oiw(14)
	...
	/**
	 * ripemd160 OBJECT IDENTIFIER ::= {iso(1) identified-organization(3)
	 * TeleTrust(36) algorithm(3) hashAlgorithm(2) RIPEMD-160(1)}
	 * <p>
	 * OID: 1.3.36.3.2.1
	 */
	...
	/**
	 * ripemd160WithRSAEncryption OBJECT IDENTIFIER ::= {iso(1)
	 * identified-organization(3) TeleTrust(36) algorithm(3) signatureAlgorithm(3)
	 * rsaSignature(1) rsaSignatureWithripemd160(2) }
	 * <p>
	 * OID: 1.3.36.3.3.1.2
	 */
