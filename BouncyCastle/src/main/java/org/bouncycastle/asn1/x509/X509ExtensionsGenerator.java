...
public class X509ExtensionsGenerator {
	...
	/**
	 * Add an extension with the given oid and the passed in value to be included in
	 * the OCTET STRING associated with the extension.
	 *
	 * @param oid
	 ...
	 * wrapped in the OCTET STRING associated with the extension.
	 *
	 * @param oid
	 *            OID for the extension.
	 * @param critical
	...
	/**
	 * Generate an X509Extensions object based on the current state of the
	 * generator.
	 *
