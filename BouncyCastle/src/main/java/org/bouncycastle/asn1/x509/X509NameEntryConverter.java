 ...
 * encoded into their ASN.1 counterparts is rapidly approaching the number of
 * machines on the internet. By default the X509Name class will produce
 * UTF8Strings in line with the current recommendations (RFC 3280).
 * <p>
 * An example of an encoder look like below:
 * 
 * <pre>
 * public class X509DirEntryConverter extends X509NameEntryConverter {
...
public abstract class X509NameEntryConverter {
	/**
	 * Convert an inline encoded hex string rendition of an ASN.1 object back into
	 * its corresponding ASN.1 object.
	 * 
	 * @param str
