...
/**
 * <code>NoticeReference</code> class, used in <code>CertificatePolicies</code>
...
public class NoticeReference extends ASN1Object {
	 ...
	 * Creates a new <code>NoticeReference</code> instance.
	 * <p>
	 * Useful for reconstructing a <code>NoticeReference</code> instance from its
	 * encodable/encoded form.
	 *
	 * @param as
	 *            an <code>ASN1Sequence</code> value obtained from either
	 *            calling @{link toASN1Primitive()} for a
	 *            <code>NoticeReference</code> instance or from parsing it from a
	 *            DER-encoded stream.
	 */
