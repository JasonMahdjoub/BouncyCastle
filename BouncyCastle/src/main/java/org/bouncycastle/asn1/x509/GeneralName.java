...
public class GeneralName extends ASN1Object implements ASN1Choice {
	 ...
	 * address MUST be included as an rfc822Name. The format of an rfc822Name is an
	 * "addr-spec" as defined in RFC 822 [RFC 822].
	 *
	 * When the subjectAltName extension contains a domain name service label, the
	 * domain name MUST be stored in the dNSName (an IA5String). The name MUST be in
	 * the "preferred name syntax," as specified by RFC 1034 [RFC 1034].
	 *
	 * When the subjectAltName extension contains a URI, the name MUST be stored in
	 * the uniformResourceIdentifier (an IA5String). The name MUST be a non-relative
	 * URL, and MUST follow the URL syntax and encoding rules specified in [RFC
	 * 1738]. The name must include both a scheme (e.g., "http" or "ftp") and a
	 ...
	 * corresponding byte in the network address. For IP Version 4, as specified in
	 * RFC 791, the octet string MUST contain exactly four octets. For IP Version 6,
	 * as specified in RFC 1883, the octet string MUST contain exactly sixteen
	 * octets [RFC 1883].
	 */
	 ...
	 * <li>registeredID
	 * </ul>
	 * For x400Address, otherName and ediPartyName there is no common string format
	 * defined.
	 * <p>
