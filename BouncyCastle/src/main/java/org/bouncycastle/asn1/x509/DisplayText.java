...
/**
 * <code>DisplayText</code> class, used in <code>CertificatePolicies</code> X509
 * V3 extensions (in policy qualifiers).
 *
 * <p>
...
public class DisplayText extends ASN1Object implements ASN1Choice {
	 ...
	 * @param text
	 *            the text to store. Strings longer than 200 characters are
	 *            truncated.
	 */
	 ...
	 *
	 * @param text
	 *            the text to encapsulate. Strings longer than 200 characters are
	 *            truncated.
	 */
	 ...
	 * Creates a new <code>DisplayText</code> instance.
	 * <p>
	 * Useful when reading back a <code>DisplayText</code> class from it's
	 * ASN1Encodable/DEREncodable form.
	 *
	 * @param de
