...
public class IssuingDistributionPoint extends ASN1Object {
	 ...
	 * @param indirectCRL
	 *            If <code>true</code> then the CRL contains revocation information
	 *            about certificates ssued by other CAs.
	 * @param onlyContainsAttributeCerts
	 *            Covers revocation information for attribute certificates.
	 */
	public IssuingDistributionPoint(DistributionPointName distributionPoint, boolean onlyContainsUserCerts,
			boolean onlyContainsCACerts, ReasonFlags onlySomeReasons, boolean indirectCRL,
	 ...
	 *            Covers revocation information for attribute certificates.
	 */
	public IssuingDistributionPoint(DistributionPointName distributionPoint, boolean indirectCRL,
			boolean onlyContainsAttributeCerts) {
