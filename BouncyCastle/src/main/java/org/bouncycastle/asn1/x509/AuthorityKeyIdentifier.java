...
public class AuthorityKeyIdentifier extends ASN1Object {
	...
	/**
	 *
	 * Calulates the keyidentifier using a SHA1 hash over the BIT STRING from
	 ...
	 * </pre>
	 * 
	 * @deprecated create the extension using
	...
	/**
	 * create an AuthorityKeyIdentifier with the GeneralNames tag and the serial
	...
	/**
	 * create an AuthorityKeyIdentifier with a precomputed key identifier and the
	 * GeneralNames tag and the serial number provided as well.
	 */
