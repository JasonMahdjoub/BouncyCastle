...
public class ObjectDigestInfo extends ASN1Object {
	 ...
	 * {@link #publicKey} <code>otherObjectTypeID</code> must be given, otherwise it
	 * is ignored.
	 * 
	 ...
	 *            The hash value.
	 */
	public ObjectDigestInfo(int digestedObjectType, ASN1ObjectIdentifier otherObjectTypeID,
