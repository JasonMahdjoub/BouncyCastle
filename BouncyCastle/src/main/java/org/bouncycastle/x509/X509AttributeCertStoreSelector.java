 ...
 * @deprecated use org.bouncycastle.cert.X509AttributeCertificateSelector and
 *             org.bouncycastle.cert.X509AttributeCertificateSelectorBuilder.
 */
public class X509AttributeCertStoreSelector implements Selector {
			...
			if (targetInfoExt != null) {
				...
				try {
					targetinfo = TargetInformation.getInstance(new ASN1InputStream(
							((DEROctetString) DEROctetString.fromByteArray(targetInfoExt)).getOctets()).readObject());
				} catch (IOException e) {
					return false;
	...
	/**
	 * Set the attribute certificate to be matched. If <code>null</code> is given
	 * any will do.
	 * 
	 * @param attributeCert
	...
	/**
	 * Set the time, when the certificate must be valid. If <code>null</code> is
	 * given any will do.
	 * 
	 * @param attributeCertificateValid
	...
	/**
	 * Sets the issuer the attribute certificate must have. If <code>null</code> is
	 * given any will do.
	 * 
	 * @param issuer
	 *            The issuer to set.
	 ...
	 * limiting the servers where this attribute certificate can be used. If this
	 * extension is not present, the attribute certificate is not targeted and may
	 * be accepted by any server.
	 *
	 * @param name
	 *            The name as a GeneralName (not <code>null</code>)
	 */
	 ...
	 *
	 * @param name
	 *            a byte array containing the name in ASN.1 DER encoded form of a
	 *            GeneralName
	 * @throws IOException
	...
	/**
	 * Adds a collection with target names criteria. If <code>null</code> is given
	 * any will do.
	 * <p>
	 * The collection consists of either GeneralName objects or byte[] arrays
	 * representing DER encoded GeneralName structures.
	 * 
	 * @param names
	 ...
	 *
	 * @param group
	 *            The group as GeneralName form (not <code>null</code>)
	 */
	 ...
	 *
	 * @param name
	 *            a byte array containing the group in ASN.1 DER encoded form of a
	 *            GeneralName
	 * @throws IOException
	 *             if a parsing error occurs.
	 */
	...
	/**
	 * Adds a collection with target groups criteria. If <code>null</code> is given
	 * any will do.
	 * <p>
	 * The collection consists of <code>GeneralName</code> objects or
	 * <code>byte[]</code representing DER encoded GeneralNames.
	 * 
	 * @param names
	...
	/**
	 * Gets the target groups. The collection consists of <code>GeneralName</code>
	 * objects.
	 * <p>
	 * The returned collection is immutable.
	 *
