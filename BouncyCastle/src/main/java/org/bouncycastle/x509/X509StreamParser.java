...
public class X509StreamParser implements StreamParser {
	/**
	 * Generates a StreamParser object that implements the specified type. If the
	 * default provider package provides an implementation of the requested type, an
	 * instance of StreamParser containing that implementation is returned. If the
	 ...
	 *                if the requested type is not available in the default provider
	 *                package or any of the other provider packages that were
	 *                searched.
	 */
	...
	/**
	 * Generates a X509StreamParser object for the specified type from the specified
	 * provider.
	 *
	 * @param type
	 *            the name of the requested X.509 object type.
