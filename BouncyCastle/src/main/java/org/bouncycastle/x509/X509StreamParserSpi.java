...
public abstract class X509StreamParserSpi {
	...
	/**
	 * Returns the next X.509 object of the type of this SPI from the given input
	 * stream.
	 *
	 * @return the next X.509 object in the stream or <code>null</code> if the end
	...
	/**
	 * Returns all X.509 objects of the type of this SPI from the given input
	 * stream.
	 *
