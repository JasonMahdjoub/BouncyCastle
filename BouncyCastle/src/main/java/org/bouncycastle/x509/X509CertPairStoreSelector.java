...
public class X509CertPairStoreSelector implements Selector {
	...
	/**
	 * Decides if the given certificate pair should be selected. If <code>obj</code>
	 * is not a {@link X509CertificatePair} this method returns <code>false</code>.
	 * 
	 * @param obj
	 *            The {@link X509CertificatePair} which should be tested.
