...
public abstract class ECFieldElement implements ECConstants {
	...
	public static class Fp extends ECFieldElement {
		...
		// D.1.4 91
		/**
		 * return a sqrt root - the routine verifies that the calculation returns the
		 * right value - if none exists it returns null.
		 */
	...
	public static class F2m extends ECFieldElement {
		/**
		 * Indicates gaussian normal basis representation (GNB). Number chosen according
		 * to X9.62. GNB is not implemented at present.
		 */
		public static final int GNB = 1;

		/**
		 * Indicates trinomial basis representation (TPB). Number chosen according to
		 * X9.62.
		 */
		public static final int TPB = 2;

		/**
		 * Indicates pentanomial basis representation (PPB). Number chosen according to
		 * X9.62.
		 */
		...
		/**
		 * Checks, if the ECFieldElements <code>a</code> and <code>b</code> are elements
		 * of the same field <code>F<sub>2<sup>m</sup></sub></code> (having the same
		 * representation).
		 * 
		 * @param a
		 *            field element.
		 ...
		 *             if <code>a</code> and <code>b</code> are not elements of the same
		 *             field <code>F<sub>2<sup>m</sup></sub></code> (having the same
		 *             representation).
		 */
		 ...
		 *         <code>F<sub>2<sup>m</sup></sub></code>, either of TPB (trinomial
		 *         basis representation) or PPB (pentanomial basis representation).
		 */
		...
		public boolean equals(Object anObject) {
			...
			return ((this.m == b.m) && (this.representation == b.representation) && Arrays.areEqual(this.ks, b.ks)
					&& (this.x.equals(b.x)));
		}
