...
public class SecP160R2FieldElement extends ECFieldElement {
	...
	public ECFieldElement sqrt() {
		/*
		 * Raise this element to the exponent 2^158 - 2^30 - 2^12 - 2^10 - 2^7 - 2^6 -
		 * 2^5 - 2^1 - 2^0
		 *
		 * Breaking up the exponent's binary representation into "repunits", we get: {
		 * 127 1s } { 1 0s } { 17 1s } { 1 0s } { 1 1s } { 1 0s } { 2 1s } { 3 0s } { 3
		 * 1s } { 1 0s } { 1 1s }
		 *
		 * Therefore we need an addition chain containing 1, 2, 3, 17, 127 (the lengths
		 * of the repunits) We use: [1], [2], [3], 4, 7, 14, [17], 31, 62, 124, [127]
		 */
