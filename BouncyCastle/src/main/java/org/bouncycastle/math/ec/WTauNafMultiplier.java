...
/**
 * Class implementing the WTNAF (Window <code>&tau;</code>-adic Non-Adjacent
 * Form) algorithm.
 */
public class WTauNafMultiplier extends AbstractECMultiplier {
	 ...
	 * ECPoint.AbstractF2m} by <code>k</code> using the reduced
	 ...
	 */
	private ECPoint.AbstractF2m multiplyWTnaf(ECPoint.AbstractF2m p, ZTauElement lambda, PreCompInfo preCompInfo,
			byte a, byte mu) {
	 ...
	 * Multiplies a {@link org.bouncycastle.math.ec.ECPoint.AbstractF2m
	 * ECPoint.AbstractF2m} by an element <code>&lambda;</code> of
	 * <code><b>Z</b>[&tau;]</code> using the window <code>&tau;</code>-adic NAF
	 * (TNAF) method, given the WTNAF of <code>&lambda;</code>.
	 * 
	 * @param p
	 *            The ECPoint.AbstractF2m to multiply.
	 * @param u
	 *            The the WTNAF of <code>&lambda;</code>..
