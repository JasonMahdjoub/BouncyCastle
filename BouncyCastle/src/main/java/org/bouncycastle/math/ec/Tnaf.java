...
/**
 * Class holding methods for point multiplication based on the window &tau;-adic
 * nonadjacent form (WTNAF). The algorithms are based on the paper "Improved
 * Algorithms for Arithmetic on Anomalous Binary Curves" by Jerome A. Solinas.
...
class Tnaf {
	...
	/**
	 * The window width of WTNAF. The standard value of 4 is slightly less than
	 * optimal for running time, but keeps space requirements for precomputation
	 * low. For typical curves, a value of 5 or 6 results in a better running time.
	 * When changing this value, the <code>&alpha;<sub>u</sub></code>'s must be
	 * computed differently, see e.g. "Guide to Elliptic Curve Cryptography", Darrel
	 * Hankerson, Alfred Menezes, Scott Vanstone, Springer-Verlag New York Inc.,
	 * 2004, p. 121-122
	 */
	...
	/**
	 * Computes the norm of an element <code>&lambda;</code> of
	 * <code><b>R</b>[&tau;]</code>, where <code>&lambda; = u + v&tau;</code> and
	 * <code>u</code> and <code>u</code> are real numbers (elements of
	 * <code><b>R</b></code>).
	 * 
	 * @param mu
	 *            The parameter <code>&mu;</code> of the elliptic curve.
	 * @param u
	 *            The real part of the element <code>&lambda;</code> of
	 *            <code><b>R</b>[&tau;]</code>.
	 * @param v
	...
	/**
	 * Rounds an element <code>&lambda;</code> of <code><b>R</b>[&tau;]</code> to an
	 * element of <code><b>Z</b>[&tau;]</code>, such that their difference has
	 * minimal norm. <code>&lambda;</code> is given as
	 ...
	 * @param mu
	 *            The parameter <code>&mu;</code> of the elliptic curve. Must equal
	 *            1 or -1.
	 * @return The rounded element of <code><b>Z</b>[&tau;]</code>.
	 * @throws IllegalArgumentException
	 *             if <code>lambda0</code> and <code>lambda1</code> do not have same
	 *             scale.
	 */
	...
	/**
	 * Approximate division by <code>n</code>. For an integer <code>k</code>, the
	 * value <code>&lambda; = s k / n</code> is computed to <code>c</code> bits of
	 * accuracy.
	 * 
	 * @param k
	 *            The parameter <code>k</code>.
	 * @param s
	 *            The curve parameter <code>s<sub>0</sub></code> or
	 ...
	 * @param c
	 *            The number of bits of accuracy, i.e. the scale of the returned
	 *            <code>SimpleBigDecimal</code>.
	 * @return The value <code>&lambda; = s k / n</code> computed to <code>c</code>
	 *         bits of accuracy.
	 */
	...
	/**
	 * Computes the <code>&tau;</code>-adic NAF (non-adjacent form) of an element
	 ...
	 * 
	 * @param p
	 *            The ECPoint.AbstractF2m to which <code>&tau;()</code> is applied.
	 ...
	 * 
	 * @param curve
	 *            The elliptic curve from which to obtain <code>&mu;</code>. The
	 *            curve must be a Koblitz curve, i.e. <code>a</code> equals
	 ...
	 *            The parameter <code>&mu;</code> of the elliptic curve.
	 * @param k
	 *            The index of the second element of the Lucas Sequence to be
	 *            returned.
	 * @param doV
	 *            If set to true, computes <code>V<sub>k-1</sub></code> and
	 *            <code>V<sub>k</sub></code>, otherwise <code>U<sub>k-1</sub></code>
	 *            and <code>U<sub>k</sub></code>.
	...
	/**
	 * Computes the auxiliary value <code>t<sub>w</sub></code>. If the width is 4,
	 * then for <code>mu = 1</code>, <code>t<sub>w</sub> = 6</code> and for
	 ...
	 * 
	 * @param curve
	 *            The elliptic curve for which to compute <code>s<sub>0</sub></code>
	 *            and <code>s<sub>1</sub></code>.
	 * @throws IllegalArgumentException
	 *             if <code>curve</code> is not a Koblitz curve (Anomalous Binary
	 *             Curve, ABC).
	 */
	 ...
	 * @param c
	 *            The precision (number of bits of accuracy) of the partial modular
	 *            reduction.
	 ...
	 * ECPoint.AbstractF2m} by a <code>BigInteger</code> using the reduced
	 * <code>&tau;</code>-adic NAF (RTNAF) method.
	 * 
	 * @param p
	 *            The ECPoint.AbstractF2m to multiply.
	 * @param k
	...
	/**
	 * Multiplies a {@link org.bouncycastle.math.ec.ECPoint.AbstractF2m
	 * ECPoint.AbstractF2m} by an element <code>&lambda;</code> of
	 * <code><b>Z</b>[&tau;]</code> using the <code>&tau;</code>-adic NAF (TNAF)
	 * method.
	 * 
	 * @param p
	 *            The ECPoint.AbstractF2m to multiply.
	 ...
	 * ECPoint.AbstractF2m} by an element <code>&lambda;</code> of
	 * <code><b>Z</b>[&tau;]</code> using the <code>&tau;</code>-adic NAF (TNAF)
	 * method, given the TNAF of <code>&lambda;</code>.
	 * 
	 * @param p
	 *            The ECPoint.AbstractF2m to multiply.
	 * @param u
	 ...
	 * @param lambda
	 *            The element <code>&lambda;</code> of <code><b>Z</b>[&tau;]</code>
	 *            of which to compute the <code>[&tau;]</code>-adic NAF.
	 * @param width
