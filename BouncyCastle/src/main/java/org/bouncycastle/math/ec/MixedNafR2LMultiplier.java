 ...
 * (right-to-left) using mixed coordinates.
 */
public class MixedNafR2LMultiplier extends AbstractECMultiplier {
	protected int additionCoord, doublingCoord;

	/**
	 * By default, addition will be done in Jacobian coordinates, and doubling will
	 * be done in Modified Jacobian coordinates (independent of the original
