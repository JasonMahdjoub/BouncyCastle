 ...
 * PQC:
 * <p>
 * { iso(1) identifier-organization(3) dod(6) internet(1) private(4) 1 8301 3 1
 * 3 5 3 ... }
 */
public interface PQCObjectIdentifiers {
	...
	public static final ASN1ObjectIdentifier mcElieceFujisaki = new ASN1ObjectIdentifier(
			"1.3.6.1.4.1.8301.3.1.3.4.2.1");
	public static final ASN1ObjectIdentifier mcEliecePointcheval = new ASN1ObjectIdentifier(
			"1.3.6.1.4.1.8301.3.1.3.4.2.2");
	public static final ASN1ObjectIdentifier mcElieceKobara_Imai = new ASN1ObjectIdentifier(
