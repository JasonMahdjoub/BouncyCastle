...
public class NTRUEncryptionPublicKeyParameters extends NTRUEncryptionKeyParameters {
	 ...
	 *
	 * @param h
	 *            the polynomial <code>h</code> which determines the key
	 * @param params
	...
	/**
	 * Converts a byte array to a polynomial <code>h</code> and constructs a new
	 * public key
	 *
	 * @param b
	...
	/**
	 * Reads a polynomial <code>h</code> from an input stream and constructs a new
	 * public key
	 *
	 * @param is
	 *            an input stream
	 ...
	 *            an output stream
	 * @throws IOException
	 * @see #NTRUEncryptionPublicKeyParameters(InputStream,
