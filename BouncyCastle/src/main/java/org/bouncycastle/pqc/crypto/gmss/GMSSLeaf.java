...
public class GMSSLeaf {
	 ...
	 * @param w
	 *            the winterniz parameter of that tree the leaf is computed for
	 * @param numLeafs
	 ...
	 *            the starting seed
	 */
	// TODO: this really looks like it should be either always called from a
	// constructor or nextLeaf.
