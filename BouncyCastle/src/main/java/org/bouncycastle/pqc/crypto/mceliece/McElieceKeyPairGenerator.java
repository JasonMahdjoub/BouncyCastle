...
public class McElieceKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
	...
	private void initializeDefault() {
		McElieceKeyGenerationParameters mcParams = new McElieceKeyGenerationParameters(new SecureRandom(),
	...
	private AsymmetricCipherKeyPair genKeyPair() {
		...
		McEliecePrivateKeyParameters privKey = new McEliecePrivateKeyParameters(n, k, field, gp, p1, p2,
				matrixSandInverse[1]);
