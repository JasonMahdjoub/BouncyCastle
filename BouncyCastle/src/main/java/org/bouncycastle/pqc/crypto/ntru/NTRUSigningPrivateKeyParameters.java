 ...
 * {@link NTRUSigningPrivateKeyParameters.Basis} of three polynomials each,
...
public class NTRUSigningPrivateKeyParameters extends AsymmetricKeyParameter {
	...
	public static class Basis {
		 ...
		 *            NtruSign parameters
		 */
		protected Basis(Polynomial f, Polynomial fPrime, IntegerPolynomial h,
				NTRUSigningKeyGenerationParameters params) {
			this.f = f;
			this.fPrime = fPrime;
			this.h = h;
		 ...
		 *            NtruSign parameters
		 * @param include_h
		 *            whether to read the polynomial <code>h</code> (<code>true</code>)
		 *            or only <code>f</code> and <code>f'</code> (<code>false</code>)
		 */
		 ...
		 *            an output stream
		 * @param include_h
		 *            whether to write the polynomial <code>h</code> (<code>true</code>)
		 *            or only <code>f</code> and <code>f'</code> (<code>false</code>)
		 * @throws IOException
		 */
