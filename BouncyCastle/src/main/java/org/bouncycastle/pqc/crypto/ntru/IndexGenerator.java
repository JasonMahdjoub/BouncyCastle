...
public class IndexGenerator {
	 ...
	 *
	 * @param seed
	 *            a seed of arbitrary length to initialize the index generator with
	 * @param params
	...
	/**
	 * Represents a string of bits and supports appending, reading the head, and
	 * reading the tail.
	 */
	public static class BitString {
		 ...
		 * @param numBits
		 *            number of bits
		 * @return an <code>int</code> whose lower <code>numBits</code> bits are the
		 *         beginning of the bit string
		 */
