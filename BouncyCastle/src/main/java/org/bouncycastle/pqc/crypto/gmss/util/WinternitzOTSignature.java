...
public class WinternitzOTSignature {
	...
	/**
	 * An array of strings, containing the name of the used hash function, the name
	 * of the PRGN and the names of the corresponding providers
	 */
	...
	/**
	 * The constructor generates an OTS key pair, using <code>seed0</code> and the
	 * PRNG
	 *
	 * @param seed0
	 ...
	 *            function, the name of the PRGN and the names of the corresponding
	 *            providers
	 * @param w
	 *            the Winternitz parameter
	 */
	...
	/**
	 * @return The one-time signature of the message, generated with the private key
	 */
