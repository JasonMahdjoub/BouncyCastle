...
public class GMSSUtil {
	/**
	 * Converts a 32 bit integer into a byte array beginning at <code>offset</code>
	...
	/**
	 * Converts a byte array beginning at <code>offset</code> into a 32 bit integer
	 * (little-endian representation)
	 *
	 * @param bytes
	 *            the byte array
	...
	/**
	 * This method concatenates a 2-dimensional byte array into a 1-dimensional byte
	 * array
	 *
	 * @param arraycp
