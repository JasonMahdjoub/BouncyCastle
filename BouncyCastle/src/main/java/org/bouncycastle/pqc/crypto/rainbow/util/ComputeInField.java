...
public class ComputeInField {
	...
	/**
	 * This function finds a solution of the equation Bx = b. Exception is thrown if
	 * the linear equation system has no solution
	 *
	 * @param B
	 *            this matrix is the left part of the equation (B in the equation
	 *            above)
	 * @param b
	 *            the right part of the equation (b in the equation above)
	...
	public short[] solveEquation(short[][] B, short[] b) {
		try {
			...
			// In this column we store a free coefficient that should be later subtracted
			// from b
	 ...
	 *
	 * @param coef
	 *            the matrix which inverse matrix is needed
	 * @return inverse matrix of the input matrix. If the matrix is singular, null
	 *         is returned.
	 * @throws RuntimeException
	 ...
	 * operations.
	 * <p>
	 * It is used in solveEquaton as well as in the function for finding an inverse
	 * of a matrix: {@link}inverse. Both of them use the Gauss-Elimination Method.
	 * </p>
	 * <p>
	 * The result is stored in the global matrix A
	 * </p>
	 * 
	 * @param usedForInverse
	 *            This parameter shows if the function is used by the
	 *            solveEquation-function or by the inverse-function and according to
	 *            this creates matrices of different sizes.
	 * @throws RuntimeException
	 *             in case a multiplicative inverse of 0 is needed
	 */
	private void computeZerosUnder(boolean usedForInverse) throws RuntimeException {
		...
		// the function is used in inverse() - A should have 2 times more columns than
		// rows
		if (usedForInverse) {
			length = 2 * A.length;
		}
		...
		// elimination operations to modify A so that that it contains only 0s under the
		// diagonal
	 ...
	 * operations.
	 * <p>
	 * It is used in the inverse-function The result is stored in the global matrix
	 * A
	 * </p>
	 * 
	 * @throws RuntimeException
	 ...
	 * system (LES) B*x = b, where A a triangle-matrix is (contains only zeros under
	 * the diagonal) and b is a vector
	 * <p>
	 * If the multiplicative inverse of 0 is needed, an exception is thrown. In this
	 * case is the LES not solvable
	 * </p>
	 * 
	 * @throws RuntimeException
	 *             in case a multiplicative inverse of 0 is needed
	...
	/**
	 * This function multiplies two given matrices. If the given matrices cannot be
	 * multiplied due to different sizes, an exception is thrown.
	 *
	 * @param M1
	 *            -the 1st matrix
	 * @param M2
	 ...
	 * @return A = M1*M2
	 * @throws RuntimeException
	 *             in case the given matrices cannot be multiplied due to different
	 *             dimensions.
	 */
	 ...
	 * <p>
	 * An exception is thrown, if the number of columns in the matrix and the number
	 * of rows in the one-dim. array differ.
	 *
	 * @param M1
	 *            the matrix to be multiplied
	 * @param m
	 *            the one-dimensional array to be multiplied
	 * @return M1*m
	 * @throws RuntimeException
	 ...
	 *
	 * @param vector1
	 *            first summand, always of dim n
	 * @param vector2
	 *            second summand, always of dim n
	 * @return addition of vector1 and vector2
	 * @throws RuntimeException
	 *             in case the addition is impossible due to inconsistency in the
	 *             dimensions
	 */
	 ...
	 *
	 * @param vector1
	 *            column vector, always n x 1
	 * @param vector2
	 *            row vector, always 1 x n
	 * @return resulting n x n matrix of multiplication
	 * @throws RuntimeException
	 *             in case the multiplication is impossible due to inconsistency in
	 *             the dimensions
	 */
	 ...
	 *
	 * @param scalar
	 *            galois element to multiply vector with
	 * @param vector
	 ...
	 *
	 * @param scalar
	 *            galois element to multiply matrix with
	 * @param matrix
	 *            2-dim n x n matrix to be multiplied
	 ...
	 * @throws RuntimeException
	 *             in case the addition is not possible because of different
