...
public class Layer {
	 ...
	 * @param viNext
	 *            number of vinegar variables of next layer. It's the same as (num
	 *            of oils) + (num of vinegars) of this layer.
	 * @param coeffAlpha
	 *            alpha-coefficients in the polynomials of this layer
	 * @param coeffBeta
	 *            beta-coefficients in the polynomials of this layer
	 * @param coeffGamma
	 *            gamma-coefficients in the polynomials of this layer
	 * @param coeffEta
	 *            eta-coefficients in the polynomials of this layer
	 */
	public Layer(byte vi, byte viNext, short[][][] coeffAlpha, short[][][] coeffBeta, short[][] coeffGamma,
			short[] coeffEta) {
		this.vi = vi & 0xff;
	...
	/**
	 * This function generates the coefficients of all polynomials in this layer at
	 * random using random generator.
	 *
	 * @param sr
	...
	/**
	 * This method plugs in the vinegar variables into the polynomials of this layer
	 * and computes the coefficients of the Oil-variables as well as the free
	 * coefficient in each polynomial.
	 * <p>
	 * It is needed for computing the Oil variables while signing.
	 *
	 * @param x
	 *            vinegar variables of this layer that should be plugged into the
	 *            polynomials.
	...
	public boolean equals(Object other) {
		...
		return vi == otherLayer.getVi() && viNext == otherLayer.getViNext() && oi == otherLayer.getOi()
