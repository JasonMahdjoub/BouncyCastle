...
public class McElieceCCA2KeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
	...
	private void initializeDefault() {
		McElieceCCA2KeyGenerationParameters mcCCA2Params = new McElieceCCA2KeyGenerationParameters(new SecureRandom(),
	...
	public AsymmetricCipherKeyPair generateKeyPair() {
		...
		PolynomialGF2mSmallM gp = new PolynomialGF2mSmallM(field, t, PolynomialGF2mSmallM.RANDOM_IRREDUCIBLE_POLYNOMIAL,
				random);
		...
		McElieceCCA2PrivateKeyParameters privKey = new McElieceCCA2PrivateKeyParameters(n, k, field, gp, p,
				mcElieceCCA2Params.getParameters().getDigest());
