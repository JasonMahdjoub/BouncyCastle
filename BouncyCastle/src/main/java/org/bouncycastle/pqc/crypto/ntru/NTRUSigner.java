 ...
 * 
 * @deprecated the NTRUSigner algorithm was broken in 2012 by Ducas and Nguyen.
 *             See <a href=
...
public class NTRUSigner {
	...
	/**
	 * Adds data to sign and computes a signature over this data and any data
	 * previously added via {@link #update(byte[], int, int)}.
	 *
	 * @return a signature
	 * @throws IllegalStateException
	 *             if <code>initSign</code> was not called
	 */
		...
		do {
			...
			if (r > params.signFailTolerance) {
				throw new IllegalStateException(
						"Signing failed: too many retries (max=" + params.signFailTolerance + ")");
			}
	 ...
	 * @throws IllegalStateException
	 *             if <code>initVerify</code> was not called
	 */
