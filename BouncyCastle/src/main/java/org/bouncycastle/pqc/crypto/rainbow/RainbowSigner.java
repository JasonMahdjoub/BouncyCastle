 ...
 * Here the message, which has to be signed, is updated. The use of different
 * hash functions is possible.
 * <p>
...
public class RainbowSigner implements MessageSigner {
	 ...
	 * private key.
	 * <p>
	 * For computing the signature, L1 and L2 are needed, as well as LES should be
	 * solved for each layer in order to find the Oil-variables in the layer.
	 * <p>
		...
		do {
			...
			try {
				...
				for (int i = 0; i < numberOfLayers; i++) {
					...
					/*
					 * plug in the vars of the previous layer in order to get the vars of the
					 * current layer
					 */
	...
	/**
	 * This function creates the representative of the message which gets signed or
	 * verified.
	 *
	 * @param message
	 *            the message
