...
public class McEliecePrivateKeyParameters extends McElieceKeyParameters {
	 ...
	 */
	public McEliecePrivateKeyParameters(int n, int k, GF2mField field, PolynomialGF2mSmallM gp, Permutation p1,
			Permutation p2, GF2Matrix sInv) {
		super(true, null);
		this.k = k;
		this.n = n;
		this.field = field;
	 ...
	 * @param encSInv
	 *            the encoded matrix <tt>S<sup>-1</sup></tt>
	 * @param encP1
	 *            the encoded permutation used to generate the systematic check
	 *            matrix
	 * @param encP2
	 *            the encoded permutation used to compute the public generator
	 *            matrix
	 * @param encH
	 ...
	 */
	public McEliecePrivateKeyParameters(int n, int k, byte[] encField, byte[] encGoppaPoly, byte[] encSInv,
			byte[] encP1, byte[] encP2, byte[] encH, byte[][] encQInv) {
		super(true, null);
		this.n = n;
		this.k = k;
