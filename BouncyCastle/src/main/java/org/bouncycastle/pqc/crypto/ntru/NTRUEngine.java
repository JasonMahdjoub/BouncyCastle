...
public class NTRUEngine implements AsymmetricBlockCipher {
	...
	/**
	 * Deterministically generates a blinding polynomial from a seed and a message
	 * representative.
	 *
	 * @param seed
	 * @param M
	...
	/**
	 * Generates an <code>int</code> array containing <code>dr</code> elements equal
	 * to <code>1</code> and <code>dr</code> elements equal to <code>-1</code> using
	 * an index generator.
	 *
	 * @param ig
	 *            an index generator
	 * @param dr
	 *            number of ones / negative ones
	 * @return an array containing numbers between <code>-1</code> and
	 *         <code>1</code>
	 */
	 ...
	 *             if the encrypted data is invalid, or <code>maxLenBytes</code> is
	 *             greater than 255
	 */
	 ...
	 * @param e
	 * @param priv_t
	 *            a polynomial such that if <code>fastFp=true</code>,
	 *            <code>f=1+3*priv_t</code>; otherwise, <code>f=priv_t</code>
	 * @param priv_fp
