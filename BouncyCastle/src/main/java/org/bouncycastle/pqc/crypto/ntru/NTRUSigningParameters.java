...
public class NTRUSigningParameters implements Cloneable {
	 ...
	 *            <code>getDigestLength()</code> method.
	 */
	public NTRUSigningParameters(int N, int q, int d1, int d2, int d3, int B, double beta, double normBound,
			double keyNormBound, Digest hashAlg) {
		this.N = N;
		this.q = q;
		this.d1 = d1;
		this.d2 = d2;
	...
	public String toString() {
		...
		output.append(" B=" + B + " beta=" + format.format(beta) + " normBound=" + format.format(normBound)
				+ " hashAlg=" + hashAlg + ")");
