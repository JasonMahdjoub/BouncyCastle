 ...
 * which takes different forms depending on whether product-form polynomials are
 * used, and on <code>fastP</code><br>
 * The inverse of <code>f</code> modulo <code>p</code> is precomputed on
 * initialization.
 */
public class NTRUEncryptionPrivateKeyParameters extends NTRUEncryptionKeyParameters {
	 ...
	 *
	 * @param h
	 *            the public polynomial for the key.
	 * @param t
	 *            the polynomial which determines the key: if
	 *            <code>fastFp=true</code>, <code>f=1+3t</code>; otherwise,
	 *            <code>f=t</code>
	 * @param fp
	 ...
	 */
	public NTRUEncryptionPrivateKeyParameters(IntegerPolynomial h, Polynomial t, IntegerPolynomial fp,
	...
	/**
	 * Converts a byte array to a polynomial <code>f</code> and constructs a new
	 * private key
	 *
	 * @param b
	...
	/**
	 * Reads a polynomial <code>f</code> from an input stream and constructs a new
	 * private key
	 *
	 * @param is
	 *            an input stream
	 ...
	 *            an output stream
	 * @throws IOException
	 * @see #NTRUEncryptionPrivateKeyParameters(InputStream,
