...
public class RainbowKeyFactorySpi extends KeyFactorySpi implements AsymmetricKeyInfoConverter {
	 ...
	 * {@link BCRainbowPrivateKey}. Currently, the following key specifications are
	 * supported: {@link RainbowPrivateKeySpec}, {@link PKCS8EncodedKeySpec}.
	 * <p>
	...
	/**
	 * Converts, if possible, a key specification into a {@link BCRainbowPublicKey}.
	...
	public final KeySpec engineGetKeySpec(Key key, Class keySpec) throws InvalidKeySpecException {
		if (key instanceof BCRainbowPrivateKey) {
			if (PKCS8EncodedKeySpec.class.isAssignableFrom(keySpec)) {
				...
				return new RainbowPrivateKeySpec(privKey.getInvA1(), privKey.getB1(), privKey.getInvA2(),
						privKey.getB2(), privKey.getVi(), privKey.getLayers());
			}
			...
			if (X509EncodedKeySpec.class.isAssignableFrom(keySpec)) {
				...
				return new RainbowPublicKeySpec(pubKey.getDocLength(), pubKey.getCoeffQuadratic(),
	...
	public PrivateKey generatePrivate(PrivateKeyInfo keyInfo) throws IOException {
		...
		return new BCRainbowPrivateKey(pKey.getInvA1(), pKey.getB1(), pKey.getInvA2(), pKey.getB2(), pKey.getVi(),
				pKey.getLayers());
	}
	...
	public PublicKey generatePublic(SubjectPublicKeyInfo keyInfo) throws IOException {
		...
		return new BCRainbowPublicKey(pKey.getDocLength(), pKey.getCoeffQuadratic(), pKey.getCoeffSingular(),
				pKey.getCoeffScalar());
	}
}
