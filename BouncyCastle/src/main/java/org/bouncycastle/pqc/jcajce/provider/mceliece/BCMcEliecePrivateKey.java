...
public class BCMcEliecePrivateKey implements CipherParameters, PrivateKey {
	...
	public boolean equals(Object other) {
		...
		return (getN() == otherKey.getN()) && (getK() == otherKey.getK()) && getField().equals(otherKey.getField())
				&& getGoppaPoly().equals(otherKey.getGoppaPoly()) && getSInv().equals(otherKey.getSInv())
				&& getP1().equals(otherKey.getP1()) && getP2().equals(otherKey.getP2());
	}
	...
	public byte[] getEncoded() {
		McEliecePrivateKey privateKey = new McEliecePrivateKey(params.getN(), params.getK(), params.getField(),
				params.getGoppaPoly(), params.getP1(), params.getP2(), params.getSInv());
		PrivateKeyInfo pki;
		try {
