...
/**
 * The AsymmetricHybridCipher class extends CipherSpiExt. NOTE: Some Ciphers are
...
public abstract class AsymmetricHybridCipher extends CipherSpiExt {
	 ...
	 * </p>
	 * 
	 * @return the parameters used with this cipher, or <tt>null</tt> if this cipher
	 ...
	 * parameters can be retrieved using {@link #getParameters()}.
	 * </p>
	 * 
	 * @param key
	 *            the encryption key
	 ...
	 *             if this cipher needs algorithm parameters for initialization and
	 *             cannot generate parameters itself.
	 */
	 ...
	 *             cipher, or if this cipher is initialized with <tt>null</tt>
	 *             parameters and cannot generate parameters itself.
	 */
	 ...
	 * <p>
	 * If this cipher requires any random bytes (e.g., for parameter generation), it
	 * will get them from <tt>random</tt>.
	 * </p>
	 * <p>
