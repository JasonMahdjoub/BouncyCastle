...
public class McElieceCCA2KeyPairGeneratorSpi extends KeyPairGenerator {
	...
	public void initialize(AlgorithmParameterSpec params) throws InvalidAlgorithmParameterException {
		...
		McElieceCCA2KeyGenerationParameters mccca2KGParams = new McElieceCCA2KeyGenerationParameters(new SecureRandom(),
				new McElieceCCA2Parameters(ecc.getM(), ecc.getT(), ecc.getDigest()));
	...
	public void initialize(int keySize, SecureRandom random) {
		...
		McElieceCCA2KeyGenerationParameters mccca2KGParams = new McElieceCCA2KeyGenerationParameters(random,
