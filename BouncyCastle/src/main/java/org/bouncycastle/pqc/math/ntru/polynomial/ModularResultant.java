...
public class ModularResultant extends Resultant {
	...
	/**
	 * Calculates a <code>rho</code> modulo <code>m1*m2</code> from two resultants
	 * whose <code>rho</code>s are modulo <code>m1</code> and <code>m2</code>.<br/>
	 * </code>res</code> is set to <code>null</code>.
	 *
	 * @param modRes1
	 * @param modRes2
	 * @return <code>rho</code> modulo
	 *         <code>modRes1.modulus * modRes2.modulus</code>, and <code>null</code>
	 *         for </code>res</code>.
	 */
