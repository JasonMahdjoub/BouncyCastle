...
public class GF2Matrix extends Matrix {
	 ...
	 * @param typeOfMatrix
	 *            the martix type (see {@link Matrix} for predefined constants)
	 */
	...
	/**
	 * Compute the full form matrix <tt>(this | Id)</tt> from this matrix in left
	 * compact form, where <tt>Id</tt> is the <tt>k x k</tt> identity matrix and
	 * <tt>k</tt> is the number of rows of this matrix.
	 *
	...
	/**
	 * Compute the full form matrix <tt>(Id | this)</tt> from this matrix in right
	 * compact form, where <tt>Id</tt> is the <tt>k x k</tt> identity matrix and
	 * <tt>k</tt> is the number of rows of this matrix.
	 *
	...
	/**
	 * Compute the product of the matrix <tt>(this | Id)</tt> and a column vector,
	 * where <tt>Id</tt> is a <tt>(numRows x numRows)</tt> unit matrix.
	 *
	 * @param vec
	 *            the vector over GF(2)
	...
	/**
	 * Compute the product of the matrix <tt>(Id | this)</tt> and a column vector,
	 * where <tt>Id</tt> is a <tt>(numRows x numRows)</tt> unit matrix.
	 *
	 * @param vec
	 *            the vector over GF(2)
