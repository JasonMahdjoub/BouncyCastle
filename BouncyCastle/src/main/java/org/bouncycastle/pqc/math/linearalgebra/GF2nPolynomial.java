...
public class GF2nPolynomial {
	...
	/**
	 * Creates a new PolynomialGF2n of size <i>deg</i> and elem as coefficients.
	 *
	 * @param deg
	...
	/**
	 * Creates a new PolynomialGF2n from the given Bitstring <i>polynomial</i> over
	 * the GF2nField <i>B1</i>.
	 *
	 * @param polynomial
	...
	public GF2nPolynomial(GF2Polynomial polynomial, GF2nField B1) {
		...
		if (B1 instanceof GF2nONBField) {
			...
			throw new IllegalArgumentException("PolynomialGF2n(Bitstring, GF2nField): B1 must be "
	...
	/**
	 * Returns the size (=maximum degree + 1) of this PolynomialGF2n. This is not
	 * the degree, use getDegree instead.
	 *
	...
	/**
	 * Adds the PolynomialGF2n <tt>b</tt> to <tt>this</tt> and returns the result in
	 * a new <tt>PolynomialGF2n</tt>.
	 *
	 * @param b
	 *            - the <tt>PolynomialGF2n</tt> to add
	 * @return <tt>this + b</tt>
	 * @throws DifferentFieldsException
	 *             if <tt>this</tt> and <tt>b</tt> are not defined over the same
	 *             field.
	 */
	...
	/**
	 * Multiplies the scalar <i>s</i> to each coefficient of this PolynomialGF2n and
	 ...
	 * @throws DifferentFieldsException
	 *             if <tt>this</tt> and <tt>s</tt> are not defined over the same
	 *             field.
	 */
	 ...
	 * @throws DifferentFieldsException
	 *             if <tt>this</tt>, <tt>b</tt> and <tt>g</tt> are not all defined
	 *             over the same field.
	 */
	 ...
	 * @throws DifferentFieldsException
	 *             if <tt>this</tt> and <tt>g</tt> are not defined over the same
	 *             field.
	 */
	...
	/**
	 * Shifts left <i>this</i> by <i>amount</i> and stores the result in <i>this</i>
	 * PolynomialGF2n.
	 *
	 * @param amount
	...
	/**
	 * Computes the greatest common divisor of <i>this</i> and <i>g</i> and returns
	 * the result in a new PolynomialGF2n.
	 *
	 * @param g
	 *            - a GF2nPolynomial
	 * @return gcd(<i>this</i>, <i>g</i>)
	 * @throws DifferentFieldsException
	 *             if the coefficients of <i>this</i> and <i>g</i> use different
	 *             fields
