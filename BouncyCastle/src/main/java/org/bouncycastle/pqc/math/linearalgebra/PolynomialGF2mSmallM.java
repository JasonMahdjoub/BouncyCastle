...
public class PolynomialGF2mSmallM {
	 ...
	 * <tt>poly(X) -> [coef_0, coef_1, ...]</tt> is used, where <tt>coef_i</tt> is
	 * the <tt>i</tt>th coefficient of the polynomial represented as int (see
	 * {@link GF2mField}). The polynomials are stored as int arrays.
	 */
	...
	public PolynomialGF2mSmallM(GF2mField field, int deg, char typeOfPolynomial, SecureRandom sr) {
		...
		default:
			throw new IllegalArgumentException(
					" Error: type " + typeOfPolynomial + " is not defined for GF2smallmPolynomial");
		}
		computeDegree();
	}
	...
	/**
	 * Construct the polynomial over the given finite field GF(2^m) from the given
	 * coefficient vector.
	 *
	 * @param field
	 *            finite field GF2m
	 ...
	 *
	 * @param other
	 *            another {@link PolynomialGF2mSmallM}
	 */
	 ...
	 *
	 * @return int degree of this polynomial if this is zero polynomial return -1
	 */
	 ...
	 *
	 * @param e
	 *            the element of the finite field GF(2^m)
	 * @return <tt>this(e)</tt>
	 */
	 ...
	 *
	 * @param element
	 *            an element of the finite field GF(2^m)
	 * @return <tt>this * element</tt> (newly created)
	 * @throws ArithmeticException
	 *             if <tt>element</tt> is not an element of the finite field this
	...
	/**
	 * Compute the product of a polynomial a with an element from the finite field
	 * <tt>GF(2^m)</tt>.
	 *
	 * @param a
	 *            the polynomial
	...
	public PolynomialGF2mSmallM[] div(PolynomialGF2mSmallM f) {
		...
		return new PolynomialGF2mSmallM[] { new PolynomialGF2mSmallM(field, resultCoeffs[0]),
	...
	/**
	 * Compute the product of this polynomial and the given factor using a Karatzuba
	 * like scheme.
	 *
	 * @param factor
	 *            the polynomial
	...
	/**
	 * Compute the product of two polynomials over the field <tt>GF(2^m)</tt> using
	 * a Karatzuba like multiplication.
	 *
	 * @param a
	 *            the first polynomial
	 * @param b
	...
	/**
	 * Compute the product of this polynomial and another polynomial modulo a third
	 * polynomial.
	 *
	 * @param a
	 *            another polynomial
	 ...
	 * @param matrix
	 *            the squaring matrix
	 * @return <tt>this^2</tt> modulo the reduction polynomial implicitly given via
	 *         the squaring matrix
	 */
	 ...
	 *
	 * @param matrix
	 *            the matrix for computing square roots in <tt>(GF(2^m))^t</tt> the
	 *            polynomial ring defining the square root matrix
	 * @return <tt>this^(1/2)</tt> modulo the reduction polynomial implicitly given
	 *         via the square root matrix
	 */
	...
	/**
	 * Compute the result of the division of this polynomial by another polynomial
	...
	/**
	 * Compute a polynomial pair (a,b) from this polynomial and the given polynomial
	 * g with the property b*this = a mod g and deg(a)&lt;=deg(g)/2.
	 *
	 * @param g
	 *            the reduction polynomial
	...
	/**
	 * Compute the degree of this polynomial. If this is the zero polynomial, the
	 * degree is -1.
	 */
	 ...
	 * @param a
	 *            the polynomial
	 * @return the degree of the polynomial <tt>a</tt>. If <tt>a</tt> is the zero
	 *         polynomial, return -1.
	 */
