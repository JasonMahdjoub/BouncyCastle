...
public class GF2Vector extends Vector {
	...
	/**
	 * Construct a random GF2Vector of the given length with the specified number of
	...
	/**
	 * Construct a GF2Vector of the given length and with elements from the given
	 * array. The array is copied and unused bits are masked out.
	 *
	 * @param length
	 *            the length of the vector
	 * @param v
	 ...
	 * element array. The array is not changed and only a reference to the array is
	...
	/**
	 * Return the Hamming weight of this vector, i.e., compute the number of units
	 * of this vector.
	 *
	...
	/**
	 * Set the coefficient at the given index to 1. If the index is out of bounds,
	 * do nothing.
	 *
	 * @param index
	 ...
	 * @return a new {@link GF2Vector} consisting of the first <tt>k</tt> elements
	 *         of this vector
	 */
	 ...
	 * @param k
	 *            the number of elements to extract
	 * @return a new {@link GF2Vector} consisting of the last <tt>k</tt> elements of
	 *         this vector
	 */
