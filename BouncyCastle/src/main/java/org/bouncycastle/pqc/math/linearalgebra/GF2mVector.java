...
public class GF2mVector extends Vector {
	...
	/**
	 * creates the vector over GF(2^m) of given length and with elements from array
	 * v (beginning at the first bit)
	 *
	 * @param field
	 *            finite field
	 * @param v
	...
	/**
	 * Create a new vector over <tt>GF(2<sup>m</sup>)</tt> of the given length and
	 * element array.
	 *
	 * @param field
	 ...
	 *             if the other vector is not defined over the same field as this
	 *             vector.
	 *             <p>
