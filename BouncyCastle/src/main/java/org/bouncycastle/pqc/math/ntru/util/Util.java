...
public class Util {
	...
	/**
	 * Generates a "sparse" or "dense" polynomial containing numOnes ints equal to
	 * 1, numNegOnes int equal to -1, and the rest equal to 0.
	 *
	 * @param N
	 * @param numOnes
	 * @param numNegOnes
	...
	/**
	 * Generates an array containing numOnes ints equal to 1, numNegOnes int equal
	 ...
	 *
	 * @return <code>true</code> if 64-bit support detected, <code>false</code>
	 *         otherwise
	 */
	...
	/**
	 * Reads a given number of bytes from an <code>InputStream</code>. If there are
	 * not enough bytes in the stream, an <code>IOException</code> is thrown.
	 *
	 * @param is
	 * @param length
