...
public final class GoppaCode {
	...
	/**
	 * This class is a container for an instance of {@link GF2Matrix} and one int[].
	 * It is used to hold a generator matrix and the set of indices such that the
	 * submatrix of the generator matrix consisting of the specified columns is the
	 * identity.
	 *
	 * @see GF2Matrix
	 * @see Permutation
	...
	public static class MatrixSet {
		...
		/**
		 * Construct a new {@link MatrixSet} container with the given parameters.
		 *
		 * @param g
		 *            the generator matrix
		 * @param setJ
		 *            the set of indices such that the submatrix of the generator matrix
		 *            consisting of the specified columns is the identity
		 */
		...
		/**
		 * @return the set of indices such that the submatrix of the generator matrix
		 *         consisting of the specified columns is the identity
		 */
		public int[] getSetJ() {
			return setJ;
	...
	/**
	 * Given a check matrix <tt>H</tt>, compute matrices <tt>S</tt>, <tt>M</tt>, and
	 * a random permutation <tt>P</tt> such that <tt>S*H*P = (Id|M)</tt>. Return
	 * <tt>S^-1</tt>, <tt>M</tt>, and <tt>P</tt> as {@link MaMaPe}. The matrix
	 * <tt>(Id | M)</tt> is called the systematic form of H.
	 *
	 * @param h
	 *            the check matrix
	 * @param sr
	...
	/**
	 * Find an error vector <tt>e</tt> over <tt>GF(2)</tt> from an input syndrome
	 * <tt>s</tt> over <tt>GF(2<sup>m</sup>)</tt>.
	 *
	 * @param syndVec
	 *            the syndrome
	 * @param field
	 ...
	 */
	public static GF2Vector syndromeDecode(GF2Vector syndVec, GF2mField field, PolynomialGF2mSmallM gp,
