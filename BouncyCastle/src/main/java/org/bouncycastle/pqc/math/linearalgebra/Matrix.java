...
public abstract class Matrix {
	...
	/**
	 * Compute the product of a vector and this matrix. If the length of the vector
	 * is greater than the number of rows of this matrix, the matrix is multiplied
	 * by each m-bit part of the vector.
	 *
	 * @param vector
	 *            a vector
