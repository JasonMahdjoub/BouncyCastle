...
/**
 * This class implements elements of finite binary fields
 * <i>GF(2<sup>n</sup>)</i> using polynomial representation. For more
 * information on the arithmetic see for example IEEE Standard 1363 or <a
 * href=http://www.certicom.com/research/online.html> Certicom
 * online-tutorial</a>.
 *
 * @see "GF2nField"
...
public class GF2nPolynomialElement extends GF2nElement {
	...
	/**
	 * Create a new random GF2nPolynomialElement using the given field and source of
	 * randomness.
	 *
	 * @param f
	 *            the GF2nField to use
	 * @param rand
	 ...
	 *
	 * @param f
	 *            the GF2nPolynomialField to use
	 * @param bs
	...
	/**
	 * Creates a new GF2nPolynomialElement using the given field <i>f</i> and byte[]
	 * <i>os</i> as value. The conversion is done according to 1363.
	 *
	 * @param f
	 *            the GF2nField to use
	 * @param os
	 *            the octet string to assign to this GF2nPolynomialElement
	...
	/**
	 * Creates a new GF2nPolynomialElement using the given field <i>f</i> and int[]
	 * <i>is</i> as value.
	 *
	 * @param f
	 *            the GF2nField to use
	 ...
	 * @param other
	 *            the other object
	 * @return <tt>true</tt> if the two objects are equal, <tt>false</tt> otherwise
	 */
	...
	/**
	 * Returns whether the rightmost bit of the bit representation is set. This is
	 * needed for data conversion according to 1363.
	 *
	...
	/**
	 * Calculates the multiplicative inverse of <i>this</i> and returns the result
	 * in a new GF2nPolynomialElement.
	 *
	 * @return <i>this</i>^(-1)
	 * @throws ArithmeticException
	 *             if <i>this</i> equals zero
	 */
	...
	/**
	 * Squares this GF2nPolynomialElement using GF2nField's squaring matrix. This is
	 * supposed to be fast when using a polynomial (no tri- or pentanomial) as
	 * fieldpolynomial. Use squarePreCalc when using a tri- or pentanomial as
	...
	/**
	 * Squares this GF2nPolynomialElement using GF2nFields squaring matrix. This is
	 * supposed to be fast when using a polynomial (no tri- or pentanomial) as
	 * fieldpolynomial. Use squarePreCalc when using a tri- or pentanomial as
	 * fieldpolynomial instead.
	 *
	...
	/**
	 * Squares this GF2nPolynomialElement by using precalculated values and
	 * reducing. This is supposed to de fastest when using a tri- or pentanomial as
	 * fieldpolynomial. Use squareMatrix when using a ordinary polynomial as
	 * fieldpolynomial.
	 *
	 * @see GF2nPolynomialElement#squareMatrix
	 * @see GF2Polynomial#squareThisPreCalc
	...
	/**
	 * Calculates <i>this</i> to the power of <i>k</i> and returns the result in a
	 * new GF2nPolynomialElement.
	 *
	 * @param k
	 *            the power
	...
	/**
	 * Solves the quadratic equation <tt>z<sup>2</sup> + z = this</tt> if such a
	 * solution exists. This method returns one of the two possible solutions. The
	 * other solution is <tt>z + 1</tt>. Use z.increase() to compute this solution.
	 *
	 * @return a GF2nPolynomialElement representing one z satisfying the equation
	 *         <tt>z<sup>2</sup> + z = this</tt>
	 ...
	 * x^pc[1] + x^pc[0] + 1 as fieldpolynomial. The coefficients are reduced bit by
	 * bit.
	 */
	...
	/**
	 * Returns a string representing this Bitstrings value using hexadecimal radix
	 * in MSB-first order.
	 *
	 ...
	 *
	 * @return a BigInteger representing the value of this GF2nPolynomialElement
