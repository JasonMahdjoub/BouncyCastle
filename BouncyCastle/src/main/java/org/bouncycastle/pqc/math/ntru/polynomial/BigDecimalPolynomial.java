...
/**
 * A polynomial with {@link BigDecimal} coefficients. Some methods (like
 * <code>add</code>) change the polynomial, others (like <code>mult</code>) do
...
public class BigDecimalPolynomial {
	...
	/**
	 * Constructs a <code>BigDecimalPolynomial</code> from a
	...
	/**
	 * Multiplies the polynomial by another. Does not change this polynomial but
