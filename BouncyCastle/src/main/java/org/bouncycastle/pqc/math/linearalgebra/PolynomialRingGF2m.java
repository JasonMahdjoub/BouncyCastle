 ...
 * <tt>m&lt;32</tt>. If <tt>p(X)</tt> is irreducible, the polynomial ring is in
 * fact an extension field of <tt>GF(2^m)</tt>.
 */
public class PolynomialRingGF2m {
	...
	/**
	 * the squaring matrix for this polynomial ring (given as the array of its row
	 * vectors)
	 */
	protected PolynomialGF2mSmallM[] sqMatrix;

	/**
	 * the matrix for computing square roots in this polynomial ring (given as the
	 * array of its row vectors). This matrix is computed as the inverse of the
	 * squaring matrix.
	 */
	...
	/**
	 * Compute the squaring matrix for this polynomial ring, using the base field
	 * and the reduction polynomial.
	 */
