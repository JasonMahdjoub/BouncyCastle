...
/**
 * This class describes some operations with matrices over finite field
 * <i>GF(2<sup>m</sup>)</i> with small <i>m</i> (1&lt; m &lt;32).
 *
 * @see Matrix
 */
public class GF2mMatrix extends Matrix {
	...
	/**
	 * For the matrix representation the array of type int[][] is used, thus every
	 * element of the array keeps one element of the matrix (element from finite
	 * field GF(2^m))
	 */
	...
	public boolean equals(Object other) {
		...
		if ((!this.field.equals(otherMatrix.field)) || (otherMatrix.numRows != this.numColumns)
