...
public final class BigIntUtils {
	 ...
	 * such a method, it uses an extra bit to indicate the sign of the number. For
	 * elliptic curve cryptography, the numbers usually are positive. Thus, this
	 * helper method returns a byte array of minimal length, ignoring the sign of
	 * the number.
	 *
	 * @param value
