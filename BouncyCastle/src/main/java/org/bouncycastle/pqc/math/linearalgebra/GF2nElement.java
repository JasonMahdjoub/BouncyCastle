 ...
 * or in <i>polynomial</i> representation. It is extended by the classes
 * <a href = GF2nONBElement.html><tt> GF2nONBElement</tt></a> and
 * <a href = GF2nPolynomialElement.html> <tt>GF2nPolynomialElement</tt> </a>.
 *
...
public abstract class GF2nElement implements GFElement {
	...
	/**
	 * Compute the difference of this element and <tt>minuend</tt>, overwriting this
	 * element.
	 *
	 * @param minuend
	 *            the minuend
	 ...
	 * @throws DifferentFieldsException
	 *             if <tt>this</tt> cannot be converted according to <tt>basis</tt>.
	 */
	 ...
	 *             if z<sup>2</sup> + z = <tt>this</tt> does not have a solution
	 */
