...
public class GF2nPolynomialField extends GF2nField {
	 ...
	 *            source of randomness for generating new polynomials.
	 * @param file
	 *            true if you want to read the field polynomial from the file false
	 *            if you want to use a random fielpolynomial (this can take very
	...
	/**
	 * Returns true if the field polynomial is a trinomial. The coefficient can be
	 * retrieved using getTc().
	 *
	...
	/**
	 * Returns true if the field polynomial is a pentanomial. The coefficients can
	 * be retrieved using getPc().
	 *
	...
	/**
	 * Returns the degree of the middle coefficient of the used field trinomial (x^n
	 * + x^(getTc()) + 1).
	 *
	...
	/**
	 * Returns the degree of the middle coefficients of the used field pentanomial
	 * (x^n + x^(getPc()[2]) + x^(getPc()[1]) + x^(getPc()[0]) + 1).
	 *
	 ...
	 *
	 * @param i
	 *            the index of the row vector to return
	...
	protected void computeCOBMatrix(GF2nField B1) {
		...
		if (mDegree != B1.mDegree) {
			throw new IllegalArgumentException("GF2nPolynomialField.computeCOBMatrix: B1 has a different "
	...
	/**
	 * Tests all trinomials of degree (n+1) until a irreducible is found and stores
	 * the result in <i>field polynomial</i>. Returns false if no irreducible
	 * trinomial exists in GF(2^n). This can take very long for huge degrees.
	 *
	 ...
	 * stores the result in <i>field polynomial</i>. Returns false if no irreducible
	 * pentanomial exists in GF(2^n). This can take very long for huge degrees.
	 *
	...
	/**
	 * Tests random polynomials of degree (n+1) until an irreducible is found and
	 * stores the result in <i>field polynomial</i>. This can take very long for
	 * huge degrees.
	 *
	 * @return true
	 */
