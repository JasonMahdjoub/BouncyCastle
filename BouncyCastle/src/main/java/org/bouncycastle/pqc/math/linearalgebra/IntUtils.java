...
public final class IntUtils {
	 ...
	 * calling this method this array is sorted in ascending order with the smallest
	 * integer taking position 0 in the array.
	 * <p>
	 * This implementation is based on the quicksort algorithm as described in
	 * <code>Data Structures In Java</code> by Thomas A. Standish, Chapter 10, ISBN
	 * 0-201-30564-X.
	 *
	 * @param source
	...
	/**
	 * Sort a subarray of a source array. The subarray is specified by its start and
	 * end index.
	 *
	 * @param source
	...
	/**
	 * Split a subarray of a source array into two partitions. The left partition
	 * contains elements that have value less than or equal to the pivot element,
	 * the right partition contains the elements that have larger value.
	 *
	 * @param source
	 ...
	 *         <tt>end</tt>
	 */
	public static int[] subArray(final int[] input, final int start, final int end) {
