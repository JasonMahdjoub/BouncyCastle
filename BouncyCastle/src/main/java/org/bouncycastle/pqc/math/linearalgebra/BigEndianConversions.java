...
public final class BigEndianConversions {
	 ...
	 * Length checking is performed.
	 *
	 * @param x
	 *            the integer to convert
	 * @param oLen
	 *            the desired length of the octet string
	 * @return an octet string of length <tt>oLen</tt> representing the integer
	 *         <tt>x</tt>, or <tt>null</tt> if the integer is negative
	 * @throws ArithmeticException
	 *             if <tt>x</tt> can't be encoded into <tt>oLen</tt> octets.
	 */
	...
	/**
	 * Convert an integer to an octet string of the specified length according to
	 * IEEE 1363, Section 5.5.3. No length checking is performed (i.e., if the
	 * integer cannot be encoded into <tt>length</tt> octets, it is truncated).
	 *
	 * @param input
	 *            the integer to convert
	 * @param output
	 ...
	 *         <tt>0</tt> if the represented integer is negative or too large or the
	 *         byte array is empty
	 * @throws ArithmeticException
	 ...
	 *            the byte array holding the octet string
	 * @param inOff
	 *            the offset in the input byte array where the octet string starts
	 * @param inLen
