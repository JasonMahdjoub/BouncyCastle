...
public class LocalizedMessage {
	...
	/**
	 * Constructs a new LocalizedMessage using <code>resource</code> as the base
	 * name for the RessourceBundle and <code>id</code> as the message bundle id the
	 * resource file.
	 * 
	 * @param resource
	 ...
	 *             if <code>resource</code> or <code>id</code> is <code>null</code>
	 */
	...
	/**
	 * Reads the entry <code>id + "." + key</code> from the resource file and
	 * returns a formated message for the given Locale and TimeZone.
	 * 
	 * @param key
	 *            second part of the entry id
	 * @param loc
	 *            the used {@link Locale}
	 * @param timezone
	 *            the used {@link TimeZone}
	 * @return a Strng containing the localized message
	 * @throws MissingEntryException
	 *             if the resource file is not available or the entry does not
	 *             exist.
	 */
	public String getEntry(String key, Locale loc, TimeZone timezone) throws MissingEntryException {
		...
		try {
			...
			throw new MissingEntryException("Can't find entry " + entry + " in resource file " + resource + ".",
					resource, entry, loc, loader != null ? loader : this.getClassLoader());
	 ...
	 * 
	 * @param filter
	 *            the {@link Filter} to use. <code>null</code> to disable filtering.
	 */
	...
	/**
	 * Set the {@link ClassLoader} which loads the resource files. If it is set to
	 * <code>null</code> then the default {@link ClassLoader} is used.
	 * 
	 * @param loader
	 *            the {@link ClassLoader} which loads the resource files
	 */
	...
	/**
	 * Returns the {@link ClassLoader} which loads the resource files or
	 * <code>null</code> if the default ClassLoader is used.
	 * 
