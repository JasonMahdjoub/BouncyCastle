...
/**
 * A fixed secure random designed to return data for someone needing to create a
 * single BigInteger.
 */
public class TestRandomBigInteger extends FixedSecureRandom {
	 ...
	 *
	 * @param encoding
	 *            a String BigInteger of base radix.
	 * @param radix
	 *            the radix to use.
	 */
	public TestRandomBigInteger(String encoding, int radix) {
		super(new FixedSecureRandom.Source[] { new FixedSecureRandom.BigInteger(
	...
	/**
	 * Constructor which ensures encoding will produce a BigInteger from a request
	 * from the passed in bitLength.
	 *
	 * @param bitLength
	 *            bit length for the BigInteger data request.
	 * @param encoding
