...
/**
 * A secure random that returns pre-seeded data to calls of nextBytes() or
 * generateSeed().
 */
public class FixedSecureRandom extends SecureRandom {
	...
	/**
	 * BigInteger Source - in this case we expect requests for data that will be
	 * used for BigIntegers. The FixedSecureRandom will attempt to compensate for
	 * platform differences here.
	 */
	...
	//
	// classpath's implementation of SecureRandom doesn't currently go back to
	// nextBytes
