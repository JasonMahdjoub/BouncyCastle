...
public final class Streams {
	...
	/**
	 * Read from inStr up to a maximum number of bytes, throwing an exception if
	 * more the maximum amount of requested data is available.
	 *
	 * @param inStr
	 *            stream to be read.
	 * @param limit
	 ...
	 * @return a byte array representing the contents of inStr.
	 * @throws IOException
	 *             in case of underlying IOException, or if limit is reached on
	 *             inStr still has data in it.
	 */
	...
	/**
	 * Fully read in len's bytes of data into buf, or up to EOF, whichever occurs
	 * first,
	 *
	 * @param inStr
	 *            the stream to be read.
	 ...
	 *            source input stream.
	 * @param limit
	 *            the maximum number of bytes allowed to be read.
	 * @param outStr
	 *            destination output stream.
	 * @throws IOException
	 *             in case of underlying IOException, or if limit is reached on
