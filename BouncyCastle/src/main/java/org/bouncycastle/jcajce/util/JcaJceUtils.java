...
public class JcaJceUtils {
	 ...
	 * @return an ASN.1 object representing the primitives making up the params
	 *         parameter.
	 * @throws IOException
	 *             if an encoding cannot be extracted.
	 * @deprecated use
	 *             AlgorithmParametersUtils.extractParameters(AlgorithmParameters
	 *             params)
	 */
	...
	/**
	 * Load an AlgorithmParameters object with the passed in ASN.1 encodable - if
	 * possible.
	 *
	 * @param params
	 *            the AlgorithmParameters object to be initialised.
	 * @param sParams
	 *            the ASN.1 encodable to initialise params with.
	 * @throws IOException
	 *             if the parameters cannot be initialised.
	 * @deprecated use AlgorithmParametersUtils.loadParameters(AlgorithmParameters
	 *             params, ASN1Encodable sParams)
	 */
	...
	/**
	 * Attempt to find a standard JCA name for the digest represented by the past in
	 * OID.
	 *
	 * @param digestAlgOID
	 *            the OID of the digest algorithm of interest.
	 * @return a string representing the standard name - the OID as a string if none
	 *         available.
