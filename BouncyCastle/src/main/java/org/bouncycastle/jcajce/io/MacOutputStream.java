...
/**
 * An output stream which calculates a MAC based on the data that is written to
 * it.
 */
public final class MacOutputStream extends OutputStream {
	...
	/**
	 * Write a block of data of length len starting at offset off in the byte array
	 * bytes to the stream.
	 *
	 * @param bytes
