 ...
 * </p>
 * <p>
 * This is a reimplementation of {@link javax.crypto.CipherInputStream} that is
 * safe for use with AEAD block ciphers, and does not silently catch
 * {@link BadPaddingException} and {@link IllegalBlockSizeException} errors. Any
 * errors that occur during {@link Cipher#doFinal() finalisation} are rethrown
 * wrapped in an {@link InvalidCipherTextIOException}.
 * </p>
 */
public class CipherInputStream extends FilterInputStream {
	...
	/**
	 * Closes the underlying input stream, and then finalises the processing of the
	 * data by the cipher.
	 *
	 * @throws IOException
	 *             if there was an error closing the input stream.
