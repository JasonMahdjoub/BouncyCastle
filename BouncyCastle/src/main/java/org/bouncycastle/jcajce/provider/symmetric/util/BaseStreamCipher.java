...
public class BaseStreamCipher extends BaseWrapCipher implements PBE {
	...
	// specs we can handle.
	//
	private Class[] availableSpecs = { RC2ParameterSpec.class, RC5ParameterSpec.class, IvParameterSpec.class,
	...
	protected void engineInit(int opmode, Key key, AlgorithmParameterSpec params, SecureRandom random)
		...
		if (key instanceof PKCS12Key) {
			...
			if (k instanceof PKCS12KeyWithParameters && pbeSpec == null) {
				pbeSpec = new PBEParameterSpec(((PKCS12KeyWithParameters) k).getSalt(),
