...
public class KeyPairGeneratorSpi extends java.security.KeyPairGenerator {
	...
	public void initialize(AlgorithmParameterSpec params, SecureRandom random)
		...
		if (params instanceof ECParameterSpec) {
			...
			param = new ECKeyGenerationParameters(new ECDomainParameters(p.getCurve(), p.getG(), p.getN(), p.getH()),
					random);
			...
			param = new ECKeyGenerationParameters(
					new ECDomainParameters(curve, g, p.getOrder(), BigInteger.valueOf(p.getCofactor())), random);
			...
			this.ecParams = new ECNamedCurveSpec(curveName, ecP.getCurve(), ecP.getG(), ecP.getN(), ecP.getH(),
					ecP.getSeed());
