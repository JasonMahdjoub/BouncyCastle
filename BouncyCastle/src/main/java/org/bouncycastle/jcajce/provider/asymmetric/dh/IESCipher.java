...
public class IESCipher extends CipherSpi {
		...
		if (state == Cipher.ENCRYPT_MODE || state == Cipher.WRAP_MODE) {
			...
			EphemeralKeyPairGenerator kGen = new EphemeralKeyPairGenerator(gen, new KeyEncoder() {
				public byte[] getEncoded(AsymmetricKeyParameter keyParameter) {
					byte[] Vloc = new byte[(((DHKeyParameters) keyParameter).getParameters().getP().bitLength() + 7)
							/ 8];
	...
	static public class IES extends IESCipher {
		public IES() {
			super(new IESEngine(new DHBasicAgreement(), new KDF2BytesGenerator(DigestFactory.createSHA1()),
					new HMac(DigestFactory.createSHA1())));
		}
	}

	static public class IESwithDESedeCBC extends IESCipher {
	...
	static public class IESwithAESCBC extends IESCipher {
