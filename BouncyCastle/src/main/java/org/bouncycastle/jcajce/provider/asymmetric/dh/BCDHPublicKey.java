	...
	public BCDHPublicKey(SubjectPublicKeyInfo info) {
		...
		if (id.equals(PKCSObjectIdentifiers.dhKeyAgreement) || isPKCSParam(seq)) {
			...
			if (validationParams != null) {
				this.dhPublicKey = new DHPublicKeyParameters(y,
						new DHParameters(params.getP(), params.getG(), params.getQ(), params.getJ(),
								new DHValidationParameters(validationParams.getSeed(),
