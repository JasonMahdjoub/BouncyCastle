...
/**
 * A permission class to define what can be done with the ConfigurableProvider
 * interface.
 * <p>
 * Available permissions are "threadLocalEcImplicitlyCa" and "ecImplicitlyCa"
 * which allow the setting of the thread local and global ecImplicitlyCa
 ...
 * <li>ProviderConfigurationPermission("BC", "threadLocalEcImplicitlyCa"); //
 * enable thread local only</li>
 * <li>ProviderConfigurationPermission("BC", "ecImplicitlyCa"); // enable global
 * setting only</li>
 * <li>ProviderConfigurationPermission("BC", "threadLocalEcImplicitlyCa,
 * ecImplicitlyCa"); // enable both explicitly</li>
 * </ul>
 * <p>
...
public class ProviderConfigurationPermission extends BasicPermission {
	...
	private static final int ALL = THREAD_LOCAL_EC_IMPLICITLY_CA | EC_IMPLICITLY_CA | THREAD_LOCAL_DH_DEFAULT_PARAMS
