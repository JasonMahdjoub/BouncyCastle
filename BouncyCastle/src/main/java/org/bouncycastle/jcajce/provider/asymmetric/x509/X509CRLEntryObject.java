...
class X509CRLEntryObject extends X509CRLEntry {
	...
	/**
	 * Constructor for CRLEntries of indirect CRLs. If <code>isIndirect</code> is
	 * <code>false</code> {@link #getCertificateIssuer()} will always return
	 * <code>null</code>, <code>previousCertificateIssuer</code> is ignored. If this
	 * <code>isIndirect</code> is specified and this CRLEntry has no certificate
	 * issuer CRL entry extension <code>previousCertificateIssuer</code> is returned
	 * by {@link #getCertificateIssuer()}.
	 * 
	 * @param c
	 *            TBSCertList.CRLEntry object.
	 * @param isIndirect
	 *            <code>true</code> if the corresponding CRL is a indirect CRL.
	...
	/**
	 * Will return true if any extensions are present and marked as critical as we
	 * currently don't handle any extensions!
	 */
					...
					if (ext.getExtnValue() != null) {
						...
						try {
							if (oid.equals(Extension.reasonCode)) {
								...
								buf.append("Certificate issuer: ").append(GeneralNames.getInstance(dIn.readObject()))
										.append(nl);
							} else {
