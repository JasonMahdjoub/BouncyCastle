...
public final class DES {
	...
	/**
	 * DES - the default for this is to generate a key in a-b-a format that's 24
	...
	static public class DESPBEKeyFactory extends BaseSecretKeyFactory {
		...
		public DESPBEKeyFactory(String algorithm, ASN1ObjectIdentifier oid, boolean forCipher, int scheme, int digest,
	 ...
	 * PBEWithMD2AndDES
	 */
	static public class PBEWithMD2KeyFactory extends DESPBEKeyFactory {
	 ...
	 * PBEWithMD5AndDES
	 */
	static public class PBEWithMD5KeyFactory extends DESPBEKeyFactory {
	 ...
	 * PBEWithSHA1AndDES
	 */
	static public class PBEWithSHA1KeyFactory extends DESPBEKeyFactory {
	 ...
	 * PBEWithMD2AndDES
	 */
	static public class PBEWithMD2 extends BaseBlockCipher {
		public PBEWithMD2() {
	 ...
	 * PBEWithMD5AndDES
	 */
	static public class PBEWithMD5 extends BaseBlockCipher {
		public PBEWithMD5() {
	 ...
	 * PBEWithSHA1AndDES
	 */
	static public class PBEWithSHA1 extends BaseBlockCipher {
		public PBEWithSHA1() {
	...
	public static class Mappings extends AlgorithmProvider {
		...
		public void configure(ConfigurableProvider provider) {
			...
			provider.addAlgorithm("Alg.Alias.Mac.DESISO9797ALG1MACWITHISO7816-4PADDING",
			...
			provider.addAlgorithm("Alg.Alias.SecretKeyFactory." + PKCSObjectIdentifiers.pbeWithMD2AndDES_CBC,
					"PBEWITHMD2ANDDES");
			provider.addAlgorithm("Alg.Alias.SecretKeyFactory." + PKCSObjectIdentifiers.pbeWithMD5AndDES_CBC,
					"PBEWITHMD5ANDDES");
			provider.addAlgorithm("Alg.Alias.SecretKeyFactory." + PKCSObjectIdentifiers.pbeWithSHA1AndDES_CBC,
					"PBEWITHSHA1ANDDES");
		}
