...
public class PKIXExtendedParameters implements CertPathParameters {
	 ...
	 * {@link PKIXParameters#setDate(Date)} method, so this methods sets the Date
	 * when <em>all</em> certificates must have been valid.
	 */
	 ...
	 * certificate was signed and so on. So the {@link PKIXParameters#setDate(Date)}
	 * method sets the time, when the <em>end certificate</em> must have been valid.
	 * <p/>
	...
	public static class Builder {
		...
		public Builder(PKIXExtendedParameters baseParameters) {
			...
			this.namedCertificateStoreMap = new HashMap<GeneralName, PKIXCertStore>(
					baseParameters.namedCertificateStoreMap);
		 ...
		 *
		 * @param trustAnchor
		 *            the trust anchor end-entity and CRLs must be based on.
		 ...
		 *
		 * @param trustAnchors
		 *            a set of trustAnchors, one of which a particular end-entity and
		 *            it's associated CRLs must be based on.
		 * @return the current builder.
		 */
	...
	private PKIXExtendedParameters(Builder builder) {
		...
		this.namedCertificateStoreMap = Collections
				.unmodifiableMap(new HashMap<GeneralName, PKIXCertStore>(builder.namedCertificateStoreMap));
		this.extraCRLStores = Collections.unmodifiableList(builder.extraCRLStores);
		this.namedCRLStoreMap = Collections
				.unmodifiableMap(new HashMap<GeneralName, PKIXCRLStore>(builder.namedCRLStoreMap));
	...
	/**
	 * Returns the required constraints on the target certificate. The constraints
	 * are returned as an instance of <code>Selector</code>. If <code>null</code>,
