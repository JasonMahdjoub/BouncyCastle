 ...
 * <p>
 * Note: if you want a straight DER encoding of a PKCS#12 file you should use
 * this.
 * </p>
 */
public class PKCS12StoreParameter implements LoadStoreParameter {
	...
	/**
	 * Return whether the KeyStore used with this parameter should be DER encoded on
	 * saving.
	 *
