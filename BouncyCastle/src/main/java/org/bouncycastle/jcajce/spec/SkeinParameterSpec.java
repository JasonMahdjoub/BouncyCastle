...
/**
 * Parameters for the Skein hash function - a series of byte[] strings
 * identified by integer tags.
 * <p>
 * Parameterised Skein can be used for:
 * <ul>
 * <li>MAC generation, by providing a
 * {@link org.bouncycastle.jcajce.spec.SkeinParameterSpec.Builder#setKey(byte[])
 * key}.</li>
 * <li>Randomised hashing, by providing a
 * {@link org.bouncycastle.jcajce.spec.SkeinParameterSpec.Builder#setNonce(byte[])
 * nonce}.</li>
 * <li>A hash function for digital signatures, associating a
 * {@link org.bouncycastle.jcajce.spec.SkeinParameterSpec.Builder#setPublicKey(byte[])
 * public key} with the message digest.</li>
 * <li>A key derivation function, by providing a
 * {@link org.bouncycastle.jcajce.spec.SkeinParameterSpec.Builder#setKeyIdentifier(byte[])
 * key identifier}.</li>
 * <li>Personalised hashing, by providing a
 * {@link org.bouncycastle.jcajce.spec.SkeinParameterSpec.Builder#setPersonalisation(java.util.Date, String, String)
 * recommended format} or
 * {@link org.bouncycastle.jcajce.spec.SkeinParameterSpec.Builder#setPersonalisation(byte[])
 * arbitrary} personalisation string.</li>
 * </ul>
 * </p>
 *
...
public class SkeinParameterSpec implements AlgorithmParameterSpec {
	/**
	 * The parameter type for a secret key, supporting MAC or KDF functions:
	 * {@value #PARAM_TYPE_KEY}.
	 */
	public static final int PARAM_TYPE_KEY = 0;

	/**
	 * The parameter type for the Skein configuration block:
	 * {@value #PARAM_TYPE_CONFIG}.
	 */
	public static final int PARAM_TYPE_CONFIG = 4;

	/**
	 * The parameter type for a personalisation string:
	 * {@value #PARAM_TYPE_PERSONALISATION}.
	 */
	...
	/**
	 * The parameter type for a key identifier string:
	 * {@value #PARAM_TYPE_KEY_IDENTIFIER}.
	 */
	...
	/**
	 * Obtains a map of type (Integer) to value (byte[]) for the parameters tracked
	 * in this object.
	 */
	...
	/**
	 * Obtains the value of the {@link #PARAM_TYPE_KEY key parameter}, or
	...
	/**
	 * Obtains the value of the {@link #PARAM_TYPE_PERSONALISATION personalisation
	 * parameter}, or <code>null</code> if not set.
	 */
	...
	/**
	 * Obtains the value of the {@link #PARAM_TYPE_PUBLIC_KEY public key parameter},
	...
	/**
	 * Obtains the value of the {@link #PARAM_TYPE_KEY_IDENTIFIER key identifier
	 * parameter}, or <code>null</code> if not set.
	 */
	...
	/**
	 * Obtains the value of the {@link #PARAM_TYPE_NONCE nonce parameter}, or
	 * <code>null</code> if not set.
	 */
	...
	public static class Builder {
		 ...
		 * {@value org.bouncycastle.jcajce.spec.SkeinParameterSpec#PARAM_TYPE_MESSAGE}
		 * (reserved for message body).
		 * <p>
		 * Parameters with type <
		 * {@value org.bouncycastle.jcajce.spec.SkeinParameterSpec#PARAM_TYPE_MESSAGE}
		 * are processed before the message content, parameters with type >
		 * {@value org.bouncycastle.jcajce.spec.SkeinParameterSpec#PARAM_TYPE_MESSAGE}
		...
		/**
		 * Sets the
		 * {@link org.bouncycastle.jcajce.spec.SkeinParameterSpec#PARAM_TYPE_KEY}
		 * parameter.
		 */
		...
		/**
		 * Sets the
		 * {@link org.bouncycastle.jcajce.spec.SkeinParameterSpec#PARAM_TYPE_PERSONALISATION}
		 * parameter.
		 */
		...
		/**
		 * Implements the recommended personalisation format for Skein defined in
		 * Section 4.11 of the Skein 1.3 specification.
		 * <p>
		 * The format is <code>YYYYMMDD email@address distinguisher</code>, encoded to a
		 * byte sequence using UTF-8 encoding.
		 * </p>
		 *
		 * @param date
		 ...
		 * @param distinguisher
		 *            an arbitrary personalisation string distinguishing the
		 *            application.
		 * @return the current builder instance.
		 */
		...
		/**
		 * Implements the recommended personalisation format for Skein defined in
		 * Section 4.11 of the Skein 1.3 specification. You may need to use this method
		 * if the default locale doesn't use a Gregorian calender so that the
		 * GeneralizedTime produced is compatible implementations.
		 * <p/>
		 * The format is <code>YYYYMMDD email@address distinguisher</code>, encoded to a
		 * byte sequence using UTF-8 encoding.
		 *
		...
		/**
		 * Sets the
		 * {@link org.bouncycastle.jcajce.spec.SkeinParameterSpec#PARAM_TYPE_KEY_IDENTIFIER}
		 * parameter.
		 *
		 * @return the current builder instance.
		 */
		...
		/**
		 * Sets the
		 * {@link org.bouncycastle.jcajce.spec.SkeinParameterSpec#PARAM_TYPE_NONCE}
		 * parameter.
		 *
		 * @return the current builder instance.
		 */
		...
		/**
		 * Constructs a new {@link org.bouncycastle.jcajce.spec.SkeinParameterSpec}
		 * instance with the parameters provided to this builder.
		 */
