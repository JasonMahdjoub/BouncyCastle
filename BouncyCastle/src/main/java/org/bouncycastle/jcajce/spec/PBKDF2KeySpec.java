...
/**
 * Extension of PBEKeySpec which takes into account the PRF algorithm setting
 * available in PKCS#5 PBKDF2.
 */
public class PBKDF2KeySpec extends PBEKeySpec {
	private static final AlgorithmIdentifier defaultPRF = new AlgorithmIdentifier(PKCSObjectIdentifiers.id_hmacWithSHA1,
			DERNull.INSTANCE);
	 ...
	 *
	 * @param password
	 *            password to use as the seed of the PBE key generator.
	 * @param salt
	 *            salt to use in the generator,
	 * @param iterationCount
	 *            iteration count to use in the generator.
	 * @param keySize
