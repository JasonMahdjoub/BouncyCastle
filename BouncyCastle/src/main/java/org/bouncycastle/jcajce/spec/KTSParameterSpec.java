...
public class KTSParameterSpec implements AlgorithmParameterSpec {
	...
	public static final class Builder {
		 ...
		 *
		 * @param algorithmName
		 *            the algorithm name for the secret key we use for wrapping.
		 * @param keySizeInBits
		...
		public Builder(String algorithmName, int keySizeInBits, byte[] otherInfo) {
			...
			this.kdfAlgorithm = new AlgorithmIdentifier(X9ObjectIdentifiers.id_kdf_kdf3,
	...
	private KTSParameterSpec(String wrappingKeyAlgorithm, int keySizeInBits, AlgorithmParameterSpec parameterSpec,
	...
	/**
	 * Return the name of the algorithm for the wrapping key this key spec should
	 * use.
	 *
	...
	/**
	 * Return the size of the key (in bits) for the wrapping key this key spec
	 * should use.
	 *
	...
	/**
	 * Return the algorithm parameter spec to be applied with the private key when
	 * the encapsulation is decrypted.
	 *
	...
	/**
	 * Return the AlgorithmIdentifier for the KDF to do key derivation after
