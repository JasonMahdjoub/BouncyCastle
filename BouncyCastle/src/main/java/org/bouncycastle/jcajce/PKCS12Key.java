...
public class PKCS12Key implements PBKDFKey {
	...
	/**
	 * Basic constructor for a password based key - secret key generation parameters
	...
	/**
	 * Unfortunately there seems to be some confusion about how to handle zero
	 * length passwords.
	 *
	 * @param password
	 *            password to use.
	 * @param useWrongZeroLengthConversion
	 *            use the incorrect encoding approach (add pad bytes)
	 */
