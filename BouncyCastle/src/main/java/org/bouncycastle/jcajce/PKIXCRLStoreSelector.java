...
public class PKIXCRLStoreSelector<T extends CRL> implements Selector<T> {
	...
	public static class Builder {
		 ...
		 *
		 * @param crlSelector
		 *            the CertSelector to copy the match details from.
		 */
		 ...
		 *
		 * @param completeCRLEnabled
		 *            <code>true</code> if only complete CRLs should be returned.
		 */
		...
		/**
		 * If this is set to <code>true</code> the CRL reported contains the delta CRL
		 * indicator CRL extension.
		 * <p>
		 * {@link #setCompleteCRLEnabled(boolean)} and
		 * {@link #setDeltaCRLIndicatorEnabled(boolean)} excluded each other.
		 *
		 * @param deltaCRLIndicator
		 *            <code>true</code> if the delta CRL indicator extension must be in
		 *            the CRL.
		 */
		...
		/**
		 * Sets the maximum base CRL number. Setting to <code>null</code> disables this
		 * cheack.
		 * <p>
		 * This is only meaningful for delta CRLs. Complete CRLs must have a CRL number
		 * which is greater or equal than the base number of the corresponding CRL.
		 *
		 * @param maxBaseCRLNumber
		 ...
		 *            <code>true</code> to enable the issuing distribution point check.
		 */
		 ...
		 * <p>
		 * The issuing distribution point extension is a CRL extension which identifies
		 * the scope and the distribution point of a CRL. The scope contains among
		 * others information about revocation reasons contained in the CRL. Delta CRLs
		 * and complete CRLs must have matching issuing distribution points.
		 * <p>
		 ...
		 *            The issuing distribution point to set. This is the DER encoded
	 ...
	 * 
	 * @return Returns <code>true</code> if only CRLs with the delta CRL indicator
	...
	/**
	 * Returns the issuing distribution point. Defaults to <code>null</code>, which
	 * is a missing issuing distribution point extension.
	 * <p>
	 * The internal byte array is cloned before it is returned.
	 * <p>
	 * The criteria must be enable with
	 * Builder.setIssuingDistributionPointEnabled(boolean)}.
	 * 
