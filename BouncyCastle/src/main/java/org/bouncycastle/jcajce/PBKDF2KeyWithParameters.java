...
/**
 * A password based key for use with PBKDF2 as defined in PKCS#5 with full PBE
 * parameters.
 */
public class PBKDF2KeyWithParameters extends PBKDF2Key implements PBEKey {
	...
	/**
	 * Basic constructor for a password based key with generation parameters using
	 * FIPS PBKDF.
	 *
	 * @param password
	 *            password to use.
	 * @param converter
	 *            converter to use for transforming characters into bytes.
	 * @param salt
	 *            salt for generation algorithm
