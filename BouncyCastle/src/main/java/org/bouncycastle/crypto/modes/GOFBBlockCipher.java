...
public class GOFBBlockCipher extends StreamBlockCipher {
	 ...
	 *
	 * @param cipher
	 *            the block cipher to be used as the basis of the counter mode (must
	 *            have a 64 bit block size).
	 */
	 ...
	 */
	public void init(boolean encrypting, // ignored by this CTR mode
	 ...
	 *
	 * @return the name of the underlying algorithm followed by "/GCTR" and the
	 *         block size in bits
	 */
