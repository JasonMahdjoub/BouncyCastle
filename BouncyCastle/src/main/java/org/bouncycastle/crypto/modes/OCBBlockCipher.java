...
/**
 * An implementation of <a href="http://tools.ietf.org/html/rfc7253">RFC 7253 on
 * The OCB Authenticated-Encryption Algorithm</a>, licensed per:
 * <p>
 * <blockquote>
 * <a href="http://www.cs.ucdavis.edu/~rogaway/ocb/license1.pdf">License for
 * Open-Source Software Implementations of OCB</a> (Jan 9, 2013) &mdash;
 * &ldquo;License 1&rdquo; <br>
 * Under this license, you are authorized to make, use, and distribute
 * open-source software implementations of OCB. This license terminates for you
 * if you sue someone over their open-source software implementation of OCB
 ...
 * document is controlling. </blockquote>
 */
public class OCBBlockCipher implements AEADBlockCipher {
	...
	protected int processNonce(byte[] N) {
		...
		/*
		 * When used with incrementing nonces, the cipher is only applied once every 64
		 * inits.
		 */
