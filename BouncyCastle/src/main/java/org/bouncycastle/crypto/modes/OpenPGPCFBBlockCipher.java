 ...
 * top of a simple cipher. This class assumes the IV has been prepended to the
 * data stream already, and just accomodates the reset after (blockSize + 2)
 * bytes have been read.
 * <p>
 * For further info see <a href="http://www.ietf.org/rfc/rfc2440.html">RFC
 * 2440</a>.
 */
public class OpenPGPCFBBlockCipher implements BlockCipher {
	 ...
	 *
	 * @return the name of the underlying algorithm followed by "/OpenPGPCFB" and
