...
public class CCMBlockCipher implements AEADBlockCipher {
	 ...
	 *            data for processing.
	 * @param inOff
	 *            offset at which data starts in the input array.
	 * @param inLen
	 *            length of the data in the input array.
	 * @return a byte array containing the processed input..
	 * @throws IllegalStateException
	 *             if the cipher is not appropriately set up.
	 * @throws InvalidCipherTextException
	 *             if the input data is truncated or the mac check fails.
	 */
	 ...
	 *            output array.
	 * @param outOff
	 *            offset into output array to start putting processed bytes.
