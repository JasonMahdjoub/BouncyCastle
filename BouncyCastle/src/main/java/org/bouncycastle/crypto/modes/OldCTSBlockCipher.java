 ...
 * <p>
 * This version applies the CTS algorithm from one block up, rather than
 * following the errata update issued in 2004, where CTS mode is applied from
 * greater than 1 block up and the first block is processed using CBC mode.
 * </p>
 */
