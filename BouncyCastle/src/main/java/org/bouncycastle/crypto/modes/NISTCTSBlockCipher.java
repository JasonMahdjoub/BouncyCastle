...
/**
 * A Cipher Text Stealing (CTS) mode cipher. CTS allows block ciphers to be used
 * to produce cipher text which is the same length as the plain text.
 * <p>
 * This class implements the NIST version as documented in "Addendum to NIST SP
 * 800-38A, Recommendation for Block Cipher Modes of Operation: Three Variants
...
public class NISTCTSBlockCipher extends BufferedBlockCipher {
	 ...
	 *
	 * @param type
	 *            type of CTS mode (CS1, CS2, or CS3)
	 * @param cipher
	 *            the underlying block cipher used to create the CBC block cipher
	 *            this cipher uses..
	 */
	 ...
	 *                if cipher text decrypts wrongly (in case the exception will
	 *                never get thrown).
	 */
