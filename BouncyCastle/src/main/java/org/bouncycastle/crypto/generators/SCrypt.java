 ...
 * <p>
 * Scrypt was created by Colin Percival and is specified in <a href=
 * "http://tools.ietf.org/html/draft-josefsson-scrypt-kdf-01">draft-josefsson-scrypt-kd</a>
 *
 */
public class SCrypt {
	/**
	 ...
	 * @param N
	 *            CPU/Memory cost parameter. Must be larger than 1, a power of 2 and
	 *            less than <code>2^(128 * r / 8)</code>.
	 * @param r
	 *            the block size, must be >= 1.
	 * @param p
	 *            Parallelization parameter. Must be a positive integer less than or
	 *            equal to <code>Integer.MAX_VALUE / (128 * r * 8)</code>.
	 * 
	 * @param dkLen
