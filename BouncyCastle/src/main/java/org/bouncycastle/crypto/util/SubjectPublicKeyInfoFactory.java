...
/**
 * Factory to create ASN.1 subject public key info objects from lightweight
 * public keys.
 */
	...
	public static SubjectPublicKeyInfo createSubjectPublicKeyInfo(AsymmetricKeyParameter publicKey) throws IOException {
		if (publicKey instanceof RSAKeyParameters) {
			...
			return new SubjectPublicKeyInfo(
					...
					new RSAPublicKey(pub.getModulus(), pub.getExponent()));
			...
			return new SubjectPublicKeyInfo(new AlgorithmIdentifier(X9ObjectIdentifiers.id_dsa, params),
					new ASN1Integer(pub.getY()));
			...
			if (domainParams == null) {
				...
				X9ECParameters ecP = new X9ECParameters(domainParams.getCurve(), domainParams.getG(),
						domainParams.getN(), domainParams.getH(), domainParams.getSeed());
			...
			return new SubjectPublicKeyInfo(new AlgorithmIdentifier(X9ObjectIdentifiers.id_ecPublicKey, params),
					p.getOctets());
		} else {
