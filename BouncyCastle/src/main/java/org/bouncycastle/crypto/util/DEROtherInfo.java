...
/**
 * Builder and holder class for preparing SP 800-56A compliant OtherInfo. The
 * data is ultimately encoded as a DER SEQUENCE. Empty octet strings are used to
...
public class DEROtherInfo {
	...
	public static final class Builder {
		 ...
		 *
		 * @param algorithmID
		 *            the algorithm associated with this invocation of the KDF.
		 * @param partyUInfo
		 *            sender party info.
		 * @param partyVInfo
		 *            receiver party info.
