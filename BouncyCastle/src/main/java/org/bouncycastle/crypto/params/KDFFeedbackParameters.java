...
/**
 * Note that counter is only supported at the location presented in the NIST SP
 * 800-108 specification, not in the additional locations present in the CAVP
 * test vectors.
 */
public final class KDFFeedbackParameters implements DerivationParameters {
	...
	public static KDFFeedbackParameters createWithCounter(byte[] ki, final byte[] iv, byte[] fixedInputData, int r) {
	...
	public static KDFFeedbackParameters createWithoutCounter(byte[] ki, final byte[] iv, byte[] fixedInputData) {
