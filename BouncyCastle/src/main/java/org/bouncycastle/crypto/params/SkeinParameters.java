 ...
 * {@link SkeinParameters.Builder#setKey(byte[]) key}.</li>
 * <li>Randomised hashing, by providing a
 * {@link SkeinParameters.Builder#setNonce(byte[]) nonce}.</li>
 * <li>A hash function for digital signatures, associating a
 * {@link SkeinParameters.Builder#setPublicKey(byte[]) public key} with the
 * message digest.</li>
 * <li>A key derivation function, by providing a
 * {@link SkeinParameters.Builder#setKeyIdentifier(byte[]) key identifier}.</li>
 * <li>Personalised hashing, by providing a
 * {@link SkeinParameters.Builder#setPersonalisation(Date, String, String)
 * recommended format} or
 * {@link SkeinParameters.Builder#setPersonalisation(byte[]) arbitrary}
 * personalisation string.</li>
 * </ul>
 *
 * @see SkeinEngine
 * @see SkeinDigest
...
public class SkeinParameters implements CipherParameters {
	...
	public static class Builder {
		 ...
		 * {@link #PARAM_TYPE_MESSAGE} (reserved for message body).
		 * <p>
		...
		/**
		 * Constructs a new {@link SkeinParameters} instance with the parameters
