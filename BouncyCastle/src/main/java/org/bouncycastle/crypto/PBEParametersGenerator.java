...
public abstract class PBEParametersGenerator {
	 ...
	 *            the number of iterations the "mixing" function is to be applied
	 *            for.
	 */
	...
	/**
	 * generate derived parameters for a key of length keySize, specifically for use
	 * with a MAC.
	 *
	 * @param keySize
	 *            the length, in bits, of the key required.
	...
	/**
	 * converts a password to a byte array according to the scheme in PKCS5 (ascii,
	 * no padding)
	 *
	 * @param password
	...
	/**
	 * converts a password to a byte array according to the scheme in PKCS5 (UTF-8,
	 * no padding)
	 *
	 * @param password
	 *            a character array representing the password.
