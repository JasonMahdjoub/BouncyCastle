...
class MacCFBBlockCipher {
	...
	/**
	 * Initialise the cipher and, possibly, the initialisation vector (IV). If an IV
	 * isn't passed as part of the parameter, the IV will be all zeros. An IV which
	 * is too short is handled in FIPS compliant fashion.
	 *
	 * @param param
	 ...
	 *
	 * @return the name of the underlying algorithm followed by "/CFB" and the block
	 *         size in bits.
	 */
...
public class CFBBlockCipherMac implements Mac {
	 ...
	 * authentication code half the length of the block size of the cipher, with the
	 * CFB mode set to 8 bits.
	 *
	 * @param cipher
	 ...
	 * given in bits. This class uses CFB mode as the basis for the MAC generation.
	 * <p>
