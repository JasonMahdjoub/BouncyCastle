 ...
 * </p>
 * <p>
 * It supports 128- or 64-bits block ciphers, with any key size, and returns a
 * MAC with dimension less or equal to the block size of the underlying cipher.
 * </p>
 */
public class CMac implements Mac {
	...
	/**
	 * create a standard MAC based on a CBC block cipher (64 or 128 bit block). This
	 * will produce an authentication code the length of the block size of the
	 * cipher.
	 *
	 * @param cipher
	 ...
	 *            the cipher to be used as the basis of the MAC generation.
	 * @param macSizeInBits
	 *            the size of the MAC in bits, must be a multiple of 8 and &lt;=
	 *            128.
	 */
