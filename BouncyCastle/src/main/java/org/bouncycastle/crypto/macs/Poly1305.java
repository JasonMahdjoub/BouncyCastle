 ...
 * <p>
 * Poly1305 computes a 128-bit (16 bytes) authenticator, using a 128 bit nonce
 * and a 256 bit key consisting of a 128 bit key applied to an underlying
 * cipher, and a 128 bit key (with 106 effective key bits) used in the
 * authenticator.
 * <p>
 * The polynomial calculation in this implementation is adapted from the public
 * domain <a href=
 * "https://github.com/floodyberry/poly1305-donna">poly1305-donna-unrolled</a> C
 * implementation by Andrew M (@floodyberry).
 * 
...
public class Poly1305 implements Mac {
	...
	/**
	 * Constructs a Poly1305 MAC, where the key passed to init() will be used
	 * directly.
	 */
	public Poly1305() {
		this.cipher = null;
	 ...
	 * 
	 * @param params
	 *            if used with a block cipher, then a {@link ParametersWithIV}
	 *            containing a 128 bit nonce and a {@link KeyParameter} with a 256
	 *            bit key complying to the {@link Poly1305KeyGenerator Poly1305 key
	 *            format}, otherwise just the {@link KeyParameter}.
	 */
