...
/**
 * The GMAC specialisation of Galois/Counter mode (GCM) detailed in NIST Special
 * Publication 800-38D.
 * <p>
 * GMac is an invocation of the GCM mode where no data is encrypted (i.e. all
 * input data to the Mac is processed as additional authenticated data with the
 * underlying GCM block cipher).
 */
public class GMac implements Mac {
	 ...
	 * <p>
	 * This will produce an authentication code the length of the block size of the
	 * cipher.
	 * 
	 * @param cipher
	 ...
	 * 
	 * @param macSizeBits
	 *            the mac size to generate, in bits. Must be a multiple of 8 and
	 *            &gt;= 32 and &lt;= 128. Sizes less than 96 are not recommended,
	...
	/**
	 * Initialises the GMAC - requires a {@link ParametersWithIV} providing a
	 * {@link KeyParameter} and a nonce.
	 */
