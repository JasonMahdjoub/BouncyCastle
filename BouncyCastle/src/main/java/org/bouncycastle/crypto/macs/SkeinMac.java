...
/**
 * Implementation of the Skein parameterised MAC function in 256, 512 and 1024
 * bit block sizes, based on the {@link ThreefishEngine Threefish} tweakable
 * block cipher.
 * <p>
...
public class SkeinMac implements Mac {
	 ...
	 *            the output/MAC size to produce in bits, which must be an integral
	 *            number of bytes.
	 */
	 ...
	 * See {@link SkeinParameters} for details on the parameterisation of the Skein
	 * hash function.
	 *
	 * @param params
	 *            an instance of {@link SkeinParameters} or {@link KeyParameter}.
	 */
	public void init(CipherParameters params) throws IllegalArgumentException {
		...
		if (params instanceof SkeinParameters) {
			...
			throw new IllegalArgumentException(
					"Invalid parameter passed to Skein MAC init - " + params.getClass().getName());
		}
