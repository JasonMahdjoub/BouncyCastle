 ...
 * output using SecureRandom.generateSeed().
 */
public class BasicEntropySourceProvider implements EntropySourceProvider {
	 ...
	 *
	 * @param random
	 *            the SecureRandom to base EntropySource construction on.
	 * @param isPredictionResistant
	 *            boolean indicating if the SecureRandom is based on prediction
	 ...
	 * @return an EntropySource that generates bitsRequired bits of entropy on each
	 *         call to its getEntropy() method.
	 */
