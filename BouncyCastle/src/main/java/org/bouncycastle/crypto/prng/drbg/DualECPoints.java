...
/**
 * General class for providing point pairs for use with DualEC DRBG. See NIST SP
 * 800-90A for further details.
 */
public class DualECPoints {
	 ...
	 * Base Constructor.
	 * <p>
	 * The cofactor is used to calculate the output block length (maxOutlen)
	 * according to
	 * 
	 * <pre>
	 ...
	 *            maximum security strength to be associated with these parameters
	 * @param p
	 *            the P point.
	 * @param q
	 *            the Q point.
	 * @param cofactor
	 *            cofactor associated with the domain parameters for the point
	 *            generation.
	 */
