...
public final class KDFDoublePipelineCounterTests implements CAVPListener {
	...
	public void receiveCAVPVectors(String name, Properties config, Properties vectors) {
		...
		final KDFDoublePipelineIterationParameters params = KDFDoublePipelineIterationParameters.createWithCounter(ki,
				fixedInputData, r);
		gen.init(params);
