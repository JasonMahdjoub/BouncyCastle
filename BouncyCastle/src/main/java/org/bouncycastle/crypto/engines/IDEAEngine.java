...
/**
 * A class that provides a basic International Data Encryption Algorithm (IDEA)
 * engine.
 * <p>
 * This implementation is based on the "HOWTO: INTERNATIONAL DATA ENCRYPTION
 * ALGORITHM" implementation summary by Fauzan Mirza
 * (F.U.Mirza@sheffield.ac.uk). (barring 1 typo at the end of the mulinv
 * function!).
 * <p>
 * It can be found at ftp://ftp.funet.fi/pub/crypt/cryptography/symmetric/idea/
 * <p>
 * Note: This algorithm was patented in the USA, Japan and Europe. These patents
 * expired in 2011/2012.
 */
public class IDEAEngine implements BlockCipher {
	...
	/**
	 * return x = x * y where the multiplication is done modulo 65537 (0x10001) (as
	 * defined in the IDEA specification) and a zero input is taken to be 65536
	 * (0x10000).
	 *
	 * @param x
	 *            the x value
	 ...
	 * subkey. The first 16 bytes are the user key, and the rest of the subkey is
	 * calculated by rotating the previous 16 bytes by 25 bits to the left, and so
	 * on until the subkey is completed.
	 */
	...
	/**
	 * This function computes multiplicative inverse using Euclid's Greatest Common
	 * Divisor algorithm. Zero and one are self inverse.
	 * <p>
	...
	/**
	 * The function to invert the encryption subkey to the decryption subkey. It
	 * also involves the multiplicative inverse and the additive inverse functions.
	 */
