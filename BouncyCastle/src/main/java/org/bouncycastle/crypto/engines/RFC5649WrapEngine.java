...
/**
 * An implementation of the AES Key Wrap with Padding specification as described
 * in RFC 5649.
 * <p>
 * For details on the specification see: <a href=
 * "https://tools.ietf.org/html/rfc5649">https://tools.ietf.org/html/rfc5649</a>
 * </p>
 */
public class RFC5649WrapEngine implements Wrapper {
	...
	/**
	 * Pads the plaintext (i.e., the key to be wrapped) as per section 4.1 of RFC
	 * 5649.
	 *
	 * @param plaintext
	...
	/**
	 * Performs steps 1 and 2 of the unwrap process defined in RFC 3394. This code
	 * is duplicated from RFC3394WrapEngine because that class will throw an error
	 * during unwrap because the IV won't match up.
	 *
	 * @param in
	 * @param inOff
	 * @param inLen
