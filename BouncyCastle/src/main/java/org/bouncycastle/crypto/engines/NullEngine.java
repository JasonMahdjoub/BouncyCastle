...
/**
 * The no-op engine that just copies bytes through, irrespective of whether
 * encrypting and decrypting. Provided for the sake of completeness.
 */
public class NullEngine implements BlockCipher {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.bouncycastle.crypto.BlockCipher#processBlock(byte[], int, byte[],
	 * int)
	 */
