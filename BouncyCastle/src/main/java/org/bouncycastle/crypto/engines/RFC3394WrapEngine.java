 ...
 * "http://www.ietf.org/rfc/rfc3394.txt">http://www.ietf.org/rfc/rfc3394.txt</a>
 * and <a href=
 * "http://csrc.nist.gov/encryption/kms/key-wrap.pdf">http://csrc.nist.gov/encryption/kms/key-wrap.pdf</a>.
 */
public class RFC3394WrapEngine implements Wrapper {
	...
	private byte[] iv = { (byte) 0xa6, (byte) 0xa6, (byte) 0xa6, (byte) 0xa6, (byte) 0xa6, (byte) 0xa6, (byte) 0xa6,
			(byte) 0xa6 };

	/**
	 * Create a RFC 3394 WrapEngine specifying the encrypt for wrapping, decrypt for
	 * unwrapping.
	 *
	 * @param engine
	...
	/**
	 * Create a RFC 3394 WrapEngine specifying the direction for wrapping and
	 * unwrapping..
	 *
	 * @param engine
	 *            the block cipher to be used for wrapping.
	 * @param useReverseDirection
	 *            true if engine should be used in decryption mode for wrapping,
	 *            false otherwise.
	 */
