...
public class RC532Engine implements BlockCipher {
	 ...
	 *
	 * Pw = Odd((e-2) * 2^wordsize) Qw = Odd((o-2) * 2^wordsize)
	 *
	 * where e is the base of natural logarithms (2.718281828...) and o is the
	...
	public void init(boolean forEncryption, CipherParameters params) {
		if (params instanceof RC5Parameters) {
			...
			throw new IllegalArgumentException(
					"invalid parameter passed to RC532 init - " + params.getClass().getName());
		}
	...
	/**
	 * Encrypt the given block starting at the given offset and place the result in
	 * the provided buffer starting at the given offset.
	 * <p>
	 * 
	 * @param in
	 *            in byte buffer containing data to encrypt
	 * @param inOff
	 *            offset into src buffer
	 * @param out
	 *            out buffer where encrypted data is written
	 * @param outOff
	 *            offset into out buffer
	 */
	...
	/**
	 * Perform a left "spin" of the word. The rotation of the given word <em>x</em>
	 * is rotated left by <em>y</em> bits. Only the <em>lg(32)</em> low-order bits
	 * of <em>y</em> are used to determine the rotation amount. Here it is assumed
	 * that the wordsize used is a power of 2.
	 * <p>
	 * 
	 * @param x
	 *            word to rotate
	 * @param y
	 *            number of bits to rotate % 32
	 */
	...
	/**
	 * Perform a right "spin" of the word. The rotation of the given word <em>x</em>
	 * is rotated left by <em>y</em> bits. Only the <em>lg(32)</em> low-order bits
	 * of <em>y</em> are used to determine the rotation amount. Here it is assumed
	 * that the wordsize used is a power of 2.
	 * <p>
