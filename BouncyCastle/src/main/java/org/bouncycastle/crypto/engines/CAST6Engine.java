...
/**
 * A class that provides CAST6 key encryption operations, such as encoding data
 * and generating keys.
 *
...
public final class CAST6Engine extends CAST5Engine {
	...
	/*
	 * Put the round and mask keys into an array. Kr0[i] => _Kr[i*4 + 0]
	 */
	...
	/*
	 * Creates the subkeys using the same nomenclature as described in RFC2612.
	 *
	 * See section 2.4
	 */
	 ...
	 * 
	 * @param A
	 *            the 00-31 bits of the plaintext block
	 * @param B
	 *            the 32-63 bits of the plaintext block
	 * @param C
	 *            the 64-95 bits of the plaintext block
	 * @param D
	 ...
	 * 
	 * @param A
	 *            the 00-31 bits of the ciphertext block
	 * @param B
	 *            the 32-63 bits of the ciphertext block
	 * @param C
