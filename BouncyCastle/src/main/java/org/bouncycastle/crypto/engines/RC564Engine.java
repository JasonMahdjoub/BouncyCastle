...
public class RC564Engine implements BlockCipher {
	...
	public void init(boolean forEncryption, CipherParameters params) {
		if (!(params instanceof RC5Parameters)) {
			throw new IllegalArgumentException(
					"invalid parameter passed to RC564 init - " + params.getClass().getName());
		}
	 ...
	 * is rotated left by <em>y</em> bits. Only the <em>lg(wordSize)</em> low-order
	 * bits of <em>y</em> are used to determine the rotation amount. Here it is
