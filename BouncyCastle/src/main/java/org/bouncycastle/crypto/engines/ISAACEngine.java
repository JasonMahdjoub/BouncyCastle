...
/**
 * Implementation of Bob Jenkin's ISAAC (Indirection Shift Accumulate Add and
 * Count). see: http://www.burtleburtle.net/bob/rand/isaacafa.html
 */
public class ISAACEngine implements StreamCipher {
	...
	public void init(boolean forEncryption, CipherParameters params) {
		...
		/*
		 * ISAAC encryption and decryption is completely symmetrical, so the
