 ...
 *
 * This Java implementation is based on the Java reference implementation
 * provided by Bruce Schneier and developed by Raif S. Naffah.
 */
public final class TwofishEngine implements BlockCipher {
	...
	/**
	 * Define the fixed p0/p1 permutations used in keyed S-box lookup. By changing
	 * the following constant definitions, the S-boxes will automatically get
	 * changed in the Twofish engine.
	 */
	...
	/**
	 * gSubKeys[] and gSBox[] are eventually used in the encryption and decryption
	 * methods.
	 */
	...
	private void setKey(byte[] key) {
		 ...
		 * The input key is a maximum of 32 bytes (256 bits), so the range for k64Cnt is
		 * 1..4
		 */
		...
		/*
		 * the function exits having setup the gSBox with the input key material.
		 */
	}
	 ...
	 *
	 * encryptBlock uses the pre-calculated gSBox[] and subKey[] arrays.
	 */
	...
	/*
	 * TODO: This can be optimised and made cleaner by combining the functionality
	 * in this function and applying it appropriately to the creation of the subkeys
	 * during key setup.
	 */
	 ...
	 * entity from 2 key material 32-bit entities.
	 *
	 * @param k0
	 *            first 32-bit entity
	 * @param k1
	 *            second 32-bit entity
