 ...
 * parties have long term public keys you should look at using this. For further
...
public class DHAgreement {
	 ...
	 * calculate the next message in the agreement sequence. In this case this will
