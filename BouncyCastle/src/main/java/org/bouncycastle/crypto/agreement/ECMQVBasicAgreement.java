...
public class ECMQVBasicAgreement implements BasicAgreement {
	...
	public BigInteger calculateAgreement(CipherParameters pubKey) {
		...
		ECPoint agreement = calculateMqvAgreement(parameters, staticPrivateKey, privParams.getEphemeralPrivateKey(),
				privParams.getEphemeralPublicKey(), pubParams.getStaticPublicKey(), pubParams.getEphemeralPublicKey())
						.normalize();
	...
	private ECPoint calculateMqvAgreement(ECDomainParameters parameters, ECPrivateKeyParameters d1U,
			ECPrivateKeyParameters d2U, ECPublicKeyParameters Q2U, ECPublicKeyParameters Q1V,
		...
		ECPoint[] points = new ECPoint[] {
				// The Q2U public key is optional - but will be calculated for us if it wasn't
				// present
				ECAlgorithms.importPoint(curve, Q2U.getQ()), ECAlgorithms.importPoint(curve, Q1V.getQ()),
