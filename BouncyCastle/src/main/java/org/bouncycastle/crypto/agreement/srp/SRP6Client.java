...
/**
 * Implements the client side SRP-6a protocol. Note that this class is stateful,
 * and therefore NOT threadsafe. This implementation of SRP is based on the
 * optimized message sequence put forth by Thomas Wu in the paper "SRP-6:
 * Improvements and Refinements to the Secure Remote Password Protocol, 2002"
 */
public class SRP6Client {
	...
	/**
	 * Authenticates the server evidence message M2 received and saves it only if
	 * correct.
	 * 
	 * @param serverM2
	 ...
	 * authentication To be called after verifying the server evidence message M2.
	 * 
