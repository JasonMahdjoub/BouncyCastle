...
/**
 * Standard pre-computed prime order groups for use by J-PAKE. (J-PAKE can use
 * pre-computed prime order groups, same as DSA and Diffie-Hellman.)
 * <p>
 * This class contains some convenient constants for use as input for
 * constructing {@link JPAKEParticipant}s.
 * <p>
 * The prime order groups below are taken from Sun's JDK JavaDoc
 * (docs/guide/security/CryptoSpec.html#AppB), and from the prime order groups
 * <a href=
 * "http://csrc.nist.gov/groups/ST/toolkit/documents/Examples/DSA2_All.pdf">published
 * by NIST</a>.
 */
public class JPAKEPrimeOrderGroups {
	/**
	 * From Sun's JDK JavaDoc (docs/guide/security/CryptoSpec.html#AppB) 1024-bit p,
	 * 160-bit q and 1024-bit g for 80-bit security.
	 */
	public static final JPAKEPrimeOrderGroup SUN_JCE_1024 = new JPAKEPrimeOrderGroup(
			...
			// g
			new BigInteger("f7e1a085d69b3ddecbbcab5c36b857b97994afbbfa3aea82f9574c0b3d078267"
	...
	public static final JPAKEPrimeOrderGroup NIST_2048 = new JPAKEPrimeOrderGroup(
			// p
			new BigInteger("C196BA05AC29E1F9C3C72D56DFFC6154A033F1477AC88EC37F09BE6C5BB95F51"
			...
			// g
			new BigInteger("A59A749A11242C58C894E9E5A91804E8FA0AC64B56288F8D47D51B1EDC4D6544"
	...
	public static final JPAKEPrimeOrderGroup NIST_3072 = new JPAKEPrimeOrderGroup(
			// p
			new BigInteger("90066455B5CFC38F9CAA4A48B4281F292C260FEEF01FD61037E56258A7795A1C"
			...
			// g
			new BigInteger("5E5CBA992E0A680D885EB903AEA78E4A45A469103D448EDE3B7ACCC54D521E37"
