...
public class CustomNamedCurves {
	...
	static X9ECParametersHolder curve25519 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			/*
			 * NOTE: Curve25519 was specified in Montgomery form. Rewriting in Weierstrass
			 * form involves substitution of variables, so the base-point x coordinate is 9
			 * + (486662 / 3).
			 * 
			 ...
			 * 
			 * (The other possible y value is
			 * 5F51E65E475F794B1FE122D388B72EB36DC2B28192839E4DD6163A5D81312C14)
			 */
			X9ECPoint G = new X9ECPoint(curve,
					Hex.decode("04" + "2AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAD245A"
	...
	static X9ECParametersHolder secp128r1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			X9ECPoint G = new X9ECPoint(curve,
					Hex.decode("04" + "161FF7528B899B2D0C28607CA52C5B86" + "CF5AC8395BAFEB13C02DA292DDED7A83"));
			return new X9ECParameters(curve, G, curve.getOrder(), curve.getCofactor(), S);
		}
	};
	...
	static X9ECParametersHolder secp160k1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			GLVTypeBParameters glv = new GLVTypeBParameters(
					...
					new BigInteger[] { new BigInteger("9162fbe73984472a0a9e", 16),
							new BigInteger("-96341f1138933bc2f505", 16) },
					new BigInteger[] { new BigInteger("127971af8721782ecffa3", 16),
							new BigInteger("9162fbe73984472a0a9e", 16) },
					new BigInteger("9162fbe73984472a0a9d0590", 16), new BigInteger("96341f1138933bc2f503fd44", 16),
					176);
			ECCurve curve = configureCurveGLV(new SecP160K1Curve(), glv);
			X9ECPoint G = new X9ECPoint(curve, Hex.decode(
	...
	static X9ECParametersHolder secp160r2 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			X9ECPoint G = new X9ECPoint(curve, Hex.decode(
					"04" + "52DCB034293A117E1F4FF11B30F7199D3144CE6D" + "FEAFFEF2E331F296E071FA0DF9982CFEA7D43F2E"));
			return new X9ECParameters(curve, G, curve.getOrder(), curve.getCofactor(), S);
		}
	};
	...
	static X9ECParametersHolder secp192k1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			GLVTypeBParameters glv = new GLVTypeBParameters(
					...
					new BigInteger[] { new BigInteger("71169be7330b3038edb025f1", 16),
							new BigInteger("-b3fb3400dec5c4adceb8655c", 16) },
					new BigInteger[] { new BigInteger("12511cfe811d0f4e6bc688b4d", 16),
							new BigInteger("71169be7330b3038edb025f1", 16) },
					new BigInteger("71169be7330b3038edb025f1d0f9", 16),
					new BigInteger("b3fb3400dec5c4adceb8655d4c94", 16), 208);
			ECCurve curve = configureCurveGLV(new SecP192K1Curve(), glv);
			X9ECPoint G = new X9ECPoint(curve, Hex.decode("04" + "DB4FF10EC057E9AE26B07D0280B7F4341DA5D1B1EAE06C7D"
	...
	static X9ECParametersHolder secp192r1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			X9ECPoint G = new X9ECPoint(curve, Hex.decode("04" + "188DA80EB03090F67CBF20EB43A18800F4FF0AFD82FF1012"
	...
	static X9ECParametersHolder secp224k1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			GLVTypeBParameters glv = new GLVTypeBParameters(
					...
					new BigInteger[] { new BigInteger("6b8cf07d4ca75c88957d9d670591", 16),
							new BigInteger("-b8adf1378a6eb73409fa6c9c637d", 16) },
					new BigInteger[] { new BigInteger("1243ae1b4d71613bc9f780a03690e", 16),
							new BigInteger("6b8cf07d4ca75c88957d9d670591", 16) },
					new BigInteger("6b8cf07d4ca75c88957d9d67059037a4", 16),
					new BigInteger("b8adf1378a6eb73409fa6c9c637ba7f5", 16), 240);
			ECCurve curve = configureCurveGLV(new SecP224K1Curve(), glv);
			X9ECPoint G = new X9ECPoint(curve,
					Hex.decode("04" + "A1455B334DF099DF30FC28A169A467E9E47075A90F7E650EB6B7A45C"
	...
	static X9ECParametersHolder secp224r1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			X9ECPoint G = new X9ECPoint(curve,
					Hex.decode("04" + "B70E0CBD6BB4BF7F321390B94A03C1D356C21122343280D6115C1D21"
	...
	static X9ECParametersHolder secp256k1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			GLVTypeBParameters glv = new GLVTypeBParameters(
					...
					new BigInteger[] { new BigInteger("3086d221a7d46bcde86c90e49284eb15", 16),
							new BigInteger("-e4437ed6010e88286f547fa90abfe4c3", 16) },
					new BigInteger[] { new BigInteger("114ca50f7a8e2f3f657c1108d9d44cfd8", 16),
							new BigInteger("3086d221a7d46bcde86c90e49284eb15", 16) },
					new BigInteger("3086d221a7d46bcde86c90e49284eb153dab", 16),
					new BigInteger("e4437ed6010e88286f547fa90abfe4c42212", 16), 272);
	...
	static X9ECParametersHolder sect113r1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			X9ECPoint G = new X9ECPoint(curve,
					Hex.decode("04" + "009D73616F35F4AB1407D73562C10F" + "00A52830277958EE84D1315ED31886"));
			return new X9ECParameters(curve, G, curve.getOrder(), curve.getCofactor(), S);
		}
	};
	...
	static X9ECParametersHolder sect131r1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			X9ECPoint G = new X9ECPoint(curve,
					Hex.decode("04" + "0081BAF91FDF9833C40F9C181343638399" + "078C6E7EA38C001F73C8134B1B4EF9E150"));
			return new X9ECParameters(curve, G, curve.getOrder(), curve.getCofactor(), S);
		}
	};
	...
	static X9ECParametersHolder sect131r2 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			X9ECPoint G = new X9ECPoint(curve,
					Hex.decode("04" + "0356DCD8F2F95031AD652D23951BB366A8" + "0648F06D867940A5366D9E265DE9EB240F"));
			return new X9ECParameters(curve, G, curve.getOrder(), curve.getCofactor(), S);
		}
	};
	...
	static X9ECParametersHolder sect163r2 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			X9ECPoint G = new X9ECPoint(curve, Hex.decode("04" + "03F0EBA16286A2D57EA0991168D4994637E8343E36"
	...
	static X9ECParametersHolder sect193r1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			X9ECPoint G = new X9ECPoint(curve, Hex.decode("04" + "01F481BC5F0FF84A74AD6CDF6FDEF4BF6179625372D8C0C5E1"
	...
	static X9ECParametersHolder sect193r2 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			X9ECPoint G = new X9ECPoint(curve, Hex.decode("04" + "00D9B67D192E0367C803F39E1A7E82CA14A651350AAE617E8F"
	...
	static X9ECParametersHolder sect233r1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			X9ECPoint G = new X9ECPoint(curve,
					Hex.decode("04" + "00FAC9DFCBAC8313BB2139F1BB755FEF65BC391F8B36F8F8EB7371FD558B"
	...
	static X9ECParametersHolder sect283k1 = new X9ECParametersHolder() {
		protected X9ECParameters createParameters() {
			...
			X9ECPoint G = new X9ECPoint(curve,
					Hex.decode("04" + "0503213F78CA44883F1A3B8162F188E553CD265F23C1567A16876913B0C2AC2458492836"
