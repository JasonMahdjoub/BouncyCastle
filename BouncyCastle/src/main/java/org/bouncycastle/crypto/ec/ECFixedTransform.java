...
/**
 * this transforms the original randomness used for an ElGamal encryption by a
 * fixed value.
 */
public class ECFixedTransform implements ECPairFactorTransform {
	...
	/**
	 * Transform an existing cipher text pair using the ElGamal algorithm. Note: it
	 * is assumed this transform has been initialised with the same public key that
	 * was used to create the original cipher text.
	 *
	 * @param cipherText
	...
	public ECPair transform(ECPair cipherText) {
		...
		ECPoint[] gamma_phi = new ECPoint[] { basePointMultiplier.multiply(ec.getG(), k).add(cipherText.getX()),
