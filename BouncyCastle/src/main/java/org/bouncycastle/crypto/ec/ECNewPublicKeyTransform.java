...
public class ECNewPublicKeyTransform implements ECPairTransform {
	...
	/**
	 * Transform an existing cipher text pair using the ElGamal algorithm. Note: the
	 * input cipherText will need to be preserved in order to complete the
	 * transformation to the new public key.
	 *
	 * @param cipherText
	...
	public ECPair transform(ECPair cipherText) {
		...
		ECPoint[] gamma_phi = new ECPoint[] { basePointMultiplier.multiply(ec.getG(), k),
