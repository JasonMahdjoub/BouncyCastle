 ...
 * piecemeal fashion with padding. The PaddedBufferedBlockCipher outputs a block
 * only when the buffer is full and more data is being added, or on a doFinal
 * (unless the current block in the buffer is a pad block). The default padding
...
public class PaddedBufferedBlockCipher extends BufferedBlockCipher {
	...
	/**
	 * return the minimum size of the output buffer required for an update plus a
