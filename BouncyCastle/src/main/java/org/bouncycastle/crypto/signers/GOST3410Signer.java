...
public class GOST3410Signer implements DSA {
	 ...
	 * with. For conventional GOST3410 the message should be a GOST3411 hash of the
	 * message of interest.
	 *
	 * @param message
	 ...
	 * passed in message for standard GOST3410 the message should be a GOST3411 hash
	 * of the real message to be verified.
	 */
