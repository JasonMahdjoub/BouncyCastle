 ...
 * <p>
 * Note: the usual value for the salt length is the number of bytes in the hash
 * function.
 */
public class PSSSigner implements Signer {
	...
	/**
	 * generate a signature for the message we've been loaded with using the key we
	...
	/**
	 * return true if the internal state represents the signature described in the
	 * passed in array.
	 */
