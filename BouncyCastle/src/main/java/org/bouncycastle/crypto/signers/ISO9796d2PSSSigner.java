 ...
 * <p>
 * Note: the usual length for the salt is the length of the hash function used
 * in bytes.
 */
public class ISO9796d2PSSSigner implements SignerWithRecovery {
	 ...
	 *            parameters are for generation they should be a
	 *            ParametersWithRandom, a ParametersWithSalt, or just an
	 *            RSAKeyParameters object. If RSAKeyParameters are passed in a
	 *            SecureRandom will be created.
	 * @throws IllegalArgumentException
	 *             if wrong parameter type or a fixed salt is passed in which is the
	 *             wrong length.
	 */
	...
	public void updateWithRecoveredMessage(byte[] signature) throws InvalidCipherTextException {
		...
		// remove the mask
		//
		byte[] dbMask = maskGeneratorFunction1(block, block.length - hLen - tLength, hLen,
				block.length - hLen - tLength);
	...
	/**
	 * generate a signature for the loaded message using the key we were initialised
	 * with.
	 */
	...
	/**
	 * return true if the signature represents a ISO9796-2 signature for the passed
	 * in message.
	 */
	...
	/**
	 * Return a reference to the recoveredMessage message, either as it was added to
	 * a just generated signature, or extracted from a verified one.
	 *
