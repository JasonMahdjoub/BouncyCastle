...
public class Certificate {
	...
	/**
	 * @return an array of {@link org.bouncycastle.asn1.x509.Certificate}
	...
	public static Certificate parse(InputStream input) throws IOException {
		...
		org.bouncycastle.asn1.x509.Certificate[] certificateList = new org.bouncycastle.asn1.x509.Certificate[certificate_list
				.size()];
