 ...
 * <p>
 * Support fast rejection of duplicate records by maintaining a sliding receive
 * window
 * </p>
 */
class DTLSReplayWindow {
	...
	/**
	 * Check whether a received record with the given sequence number should be
	 * rejected as a duplicate.
	 *
	 * @param seq
	 *            the 48-bit DTLSPlainText.sequence_number field of a received
	 *            record.
	...
	/**
	 * Report that a received record with the given sequence number passed
	 * authentication checks.
	 *
	 * @param seq
	 *            the 48-bit DTLSPlainText.sequence_number field of an authenticated
	 *            record.
	 */
