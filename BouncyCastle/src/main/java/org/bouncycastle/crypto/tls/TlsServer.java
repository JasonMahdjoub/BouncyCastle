...
public interface TlsServer extends TlsPeer {
	 ...
	 * See <i>RFC 3546 3.6. Certificate Status Request</i>. If a non-null
	 * {@link CertificateStatus} is returned, it is sent to the client as a
	 * handshake message of type "certificate_status".
	 * 
	 * @return A {@link CertificateStatus} to be sent to the client (or null for
	 *         none).
	 * @throws IOException
	 */
	 ...
	 * <p>
	 * This method will be called (only) if a NewSessionTicket extension was sent by
	 * the server. See <i>RFC 5077 4. Recommended Ticket Construction</i> for
	 * recommended format and protection.
	 *
	 * @return The ticket.
	 * @throws IOException
	 */
