...
/**
 * An implementation of {@link TlsSRPIdentityManager} that simulates the
 * existence of "unknown" identities to obscure the fact that there is no
 * verifier for them.
 */
public class SimulatedTlsSRPIdentityManager implements TlsSRPIdentityManager {
	...
	/**
	 * Create a {@link SimulatedTlsSRPIdentityManager} that implements the algorithm
	 * from RFC 5054 2.5.1.3
	 *
	 * @param group
	 *            the {@link SRP6GroupParameters} defining the group that SRP is
	 *            operating in
	 * @param seedKey
