...
public class ECCurveType {
	/**
	 * Indicates the elliptic curve domain parameters are conveyed verbosely, and
	 * the underlying finite field is a prime field.
	 */
	public static final short explicit_prime = 1;

	/**
	 * Indicates the elliptic curve domain parameters are conveyed verbosely, and
	 * the underlying finite field is a characteristic-2 field.
	 */
