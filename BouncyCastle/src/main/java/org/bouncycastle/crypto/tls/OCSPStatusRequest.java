...
public class OCSPStatusRequest {
	 ...
	 *            a {@link Vector} of {@link ResponderID}, specifying the list of
	 *            trusted OCSP responders. An empty list has the special meaning
	 *            that the responders are implicitly known to the server - e.g., by
	 *            prior arrangement.
	 * @param requestExtensions
	 *            OCSP request extensions. A null value means that there are no
	 *            extensions.
	 */
