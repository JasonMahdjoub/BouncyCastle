...
public class SHA224Digest extends GeneralDigest implements EncodableDigest {
	...
	/**
	 * State constructor - create a digest initialised with the state of a previous
	 * one.
	 *
	 * @param encodedState
	...
	/*
	 * SHA-224 Constants (represent the first 32 bits of the fractional parts of the
