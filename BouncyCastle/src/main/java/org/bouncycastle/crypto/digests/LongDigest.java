...
public abstract class LongDigest implements ExtendedDigest, Memoable, EncodableDigest {
	...
	/**
	 * adjust the byte counts so that byteCount2 represents the upper long (less 3
	 * bits) word of the byte count.
	 */
	...
	/*
	 * SHA-384 and SHA-512 Constants (represent the first 64 bits of the fractional
	 * parts of the cube roots of the first sixty-four prime numbers)
	 */
	static final long K[] = { 0x428a2f98d728ae22L, 0x7137449123ef65cdL, 0xb5c0fbcfec4d3b2fL, 0xe9b5dba58189dbbcL,
