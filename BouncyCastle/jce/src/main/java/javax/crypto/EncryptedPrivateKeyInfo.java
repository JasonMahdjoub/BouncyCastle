...
import org.bouncycastle.bcasn1.DERObjectIdentifier;
...
{
    private org.bouncycastle.bcasn1.pkcs.EncryptedPrivateKeyInfo infoObj;
        ...
        throws NullPointerException, IOException
    {
        ...
        infoObj = org.bouncycastle.bcasn1.pkcs.EncryptedPrivateKeyInfo.getInstance((ASN1Sequence)dIn.readObject());
        ...
        throws NullPointerException, IllegalArgumentException, NoSuchAlgorithmException
    {
        ...
        org.bouncycastle.bcasn1.x509.AlgorithmIdentifier      kAlgId = new AlgorithmIdentifier(new DERObjectIdentifier(algName), null);

        infoObj = new org.bouncycastle.bcasn1.pkcs.EncryptedPrivateKeyInfo(kAlgId, (byte[])encryptedData.clone());
        algP = this.getParameters();
    }
        ...
        throws NullPointerException, IllegalArgumentException, NoSuchAlgorithmException
    {
        ...
        org.bouncycastle.bcasn1.x509.AlgorithmIdentifier      kAlgId = null;
