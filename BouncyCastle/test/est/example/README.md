...
```
/src/main/java/com/distrimind/bouncycastle/test/est/examples
```
...
```<bc-java>/test/src/test/java/com/distrimind/bouncycastle/test/est/TestCACertsFetch.java```
...
```test/src/test/java/com/distrimind/bouncycastle/test/est/TestEnroll.java```

And for reenrollment:
```<bc-java>/test/src/test/java/com/distrimind/bouncycastle/test/est/TestReEnroll.java```
...
```<bc-java>/test/src/test/java/com/distrimind/bouncycastle/test/est/TestGetCSRAttrs.java```
---
