...
import com.distrimind.bouncycastle.cert.jcajce.JcaX509ContentVerifierProviderBuilder;
import com.distrimind.bouncycastle.cert.path.CertPath;
import com.distrimind.bouncycastle.cert.path.CertPathValidation;
import com.distrimind.bouncycastle.cert.path.CertPathValidationResult;
import com.distrimind.bouncycastle.cert.path.validations.BasicConstraintsValidation;
import com.distrimind.bouncycastle.cert.path.validations.KeyUsageValidation;
import com.distrimind.bouncycastle.cert.path.validations.ParentCertIssuedValidation;
...
public class PKITSBasicConstraintsTest
    extends SimpleTest
{
    public static final String PKITS_DATA_RESOURCE_PREFIX = "com/distrimind/bouncycastle/cert/PKITS/certs/";
