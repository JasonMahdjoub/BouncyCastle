    ...
    extends TestCase
{
    ...
    {
        org.bouncycastle.bcutil.test.Test[] tests = new org.bouncycastle.bcutil.test.Test[] { new CertTest(), new PKCS10Test(), new AttrCertSelectorTest(), new AttrCertTest(), new X509ExtensionUtilsTest() };
