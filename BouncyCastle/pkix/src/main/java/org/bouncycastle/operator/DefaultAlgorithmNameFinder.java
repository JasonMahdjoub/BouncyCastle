    ...
    implements AlgorithmNameFinder
{
    ...
    static
    {
        ...
        algorithms.put(BCMiscObjectIdentifiers.as_sys_sec_alg_ideaCBC, "IDEA/CBC");
        algorithms.put(BCMiscObjectIdentifiers.cast5CBC, "CAST5/CBC");
        algorithms.put(BCMiscObjectIdentifiers.cryptlib_algorithm_blowfish_ECB, "Blowfish/ECB");
        algorithms.put(BCMiscObjectIdentifiers.cryptlib_algorithm_blowfish_CBC, "Blowfish/CBC");
        algorithms.put(BCMiscObjectIdentifiers.cryptlib_algorithm_blowfish_CFB, "Blowfish/CFB");
        algorithms.put(BCMiscObjectIdentifiers.cryptlib_algorithm_blowfish_OFB, "Blowfish/OFB");
