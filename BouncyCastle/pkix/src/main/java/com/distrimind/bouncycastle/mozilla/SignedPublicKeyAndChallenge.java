package com.distrimind.bouncycastle.mozilla;
...
{
    protected final com.distrimind.bouncycastle.asn1.mozilla.SignedPublicKeyAndChallenge          spkacSeq;

    public SignedPublicKeyAndChallenge(byte[] bytes)
    {
        spkacSeq = com.distrimind.bouncycastle.asn1.mozilla.SignedPublicKeyAndChallenge.getInstance(bytes);
    }

    protected SignedPublicKeyAndChallenge(com.distrimind.bouncycastle.asn1.mozilla.SignedPublicKeyAndChallenge struct)
    {
     ...
     */
    public com.distrimind.bouncycastle.asn1.mozilla.SignedPublicKeyAndChallenge toASN1Structure()
    {
         return spkacSeq;
    }
