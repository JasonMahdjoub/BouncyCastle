...
import com.distrimind.bouncycastle.asn1.cms.CMSAlgorithmProtection;
...
import com.distrimind.bouncycastle.asn1.cms.Time;
...
public class SignerInformation
{
     ...
     * @throws com.distrimind.bouncycastle.cms.CMSVerifierCertificateNotValidException if the provider has an associated certificate and the certificate is not valid at the time given as the SignerInfo's signing time.
     * @throws com.distrimind.bouncycastle.cms.CMSException if the verifier is unable to create a ContentVerifiers or DigestCalculators.
     */
