    ...
    extends TestCase
{
        ...
        throws Exception
    {
        ...
        doFullGetInstanceTest(com.distrimind.bouncycastle.asn1.cmp.CertStatus.class, new com.distrimind.bouncycastle.asn1.cmp.CertStatus(new byte[10], BigInteger.valueOf(1), new PKIStatusInfo(PKIStatus.granted)));
