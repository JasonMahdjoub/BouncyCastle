...
import com.distrimind.bouncycastle.bcpg.sig.IntendedRecipientFingerprint;
import com.distrimind.bouncycastle.bcpg.sig.IssuerFingerprint;
import com.distrimind.bouncycastle.bcpg.sig.IssuerKeyID;
import com.distrimind.bouncycastle.bcpg.sig.KeyExpirationTime;
import com.distrimind.bouncycastle.bcpg.sig.KeyFlags;
import com.distrimind.bouncycastle.bcpg.sig.NotationData;
import com.distrimind.bouncycastle.bcpg.sig.PreferredAlgorithms;
import com.distrimind.bouncycastle.bcpg.sig.PrimaryUserID;
import com.distrimind.bouncycastle.bcpg.sig.Revocable;
import com.distrimind.bouncycastle.bcpg.sig.RevocationKey;
import com.distrimind.bouncycastle.bcpg.sig.RevocationKeyTags;
import com.distrimind.bouncycastle.bcpg.sig.RevocationReason;
import com.distrimind.bouncycastle.bcpg.sig.SignatureCreationTime;
import com.distrimind.bouncycastle.bcpg.sig.SignatureExpirationTime;
import com.distrimind.bouncycastle.bcpg.sig.SignatureTarget;
import com.distrimind.bouncycastle.bcpg.sig.SignerUserID;
import com.distrimind.bouncycastle.bcpg.sig.TrustSignature;
...
public class PGPSignatureSubpacketGenerator
{
     ...
     * See {@link com.distrimind.bouncycastle.bcpg.HashAlgorithmTags}.
     *
     * @param isCritical true if should be treated as critical, false otherwise.
     ...
     * See {@link com.distrimind.bouncycastle.bcpg.SymmetricKeyAlgorithmTags}.
     *
     * @param isCritical true if should be treated as critical, false otherwise.
     * @param algorithms array of algorithms in descending preference
     */
     ...
     * See {@link com.distrimind.bouncycastle.bcpg.CompressionAlgorithmTags}.
     *
     * @param isCritical true if should be treated as critical, false otherwise.
     * @param algorithms array of algorithms in descending preference
     */
     ...
     * See {@link com.distrimind.bouncycastle.bcpg.sig.RevocationReasonTags}.
     *
     * @param isCritical true if should be treated as critical, false otherwise.
