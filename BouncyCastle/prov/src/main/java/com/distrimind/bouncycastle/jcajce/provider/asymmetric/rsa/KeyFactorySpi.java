...
import com.distrimind.bouncycastle.jcajce.provider.asymmetric.util.ExtendedInvalidKeySpecException;
    ...
    extends BaseKeyFactorySpi
{
        ...
        throws InvalidKeySpecException
    {
        ...
        else if (spec.isAssignableFrom(com.distrimind.bouncycastle.jce.spec.OpenSSHPublicKeySpec.class) && key instanceof RSAPublicKey)
        {
            try
            {
        ...
        else if (spec.isAssignableFrom(com.distrimind.bouncycastle.jce.spec.OpenSSHPrivateKeySpec.class) && key instanceof RSAPrivateCrtKey)
        {
            try
            {
                return new com.distrimind.bouncycastle.jce.spec.OpenSSHPrivateKeySpec(OpenSSHPrivateKeyUtil.encodePrivateKey(new RSAPrivateCrtKeyParameters(
                    ((RSAPrivateCrtKey)key).getModulus(),
                    ((RSAPrivateCrtKey)key).getPublicExponent(),
                    ((RSAPrivateCrtKey)key).getPrivateExponent(),
                    ((RSAPrivateCrtKey)key).getPrimeP(),
