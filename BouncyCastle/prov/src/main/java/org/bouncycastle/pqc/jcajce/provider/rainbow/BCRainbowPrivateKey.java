    ...
    implements PrivateKey
{
    ...
    public int hashCode()
    {
        ...
        hash = hash * 37 + org.bouncycastle.bcutil.Arrays.hashCode(A1inv);
        hash = hash * 37 + org.bouncycastle.bcutil.Arrays.hashCode(b1);
        hash = hash * 37 + org.bouncycastle.bcutil.Arrays.hashCode(A2inv);
        hash = hash * 37 + org.bouncycastle.bcutil.Arrays.hashCode(b2);
        hash = hash * 37 + org.bouncycastle.bcutil.Arrays.hashCode(vi);
