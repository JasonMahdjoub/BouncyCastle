...
public class Blake2s
{
        ...
        extends DigestAlgorithmProvider
    {
        ...
        public void configure(ConfigurableProvider provider)
        {
            ...
            provider.addAlgorithm("Alg.Alias.MessageDigest." + BCMiscObjectIdentifiers.id_blake2s256, "BLAKE2S-256");

            provider.addAlgorithm("MessageDigest.BLAKE2S-224", PREFIX + "$Blake2s224");
            provider.addAlgorithm("Alg.Alias.MessageDigest." + BCMiscObjectIdentifiers.id_blake2s224, "BLAKE2S-224");

            provider.addAlgorithm("MessageDigest.BLAKE2S-160", PREFIX + "$Blake2s160");
            provider.addAlgorithm("Alg.Alias.MessageDigest." + BCMiscObjectIdentifiers.id_blake2s160, "BLAKE2S-160");

            provider.addAlgorithm("MessageDigest.BLAKE2S-128", PREFIX + "$Blake2s128");
            provider.addAlgorithm("Alg.Alias.MessageDigest." + BCMiscObjectIdentifiers.id_blake2s128, "BLAKE2S-128");
        }
    }
}
