...
import org.bouncycastle.bcjcajce.provider.asymmetric.gost.KeyFactorySpi;
...
public class GOST
{
    private static final String PREFIX = "org.bouncycastle.bcjcajce.provider.asymmetric" + ".gost.";
