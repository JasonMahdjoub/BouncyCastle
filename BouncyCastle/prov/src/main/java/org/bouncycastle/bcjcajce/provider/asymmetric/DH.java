...
import org.bouncycastle.bcjcajce.provider.asymmetric.dh.KeyFactorySpi;
...
public class DH
{
    private static final String PREFIX = "org.bouncycastle.bcjcajce.provider.asymmetric" + ".dh.";
