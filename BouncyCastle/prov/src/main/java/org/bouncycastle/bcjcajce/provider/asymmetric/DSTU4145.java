...
import org.bouncycastle.bcjcajce.provider.asymmetric.dstu.KeyFactorySpi;
...
{
    private static final String PREFIX = "org.bouncycastle.bcjcajce.provider.asymmetric" + ".dstu.";
