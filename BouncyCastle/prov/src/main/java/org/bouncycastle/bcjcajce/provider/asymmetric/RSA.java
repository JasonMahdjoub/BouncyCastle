...
import org.bouncycastle.bcjcajce.provider.asymmetric.rsa.KeyFactorySpi;
...
public class RSA
{
    private static final String PREFIX = "org.bouncycastle.bcjcajce.provider.asymmetric" + ".rsa.";
