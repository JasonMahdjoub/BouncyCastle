...
import org.bouncycastle.bcjcajce.provider.asymmetric.edec.KeyFactorySpi;
...
public class EdEC
{
    private static final String PREFIX = "org.bouncycastle.bcjcajce.provider.asymmetric" + ".edec.";
