 ...
 * <ul>
 * <li>MAC generation, by providing a {@link org.bouncycastle.bcjcajce.spec.SkeinParameterSpec.Builder#setKey(byte[]) key}.</li>
 * <li>Randomised hashing, by providing a {@link org.bouncycastle.bcjcajce.spec.SkeinParameterSpec.Builder#setNonce(byte[]) nonce}.</li>
 * <li>A hash function for digital signatures, associating a
 * {@link org.bouncycastle.bcjcajce.spec.SkeinParameterSpec.Builder#setPublicKey(byte[]) public key} with the message digest.</li>
 * <li>A key derivation function, by providing a
 * {@link org.bouncycastle.bcjcajce.spec.SkeinParameterSpec.Builder#setKeyIdentifier(byte[]) key identifier}.</li>
 * <li>Personalised hashing, by providing a
 * {@link org.bouncycastle.bcjcajce.spec.SkeinParameterSpec.Builder#setPersonalisation(java.util.Date, String, String) recommended format} or
 * {@link org.bouncycastle.bcjcajce.spec.SkeinParameterSpec.Builder#setPersonalisation(byte[]) arbitrary} personalisation string.</li>
 * </ul>
 *
    ...
    implements AlgorithmParameterSpec
{
    ...
    /**
     * A builder for {@link org.bouncycastle.bcjcajce.spec.SkeinParameterSpec}.
     */
    public static class Builder
    {
         ...
         * org.bouncycastle.bcjcajce.spec.SkeinParameterSpec#PARAM_TYPE_MESSAGE} (reserved for message body).
         * <p>
         * Parameters with type &lt; {@value org.bouncycastle.bcjcajce.spec.SkeinParameterSpec#PARAM_TYPE_MESSAGE} are processed before
         * the message content, parameters with type &gt; {@value org.bouncycastle.bcjcajce.spec.SkeinParameterSpec#PARAM_TYPE_MESSAGE}
        ...
        /**
         * Sets the {@link org.bouncycastle.bcjcajce.spec.SkeinParameterSpec#PARAM_TYPE_KEY} parameter.
         */
        ...
        /**
         * Sets the {@link org.bouncycastle.bcjcajce.spec.SkeinParameterSpec#PARAM_TYPE_PERSONALISATION} parameter.
         */
        ...
        /**
         * Sets the {@link org.bouncycastle.bcjcajce.spec.SkeinParameterSpec#PARAM_TYPE_KEY_IDENTIFIER} parameter.
         *
         * @return the current builder instance.
         */
        ...
        /**
         * Sets the {@link org.bouncycastle.bcjcajce.spec.SkeinParameterSpec#PARAM_TYPE_NONCE} parameter.
         *
         * @return the current builder instance.
         */
        ...
        /**
         * Constructs a new {@link org.bouncycastle.bcjcajce.spec.SkeinParameterSpec} instance with the parameters provided to this
         * builder.
         */
