    ...
    implements RSAPublicKey
{
    ...
    private void populateFromPublicKeyInfo(SubjectPublicKeyInfo info)
    {
        try
        {
            org.bouncycastle.bcasn1.pkcs.RSAPublicKey  pubKey = org.bouncycastle.bcasn1.pkcs.RSAPublicKey.getInstance(info.parsePublicKey());
    ...
    {
        return KeyUtil.getEncodedSubjectPublicKeyInfo(algorithmIdentifier, new org.bouncycastle.bcasn1.pkcs.RSAPublicKey(getModulus(), getPublicExponent()));
    }
