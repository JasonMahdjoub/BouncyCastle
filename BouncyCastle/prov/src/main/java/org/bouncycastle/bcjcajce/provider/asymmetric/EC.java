...
import org.bouncycastle.bcjcajce.provider.asymmetric.ec.KeyFactorySpi;
...
public class EC
{
    private static final String PREFIX = "org.bouncycastle.bcjcajce.provider.asymmetric" + ".ec.";
