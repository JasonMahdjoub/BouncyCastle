    ...
    implements PKCS12BagAttributeCarrier
{
    ...
    X509CertificateObject(JcaJceHelper bcHelper, org.bouncycastle.bcasn1.x509.Certificate c)
    ...
    private static BasicConstraints createBasicConstraints(org.bouncycastle.bcasn1.x509.Certificate c)
        throws CertificateParsingException
    {
        try
        {
    ...
    private static boolean[] createKeyUsage(org.bouncycastle.bcasn1.x509.Certificate c) throws CertificateParsingException
    {
        try
        {
    ...
    private static String createSigAlgName(org.bouncycastle.bcasn1.x509.Certificate c) throws CertificateParsingException
    {
        try
        {
    ...
    private static byte[] createSigAlgParams(org.bouncycastle.bcasn1.x509.Certificate c) throws CertificateParsingException
    {
        try
        {
