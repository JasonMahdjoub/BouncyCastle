    ...
    implements BCX509Certificate
{
    ...
    private static Collection getAlternativeNames(org.bouncycastle.bcasn1.x509.Certificate c, String oid)
        throws CertificateParsingException
    {
    ...
    protected static byte[] getExtensionOctets(org.bouncycastle.bcasn1.x509.Certificate c, String oid)
    {
        ASN1OctetString extValue = getExtensionValue(c, oid);
        if (null != extValue)
        {
    ...
    protected static ASN1OctetString getExtensionValue(org.bouncycastle.bcasn1.x509.Certificate c, String oid)
    {
