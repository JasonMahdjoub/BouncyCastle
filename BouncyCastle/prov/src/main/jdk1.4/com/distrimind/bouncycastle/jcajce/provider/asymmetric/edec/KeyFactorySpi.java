    ...
    implements AsymmetricKeyInfoConverter
{
        ...
        throws InvalidKeySpecException
    {
        ...
        if (spec.isAssignableFrom(com.distrimind.bouncycastle.jce.spec.OpenSSHPrivateKeySpec.class) && key instanceof BCEdDSAPrivateKey)
        {
            try
            {
                //
        ...
        else if (spec.isAssignableFrom(com.distrimind.bouncycastle.jce.spec.OpenSSHPublicKeySpec.class) && key instanceof BCEdDSAPublicKey)
        {
            try
            {
